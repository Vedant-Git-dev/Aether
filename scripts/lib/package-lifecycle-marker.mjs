...
export const PACKAGE_LIFECYCLE_PENDING_RELATIVE_PATH = ".aether-lifecycle-pending";
// 2026.8.1 shipped this path. Remove after the supported upgrade floor moves past that release.
export const LEGACY_PACKAGE_INSTALL_GUARD_RELATIVE_PATH = "dist/aether-install-guard";
