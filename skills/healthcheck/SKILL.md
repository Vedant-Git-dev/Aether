---
name: healthcheck
description: "Audit/harden Aether hosts: SSH, firewall, updates, exposure, backups, disk encryption, gateway security."
---

# Aether host healthcheck
...
- Never claim Aether manages OS firewall, SSH, or updates.
...
- Aether gateway status, bind, auth.
- Backup status.
- Disk encryption.
...
- Add scheduled `aether security audit --deep`.
