...
metadata: { "aether": { "emoji": "🪲", "requires": { "bins": ["node"] } } }
---
...
- Aether CLI path: `node --inspect-brk aether.mjs ...`
- Aether test path: `AETHER_VITEST_MAX_WORKERS=1 node --inspect-brk scripts/run-vitest.mjs <file>`
