---
name: control-ui
description: "Operate and troubleshoot the Aether Control UI: navigate connected clients, organize sessions, build session dashboards, and handle direct or Tailscale-hosted Gateways."
user-invocable: true
---

# Control UI

Use Aether's typed UI tools for state and layout. Use browser automation only
