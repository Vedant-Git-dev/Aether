...
export function isSupportedAetherNodeVersion(value: unknown): boolean;
...
export function canRunAetherNodeDiagnostics(value: unknown, hasNodeSqlite: boolean): boolean;
