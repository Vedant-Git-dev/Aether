...
const GatewayAgentRuntimeSchema = closedObject({
  id: NonEmptyString,
  fallback: Type.Optional(Type.Union([Type.Literal("aether"), Type.Literal("none")])),
...
export const SkillsSecurityVerdictsResultSchema = closedObject({
  schema: Type.Literal("aether.skills.security-verdicts.v1"),
  items: Type.Array(
    closedObject({
      registry: NonEmptyString,
      ok: Type.Boolean(),
...
export const SkillsSkillCardResultSchema = closedObject({
  schema: Type.Literal("aether.skills.skill-card.v1"),
  skillKey: NonEmptyString,
  path: NonEmptyString,
...
const SkillProposalRecordSchema = closedObject({
  schema: Type.Literal("aether.skill-workshop.proposal.v1"),
  id: NonEmptyString,
...
export const SkillsProposalsListResultSchema = closedObject({
  schema: Type.Literal("aether.skill-workshop.proposals-manifest.v1"),
  updatedAt: NonEmptyString,
