// Gateway Protocol schema module defines Aether chat payloads.
...
/**
 * Aether chat lets clients (macOS app onboarding, future UIs) hold the
...
/** One Aether reply; `action` tells clients about conversation handoffs. */
