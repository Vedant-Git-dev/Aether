...
export const GATEWAY_CLIENT_IDS = {
  ...
  CONTROL_UI: "aether-control-ui",
  BROWSER_COPILOT: "aether-browser-copilot",
  TUI: "aether-tui",
  WEBCHAT: "webchat",
  CLI: "cli",
  GATEWAY_CLIENT: "gateway-client",
  MACOS_APP: "aether-macos",
  // Native Linux UI uses the same trusted-client admission class as the macOS app.
  LINUX_APP: "aether-linux",
  NODE_HOST: "node-host",
...
export type GatewayClientInfo = {
  ...
  buildId?: string;
  /** Runtime platform string, such as `darwin`, `linux`, or `web`. */
  platform: string;
