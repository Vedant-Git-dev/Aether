...
ChatUI resource bundle. The macOS build entry points
...
Native apps package the original license texts per dependency; the filename is the Licenses screen's dependency
