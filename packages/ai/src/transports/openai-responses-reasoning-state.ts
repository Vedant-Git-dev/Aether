...
function inputReplay(message: AssistantMessage) {
  const value =
    "aetherResponsesInputReplay" in message ? message.aetherResponsesInputReplay : undefined;
...
export function recordResponsesReasoningState(
  ...
  Object.assign(message, { aetherResponsesInputReplay: { ...inputReplay(message), reasoning } });
}
