...
const providerAcceptanceObserver: unique symbol = Symbol("aether.providerAcceptanceObserver");
...
/** Attach an Aether-internal provider acceptance observer to one model call. */
