...
function resolveOpenAIResponsesPayloadCapabilities(
  ...
  // -- Aether bundles many named classes (Cerebras, Groq, Mistral,
  ...
  return {
    allowsOpenAIServiceTier:
      (provider === "openai" &&
        (api === "openai-responses" || api === "aether-openai-responses-transport") &&
        endpointClass === "openai-public") ||
      (isOpenAIProvider &&
        (api === "openai-chatgpt-responses" ||
          api === "aether-openai-chatgpt-responses-transport" ||
          api === "openai-responses" ||
          api === "aether-openai-responses-transport") &&
        endpointClass === "openai"),
