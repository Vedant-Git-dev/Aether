...
import { createSubsystemLogger, redactSensitiveText } from "./aether-runtime-io.js";
import {
...
} from "./aether-runtime-session.js";
...
export { readTranscriptStatsBatchReadOnlySync } from "./aether-runtime-session.js";
...
function isDreamingNarrativeGeneratedRecord(record: unknown): boolean {
  ...
  if (
    ...
    candidate.customType === "aether:bootstrap-context:full" &&
 ...
 * Aether-owned usage-counted transcript in the canonical agent sessions dir.
 */
