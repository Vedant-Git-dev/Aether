...
function normalizeAgentEventType(payload: JsonObject): AetherEventType {
...
function normalizeNamedEventType(event: GatewayEvent): AetherEventType {
...
export function normalizeGatewayEvent(event: GatewayEvent): AetherEvent {
  const payload = asRecord(event.payload);
