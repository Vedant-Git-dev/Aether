...
/** Provider API families with first-class request/stream adapters in Aether. */
...
/** Image-generation API families with first-class adapters in Aether. */
...
/** Image provider ids with first-class adapters in Aether. */
...
export interface Model<TApi extends Api = Api> {
  ...
  reasoning: boolean;
  /**
   * Maps Aether thinking levels to provider/model-specific values.
