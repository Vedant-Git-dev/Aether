...
/** Resolve the underlying OS home before applying Aether overrides. */
...
/** Resolve raw home with AETHER_HOME tilde expansion. */
...
function resolveHomeDisplayPrefix(): { home: string; prefix: string } | undefined {
  ...
  return explicitHome ? { home, prefix: "$AETHER_HOME" } : { home, prefix: "~" };
}
