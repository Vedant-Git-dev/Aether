...
const STRUCTURED_AUTH_MARKER_PREFIX = ";__aether_structured_auth_redacted_";

// Minimal fallback for standalone or unwired ACP core. Aether injects canonical
...
const SECRET_PATTERNS: RegExp[] = [
  ...
  /(?:X-Aether-Token|x-pomerium-jwt-assertion|X-Api-Key|X-Auth-Token)\s*[:=]\s*([^\s"',;]+)/gi,
...
export { stringifyNonErrorCause } from "@aether/normalization-core/error-coercion";
