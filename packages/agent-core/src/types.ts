...
export interface InternalToolBatchCall {
  ...
  args: unknown;
  /** Resolved tool identity for Aether-owned argument canonicalization. */
  tool?: AgentTool;
}
...
/** Context for Aether-owned whole-batch tool admission. */
...
/** Result of Aether-owned whole-batch tool admission. */
...
export interface AgentLoopConfig extends SimpleStreamOptions {
  ...
  /** @internal Aether-owned batch admission. Not a plugin or session SDK hook. */
  beforeToolBatch?: (
 ...
 * from aether/plugin-sdk/llm to detect support for a concrete model.
 */
