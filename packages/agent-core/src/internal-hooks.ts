...
/** Install Aether-owned loop control without adding a plugin-facing Agent option. */
...
/** Attach Aether-owned two-phase execution without changing the public AgentTool shape. */
