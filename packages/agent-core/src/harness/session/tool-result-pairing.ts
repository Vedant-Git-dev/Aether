...
export const SYNTHETIC_MISSING_TOOL_RESULT_DETAIL_KEY = "aetherSyntheticMissingToolResult";
export const DEFAULT_MISSING_TOOL_RESULT_TEXT =
  "[aether] missing tool result in session history; inserted synthetic error result for transcript repair.";
