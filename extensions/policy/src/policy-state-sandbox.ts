...
import { splitSandboxBindSpec } from "aether/plugin-sdk/agent-harness-runtime";
import {
  asNonArrayRecord,
  isRecord,
...
const DEFAULT_POLICY_SANDBOX_BROWSER_NETWORK = "aether-sandbox-browser";
...
export function scanPolicySandboxPosture(
  ...
  pushSandboxPostureEvidence(entries, {
    ...
    inheritedSandbox: {},
    sourceBase: "oc://aether.config/agents/defaults/sandbox",
    inheritedSourceBase: "oc://aether.config/agents/defaults/sandbox",
  });
