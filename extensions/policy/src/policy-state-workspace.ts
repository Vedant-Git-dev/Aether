...
export function scanPolicyAgentWorkspace(
  ...
  pushAgentWorkspaceEvidence(entries, {
    ...
    tools: defaultTools,
    inheritedTools: {},
    workspaceSourceBase: "oc://aether.config/agents/defaults",
    inheritedWorkspaceSourceBase: "oc://aether.config/agents/defaults",
    toolsSourceBase: "oc://aether.config/tools",
    inheritedToolsSourceBase: "oc://aether.config/tools",
  });
  ...
  const sandboxModeSource =
    explicitSandboxMode !== undefined
      ...
      : inheritedSandboxMode !== undefined
        ...
        : "oc://aether.config/agents/defaults/sandbox/mode";
    ...
    source:
      explicitWorkspaceAccess !== undefined
        ...
        : inheritedWorkspaceAccess !== undefined
          ...
          : "oc://aether.config/agents/defaults/sandbox/workspaceAccess",
    scope: params.scope,
