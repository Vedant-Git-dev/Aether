  ...
  return policyDenied
    ...
    .map((command): HealthFinding => {
      return {
        ...
        severity: "error",
        message: `Gateway node command '${command}' is denied by policy but not denied by Aether config.`,
        source: "policy",
        path: "aether config",
        ocPath: "oc://aether.config/gateway/nodes/commands/deny",
        target: "oc://aether.config/gateway/nodes/commands/deny",
