// Litellm plugin entrypoint registers its Aether integration.
...
import { normalizeOptionalSecretInput } from "aether/plugin-sdk/provider-auth";
import { buildOpenAICompatibleProviderCatalog } from "aether/plugin-sdk/provider-catalog-live-runtime";
