...
import type { DmPolicy, GroupPolicy, ReplyToMode } from "aether/plugin-sdk/config-contracts";
...
export function listWhatsAppAuthDirs(cfg: AetherConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: AetherConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: AetherConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: AetherConfig): ResolvedWhatsAppAccount[] {
