...
function areWhatsAppAgentReactionsEnabled(params: { cfg: AetherConfig; accountId?: string }) {
...
function hasAnyWhatsAppAccountWithAgentReactionsEnabled(cfg: AetherConfig) {
