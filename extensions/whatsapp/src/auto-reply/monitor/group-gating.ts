...
import type { BuildMentionRegexesOptions } from "aether/plugin-sdk/channel-mention-gating";
...
import type { HistoryMediaEntry } from "aether/plugin-sdk/reply-history";
