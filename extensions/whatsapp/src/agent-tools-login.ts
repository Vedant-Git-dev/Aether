...
import type { ChannelAgentTool } from "aether/plugin-sdk/channel-contract";
import type { AetherPluginApi, AetherPluginToolContext } from "aether/plugin-sdk/core";
import { hasNonEmptyString } from "aether/plugin-sdk/string-coerce-runtime";
...
export function registerWhatsAppLoginTool(api: AetherPluginApi): void {
