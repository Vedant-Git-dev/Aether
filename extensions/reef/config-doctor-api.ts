import type { ChannelDoctorLegacyConfigRule } from "aether/plugin-sdk/channel-contract";
import type { AetherConfig } from "aether/plugin-sdk/config-contracts";
import { defineStrayPluginEntryConfigMigration } from "aether/plugin-sdk/runtime-doctor-migrations";
...
export const legacyConfigRules: ChannelDoctorLegacyConfigRule[] = [
  {
    path: ["channels", "reef"],
    message:
      'channels.reef dmPolicy/allowFrom are legacy; run "aether doctor --fix" to remove them. Peer trust is SQLite-backed.',
