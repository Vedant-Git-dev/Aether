import { toStringifiedError as asError } from "aether/plugin-sdk/error-runtime";
...
import { readProviderJsonResponse } from "aether/plugin-sdk/provider-http";
...
export class ReefProtocolCompatibilityError extends ReefRelayError {
  constructor(
    ...
    readonly upgradeRequired: "reef-relay" | "aether-client",
    message: string,
  ) {
    ...
    try {
      ...
      if (
        ...
        throw new ReefProtocolCompatibilityError(
          ...
          error.code,
          "reef-relay",
          "The Reef relay is likely incompatible or outdated. Update Aether and the Reef relay together, then approve the fresh pairing challenge again.",
        );
      }
      if (
        error instanceof ReefRelayError &&
        ...
        throw new ReefProtocolCompatibilityError(
          ...
          error.code,
          "aether-client",
          "Aether is outdated for this Reef relay. Update Aether, then approve the fresh pairing challenge again.",
        );
      }
      throw error;
    }
