// Talk Voice plugin entrypoint registers its Aether integration.
...
import type { SpeechVoiceOption } from "aether/plugin-sdk/speech";
import {
  normalizeLowercaseStringOrEmpty,
  normalizeOptionalLowercaseString,
  normalizeOptionalString,
} from "aether/plugin-sdk/string-coerce-runtime";
import { resolveActiveTalkProviderConfig } from "aether/plugin-sdk/talk-config-runtime";
  ...
  register(api: AetherPluginApi) {
    api.registerCommand({
      ...
      handler: async (ctx) => {
        ...
        const cfg = api.runtime.config.current() as AetherConfig;
