import type { IdentifierAuthentication } from "aether/plugin-sdk/channel-ingress-runtime";
...
type HookDispatch = AetherPluginApi["runtime"]["hooks"]["dispatchHookAgentTurn"];
