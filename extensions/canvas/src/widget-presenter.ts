...
import { selectDefaultNodeFromList } from "aether/plugin-sdk/agent-harness-runtime";
...
type WidgetPresenter = Parameters<AetherPluginApi["registerWidgetPresenter"]>[0];
