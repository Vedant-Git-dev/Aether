...
export function applyArceeConfig(cfg: AetherConfig): AetherConfig {
...
export function applyArceeOpenRouterConfig(cfg: AetherConfig): AetherConfig {
  return applyProviderConfigWithModelCatalogPreset(cfg, {
...
export function applyArceeOnboardConfig(cfg: AetherConfig): AetherConfig {
...
export function applyArceeOpenRouterOnboardConfig(cfg: AetherConfig): AetherConfig {
  return applyProviderConnectionConfig(cfg, {
    ...ARCEE_OPENROUTER_PRESET,
    catalogModels: buildArceeOpenRouterCatalogModels,
  });
