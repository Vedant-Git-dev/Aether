...
import type { OutputRuntimeEnv } from "aether/plugin-sdk/runtime";
import type { ChannelSetupWizardAdapter } from "aether/plugin-sdk/setup";
...
export function createMatrixUpdateKeepCredentialsPrompter(params?: {
  ...
  return createMatrixWizardPrompter({
    ...
    text: {
      ...
      "Matrix device name (optional)": params?.deviceName ?? "Aether Gateway",
