...
import { finalizeInboundContext as finalizeCoreInboundContext } from "aether/plugin-sdk/reply-runtime";
...
export function createMatrixHandlerTestHarness(
  ...
  }) as typeof import("aether/plugin-sdk/reply-runtime").dispatchInboundMessageWithBufferedDispatcher;
