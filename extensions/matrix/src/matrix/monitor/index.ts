// Matrix plugin entrypoint registers its Aether integration.
import { format } from "node:util";
import { CHANNEL_APPROVAL_NATIVE_RUNTIME_CONTEXT_CAPABILITY } from "aether/plugin-sdk/approval-handler-adapter-runtime";
import type { ChannelRuntimeSurface } from "aether/plugin-sdk/channel-contract";
import {
...
import { resolveOptionalIntegerOption } from "aether/plugin-sdk/number-runtime";
...
} from "aether/plugin-sdk/thread-bindings-runtime";
...
type MonitorMatrixOpts = {
  ...
  setStatus?: (next: import("aether/plugin-sdk/channel-contract").ChannelAccountSnapshot) => void;
};
