...
} from "aether/plugin-sdk/computer-use";
...
const CUA_DRIVER_ENDPOINT_ENV = "AETHER_CUA_DRIVER_ENDPOINT";
...
function createImageProcessor(env: NodeJS.ProcessEnv): ImageProcessor {
  return createRastermill({
    ...
    temp: { rootDir: resolvePreferredAetherTmpDir(), prefix: "aether-cua-computer-" },
