...
import { buildPluginConfigSchema, type AetherPluginConfigSchema } from "aether/plugin-sdk/core";
import {
  formatPluginConfigIssue,
  mapPluginConfigIssues,
} from "aether/plugin-sdk/extension-shared";
import { MAX_TIMER_TIMEOUT_SECONDS } from "aether/plugin-sdk/number-runtime";
import { z } from "zod";
...
export function createOpenShellPluginConfigSchema(): AetherPluginConfigSchema {
