...
} from "aether/plugin-sdk/channel-config-schema";
import { requireChannelOpenAllowFrom } from "aether/plugin-sdk/extension-shared";
...
export const SmsChannelConfigSchema = buildChannelConfigSchema(SmsConfigSchema, {
  uiHints: {
    ...
    textChunkLimit: {
      ...
      help: "Maximum characters per outbound SMS chunk before Aether splits long replies.",
    },
  },
});
