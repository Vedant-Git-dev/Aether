...
import { normalizeOptionalAccountId } from "aether/plugin-sdk/account-id";
import {
  DEFAULT_ACCOUNT_ID,
...
function getChannelConfig(cfg: AetherConfig): SmsChannelConfig | undefined {
...
export function inspectSmsAccount(cfg: AetherConfig, accountId?: string | null) {
