...
import { isRecord, normalizeStringEntries } from "aether/plugin-sdk/string-coerce-runtime";
...
const resolveSmsDmPolicy = createScopedDmSecurityResolver<ResolvedSmsAccount>({
  ...
  approveHint: "aether pairing approve sms <code>",
...
export const smsPlugin: ChannelPlugin<ResolvedSmsAccount, SmsProbe> = createChatChannelPlugin({
  ...
  pairing: {
    text: {
      idLabel: "phoneNumber",
      message: "Aether: your SMS access has been approved.",
