 ...
 * Aether stream options for the shared Anthropic Messages transport.
 */
...
import { copyProviderAcceptanceObserver } from "aether/plugin-sdk/provider-transport-runtime";
...
/**
 * Create a StreamFn that routes through Aether's generic model stream with an
