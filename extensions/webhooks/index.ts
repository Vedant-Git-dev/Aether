// Webhooks plugin entrypoint registers its Aether integration.
...
function registerWebhookRoutes(api: AetherPluginApi): void {
...
export default definePluginEntry({
  ...
  name: "Webhooks",
  description:
    "Authenticated inbound webhooks that bind external automation to Aether TaskFlows.",
