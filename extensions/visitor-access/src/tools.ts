...
import type { AnyAgentTool, AetherPluginToolContext } from "../api.js";
...
export function createVisitorTools(context: AetherPluginToolContext): AnyAgentTool[] {
  ...
  const definitions = [
    {
      ...
      description:
        "Grant or renew visitor access to team.aether.ai. Provide email or GitHub login; private GitHub emails require explicit email. Grants expire after the configured duration (14 days by default); forever must be explicit.",
