...
Visitor Access is an internal Aether plugin for granting individual people
access to <https://team.aether.ai>. It manages one dedicated Cloudflare Access
    ...
    entries: {
      "visitor-access": {
        ...
        config: {
          ...
          policyName: "Visitors (aether-managed)",
          defaultTtlDays: 14,
          maxVisitors: 50,
        },
      },
...
| `policyName`     | No       | `Visitors (aether-managed)` | 1–200 characters; exact policy name.    |
...
commit it to source control. See [Secrets](https://docs.aether.ai/gateway/secrets)
...
Visitors log in at <https://team.aether.ai> with their own GitHub account. The
