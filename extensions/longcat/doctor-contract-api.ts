...
export const legacyConfigRules = [
  {
    path: MODELS_PATH,
    message:
      'models.providers.longcat.models contains the historical stock LongCat-2.0 cache-write price; run "aether doctor --fix" to update it without changing customized rows.',
