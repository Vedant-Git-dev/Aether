...
import { normalizeCommandBody } from "aether/plugin-sdk/command-surface";
import type {
  AetherConfig,
...
import { timestampMsToIsoString } from "aether/plugin-sdk/number-runtime";
...
export async function buildTelegramInboundContextPayload(params: {
  ...
  const ctxPayload = await sessionRuntime.buildChannelInboundEventContext({
    ...
    sessionTranscript: {
      ...
      senderLabels: { assistant: "Aether", user: "User" },
    },
    access: {
      commands: {
