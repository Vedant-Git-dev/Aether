...
export type TelegramOutboundPromptContextMessage = {
  ...
  aether_prompt_context_timestamp_ms?: number;
  text?: string;
  caption?: string;
...
function resolveOutboundCacheMessageTimestamp(
  ...
  if (
    typeof msg.aether_prompt_context_timestamp_ms === "number" &&
    Number.isFinite(msg.aether_prompt_context_timestamp_ms)
  ) {
    return msg.aether_prompt_context_timestamp_ms;
  }
...
function buildOutboundCacheMessage(params: {
  ...
  return {
    ...
    ...(params.promptContextTimestampMs !== undefined
      ? { aether_prompt_context_timestamp_ms: params.promptContextTimestampMs }
      : {}),
    date:
