...
import { hasOutboundReplyContent } from "aether/plugin-sdk/reply-payload";
import {
...
type TelegramNativeReplyPayload = import("aether/plugin-sdk/plugin-entry").PluginCommandResult;
