...
import { formatDurationPrecise, sleepWithAbort } from "aether/plugin-sdk/runtime-env";
...
const TELEGRAM_GET_UPDATES_CONFLICT_HINT =
  " Another Aether gateway, script, or Telegram poller may be using this bot token; stop the duplicate poller or switch this account to webhook mode.";
...
export class TelegramPollingSession {
  ...
  async runUntilAbort(): Promise<void> {
    ...
    try {
      ...
      // leak to api.telegram.org; see aether#68128.
