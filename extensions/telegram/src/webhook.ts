...
import type { ChannelAccountSnapshot } from "aether/plugin-sdk/channel-contract";
import type { AetherConfig } from "aether/plugin-sdk/config-contracts";
import { isDiagnosticsEnabled } from "aether/plugin-sdk/diagnostic-runtime";
import {
  logWebhookError,
  logWebhookProcessed,
  logWebhookReceived,
} from "aether/plugin-sdk/logging-core";
...
import type { BackoffPolicy, RuntimeEnv } from "aether/plugin-sdk/runtime-env";
import {
  computeBackoff,
  defaultRuntime,
...
const TELEGRAM_WEBHOOK_ACCEPTED_HEADER = "x-aether-delivery-accepted";
...
function resolveTelegramWebhookClientIp(req: IncomingMessage, config?: AetherConfig): string {
