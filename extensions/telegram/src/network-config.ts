...
import { isTruthyEnvValue, isWSL2Sync } from "aether/plugin-sdk/runtime-env";
import { normalizeOptionalLowercaseString } from "aether/plugin-sdk/string-coerce-runtime";

const TELEGRAM_DISABLE_AUTO_SELECT_FAMILY_ENV = "AETHER_TELEGRAM_DISABLE_AUTO_SELECT_FAMILY";
const TELEGRAM_ENABLE_AUTO_SELECT_FAMILY_ENV = "AETHER_TELEGRAM_ENABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_DNS_RESULT_ORDER_ENV = "AETHER_TELEGRAM_DNS_RESULT_ORDER";
 ...
 *
 * Priority:
 * 1. Environment variable AETHER_TELEGRAM_DNS_RESULT_ORDER
