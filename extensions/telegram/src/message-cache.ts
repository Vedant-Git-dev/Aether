...
import { formatLocationText } from "aether/plugin-sdk/channel-inbound";
...
type MessageWithPromptContextTimestamp = Message & {
  aether_prompt_context_timestamp_ms?: unknown;
};
...
const TELEGRAM_MESSAGE_CACHE_BUCKETS_KEY = Symbol.for("aether.telegram.messageCacheBuckets");
