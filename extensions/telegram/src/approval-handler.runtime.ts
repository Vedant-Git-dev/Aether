...
import { createChannelApprovalNativeRuntimeAdapter } from "aether/plugin-sdk/approval-handler-runtime";
...
import type { ExecApprovalPendingReplyParams } from "aether/plugin-sdk/approval-reply-runtime";
import type {
  ExecApprovalRequest,
  PluginApprovalRequest,
  SystemAgentApprovalRequest,
} from "aether/plugin-sdk/approval-runtime";
import { resolveGatewayPublicOrigin } from "aether/plugin-sdk/config-contracts";
  ...
  if (params.approvalKind === "system-agent") {
    ...
    const reviewUrl =
      origin && params.cfg.gateway?.controlUi?.enabled !== false
        ...
        : undefined;
    const lines = [
      "🔒 Aether change requires approval",
