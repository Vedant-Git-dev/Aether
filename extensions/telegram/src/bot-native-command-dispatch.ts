...
import { PLUGIN_COMMAND_DISPATCH } from "aether/plugin-sdk/plugin-command-runtime";
import { danger, logVerbose, type RuntimeEnv } from "aether/plugin-sdk/runtime-env";
...
export type TelegramCommandExecutorParams = {
  ...
  resolveGroupPolicy: (chatId: string | number, cfg: AetherConfig) => ChannelGroupPolicy;
...
export async function dispatchTelegramBuiltinTurn(params: {
  ...
  prompt: string;
  commandArgs?: import("aether/plugin-sdk/command-auth-native").CommandArgs;
}): Promise<boolean> {
