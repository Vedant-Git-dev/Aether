...
Official external Aether plugin for daily, weekly, and monthly GitHub activity reports
with optional Discord discussion, model-written summaries, and a **Reports**
tab in the Control UI. Installed on demand (`aether plugins install @aether/team-reports`);
...
```sh
aether team-reports status --json
aether team-reports generate --intraday
aether team-reports list --json
```
...
See the [Team Reports guide](https://docs.aether.ai/plugins/team-reports)
