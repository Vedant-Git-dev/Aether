// ClawRouter provider catalog maps credential-scoped routes to Aether transports.
import type { ProviderRuntimeModel } from "aether/plugin-sdk/plugin-entry";
import {
  getCachedLiveProviderModelRows,
  type LiveModelCatalogFetchGuard,
} from "aether/plugin-sdk/provider-catalog-live-runtime";
import type {
...
const CLAWROUTER_DEFAULT_BASE_URL = "https://clawrouter.aether.ai";
