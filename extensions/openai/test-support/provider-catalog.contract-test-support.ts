...
} from "aether/plugin-sdk/provider-test-contracts";
import type { ProviderPlugin } from "aether/plugin-sdk/provider-test-contracts";
...
vi.mock("aether/plugin-sdk/provider-catalog-runtime", async () => {
  const actual = await vi.importActual<
    typeof import("aether/plugin-sdk/provider-catalog-runtime")
  >("aether/plugin-sdk/provider-catalog-runtime");
