...
function shouldUseOpenAINativeWebSearchProvider(config: AetherConfig | undefined): boolean {
...
export function createOpenAINativeWebSearchWrapper(
  ...
  return createPayloadPatchStreamWrapper(
    ...
    ({ payload, options }) => {
      (
        options as { aetherCodeModeAllowedHostedToolTypes?: Set<string> } | undefined
      )?.aetherCodeModeAllowedHostedToolTypes?.add(OPENAI_WEB_SEARCH_TOOL.type);
