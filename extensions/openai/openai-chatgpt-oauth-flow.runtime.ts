...
import { resolveOpenAICodexAuthIdentity } from "aether/plugin-sdk/provider-auth";
import {
 ...
 * @param options.originator - OAuth originator parameter (defaults to "aether")
 */
