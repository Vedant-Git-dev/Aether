...
import { REALTIME_VOICE_AUDIO_FORMAT_PCM16_24KHZ } from "aether/plugin-sdk/realtime-voice-provider";
...
const INTERNAL_REALTIME_VOICE_PROVIDER = Symbol.for("aether.internal.realtime-voice-provider.v1");
