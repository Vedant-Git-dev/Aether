...
Nostr DM channel plugin for Aether using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to Aether. It enables your bot to:
...
```bash
aether plugins install @aether/nostr
```
...
# Configure aether to use local relay
