...
import { createDelegatedSetupWizardProxy } from "aether/plugin-sdk/setup-runtime";
...
function getNostrConfig(cfg: AetherConfig): NostrAccountConfig | undefined {
  return (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
}

function resolveDefaultSetupNostrAccountId(cfg: AetherConfig): string {
