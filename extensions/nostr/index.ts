// Nostr plugin entrypoint registers its Aether integration.
import {
  defineBundledChannelEntry,
  loadBundledEntryExportSync,
} from "aether/plugin-sdk/channel-entry-contract";
import type { AetherConfig, PluginRuntime, ResolvedNostrAccount } from "./api.js";
  ...
  registerFull(api) {
    const httpHandler = createNostrProfileHttpHandler()({
      getConfigProfile: (accountId: string) => {
        ...
        const cfg = runtime.config.current() as AetherConfig;
