// File Transfer plugin entrypoint registers its Aether integration.
import {
  definePluginEntry,
  type AnyAgentTool,
  type AetherPluginNodeHostCommand,
...
const fileTransferNodeHostCommands: AetherPluginNodeHostCommand[] = [
  {
    command: "file.fetch",
    cap: "file",
    dangerous: true,
