...
import { ARCHIVE_LIMIT_ERROR_CODE, ArchiveLimitError } from "aether/plugin-sdk/archive";
...
): Promise<AetherPluginNodeInvokePolicyResult> {
...
export function createFileTransferNodeInvokePolicy(): AetherPluginNodeInvokePolicy {
  return {
