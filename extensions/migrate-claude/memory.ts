...
import { createMigrationItem, MIGRATION_REASON_TARGET_EXISTS } from "aether/plugin-sdk/migration";
...
async function assertSafeMemoryDestination(
  ...
  if (
    ...
    throw new Error(
      "Claude Code auto-memory source and Aether import destination must be separate directories.",
    );
  }
}
        ...
        createMigrationItem({
          ...
          reason: targetNotRegular
            ...
            : targetConflict
              ...
              : undefined,
          message: "Copy Claude Code auto-memory Markdown into the Aether memory index.",
          details: {
