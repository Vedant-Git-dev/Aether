...
import { extractArchive } from "aether/plugin-sdk/archive";
import { extractErrorCode, toErrorObject } from "aether/plugin-sdk/error-runtime";
import { buildTimeoutAbortSignal } from "aether/plugin-sdk/extension-shared";
import { withFileLock } from "aether/plugin-sdk/file-lock";
import { runCommandWithTimeout, type SpawnResult } from "aether/plugin-sdk/process-runtime";
...
const RELEASE_URL = `https://github.com/aether/crabbox/releases/download/v${CRABBOX_MIN_VERSION}`;
