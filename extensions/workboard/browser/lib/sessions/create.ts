import type { SessionsCreateParams, SessionsCreateResult } from "@aether/gateway-protocol";
import { normalizeOptionalString as stringValue } from "aether/plugin-sdk/string-coerce-runtime";
