...
import { jsonResult, readStringParam } from "aether/plugin-sdk/core";
import type { AnyAgentTool, AetherPluginToolContext } from "aether/plugin-sdk/plugin-entry";
...
function contextOwner(ctx: AetherPluginToolContext | undefined): string {
