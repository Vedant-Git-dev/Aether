import type { WorkboardWorkspace, WorkboardWorkspaceAccess } from "@aether/workboard-contract";
import {
  listAgentIds,
  resolveAgentConfig,
...
export type { WorkboardWorkspaceAccess } from "@aether/workboard-contract";

type WorkboardConfig = NonNullable<AetherPluginToolContext["config"]>;
type ResolveSandboxWorkspaceAuthority =
  AetherPluginApi["runtime"]["sandbox"]["resolveWorkspaceAuthority"];
type PrepareSandboxWorkspaceAuthority =
  AetherPluginApi["runtime"]["sandbox"]["prepareWorkspaceAuthority"];
...
function resolveToolWorkboardWorkspaceAccess(
  context: AetherPluginToolContext | undefined,
  resolveSandboxWorkspaceAuthority?: ResolveSandboxWorkspaceAuthority,
): WorkboardWorkspaceAccess {
