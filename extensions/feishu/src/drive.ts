...
import { isRecord, readStringValue as readString } from "aether/plugin-sdk/string-coerce-runtime";
...
export function registerFeishuDriveTools(api: AetherPluginApi) {
