...
type FeishuReadContext = FeishuActionReadContext | AetherPluginToolContext;
...
function resolveFeishuReadGroupPolicy(cfg: AetherConfig, account: ResolvedFeishuAccount) {
