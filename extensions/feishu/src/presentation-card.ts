...
import { markdownToIRWithMeta } from "aether/plugin-sdk/text-chunking";
...
const RENDERED_FEISHU_CARD = Symbol("aether.renderedFeishuCard");
const FEISHU_PRESENTATION_FALLBACK_MARKER = "__aetherPresentationFallback";
