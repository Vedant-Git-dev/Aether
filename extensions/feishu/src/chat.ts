...
import type { AetherPluginApi } from "../runtime-api.js";
...
function authorizeFeishuChatInfo(params: {
  cfg: NonNullable<AetherPluginApi["config"]>;
...
export function registerFeishuChatTools(api: AetherPluginApi) {
  api.registerTool(
    (toolContext: AetherPluginToolContext) => {
