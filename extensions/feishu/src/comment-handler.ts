...
import { resolveInboundReplyDispatchCounts } from "aether/plugin-sdk/channel-inbound";
import { bindIngressLifecycleToReplyOptions } from "aether/plugin-sdk/channel-outbound";
import { createChannelPairingController } from "aether/plugin-sdk/channel-pairing";
import type { AetherConfig as AetherConfig } from "aether/plugin-sdk/config-contracts";
...
export async function handleFeishuCommentEvent(
  ...
  const currentCfg = core.config.current() as AetherConfig;
