...
import {
  DEFAULT_ACCOUNT_ID,
  type AetherConfig as AetherConfig,
  createAccountListHelpers,
  hasConfiguredAccountValue,
  normalizeAccountId,
  normalizeOptionalAccountId,
} from "aether/plugin-sdk/account-resolution";
import { coerceSecretRef } from "aether/plugin-sdk/provider-auth";
import { canResolveEnvSecretRefInReadOnlyPath } from "aether/plugin-sdk/secret-ref-readonly";
import { normalizeOptionalString as normalizeString } from "aether/plugin-sdk/string-coerce-runtime";
import type {
  FeishuConfig,
  FeishuAccountConfig,
 ...
 */
export function resolveDefaultFeishuAccountSelection(cfg: AetherConfig): {
  accountId: string;
 ...
 */
export function resolveDefaultFeishuAccountId(cfg: AetherConfig): string {
 ...
 */
function mergeFeishuAccountConfig(cfg: AetherConfig, accountId: string): FeishuConfig {
...
export function resolveFeishuCredentials(
  cfg?: FeishuConfig,
  options?: { mode?: FeishuCredentialResolutionMode; rootConfig?: AetherConfig },
): {
  appId: string;
  appSecret: string;
  encryptKey?: string;
...
export function inspectFeishuCredentials(cfg?: FeishuConfig, rootConfig?: AetherConfig) {
 ...
 */
export function listEnabledFeishuAccounts(cfg: AetherConfig): ResolvedFeishuAccount[] {
