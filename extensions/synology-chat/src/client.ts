...
import { collectErrorGraphCandidates, extractErrorCode } from "aether/plugin-sdk/error-runtime";
import { safeParseJsonWithSchema, safeParseWithSchema } from "aether/plugin-sdk/extension-shared";
import { parseStrictNonNegativeInteger } from "aether/plugin-sdk/number-runtime";
import { readByteStreamWithLimit } from "aether/plugin-sdk/response-limit-runtime";
import { classifyTransientNetworkErrorCode, retryAsync } from "aether/plugin-sdk/retry-runtime";
import { sleep, sleepWithAbort } from "aether/plugin-sdk/runtime-env";
...
/**
 * Send an Aether-hosted immutable file URL to Synology Chat.
 */
