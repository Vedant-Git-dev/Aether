...
import { resolveDangerousNameMatchingEnabled } from "aether/plugin-sdk/dangerous-name-runtime";
...
/** Extract the channel config from the full Aether config object. */
function getChannelConfig(cfg: AetherConfig): SynologyChatChannelConfig | undefined {
...
export function resolveAccount(
  ...
  const envBotName = normalizeOptionalString(process.env.AETHER_BOT_NAME) ?? "Aether";
