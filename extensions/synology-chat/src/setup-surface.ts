...
function getChannelConfig(cfg: AetherConfig): SynologyChatChannelConfig {
  return (cfg.channels?.[channel] as SynologyChatChannelConfig | undefined) ?? {};
}

function getRawAccountConfig(cfg: AetherConfig, accountId: string): SynologyChatAccountRaw {
...
function isSynologyChatConfigured(cfg: AetherConfig, accountId: string): boolean {
...
function resolveExistingAllowedUserIds(cfg: AetherConfig, accountId: string): string[] {
