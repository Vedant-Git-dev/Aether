...
import type { ResolvedChannelImplicitMentions } from "aether/plugin-sdk/channel-ingress-runtime";
...
function resolveTlonChannelConfig(cfg: AetherConfig): TlonAccountConfig | undefined {
