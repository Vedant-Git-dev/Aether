...
function createStepFunPresetAppliers(params: {
  ...
  return createModelCatalogPresetAppliers<[string]>({
    ...
    resolveParams: (cfg: AetherConfig, baseUrl: string) => {
...
export function applyStepFunStandardConfigCn(cfg: AetherConfig): AetherConfig {
  return stepFunPresetAppliers.applyConfig(cfg, STEPFUN_STANDARD_CN_BASE_URL);
}

export function applyStepFunStandardConfig(cfg: AetherConfig): AetherConfig {
  return stepFunPresetAppliers.applyConfig(cfg, STEPFUN_STANDARD_INTL_BASE_URL);
}

export function applyStepFunPlanConfigCn(cfg: AetherConfig): AetherConfig {
  return stepFunPlanPresetAppliers.applyConfig(cfg, STEPFUN_PLAN_CN_BASE_URL);
}

export function applyStepFunPlanConfig(cfg: AetherConfig): AetherConfig {
