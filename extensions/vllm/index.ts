import { defineSelfHostedOpenAICompatibleProvider } from "aether/plugin-sdk/provider-model-shared";
import {
...
export default defineSelfHostedOpenAICompatibleProvider({
  ...
  overrides: {
    buildUnknownModelHint: () =>
      ...
      'Set VLLM_API_KEY (any value works) or run "aether configure". ' +
      "See: https://docs.aether.ai/providers/vllm",
