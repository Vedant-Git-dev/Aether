 ...
 */
import type { AetherPluginCommandDefinition } from "aether/plugin-sdk/plugin-entry";
...
export function createCodexCommand(options: CodexCommandOptions): AetherPluginCommandDefinition {
  return {
    name: "codex",
