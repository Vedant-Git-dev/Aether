...
import type { PluginHookInboundClaimEvent } from "aether/plugin-sdk/plugin-entry";
import { normalizeSingleOrTrimmedStringList } from "aether/plugin-sdk/string-coerce-runtime";
...
function extractInboundMedia(event: PluginHookInboundClaimEvent): InboundMedia[] {
  ...
  // Aether channels expose either local staged files or remote URLs. Keep
