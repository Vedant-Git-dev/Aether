...
export function createCodexNodeExecServerCommand(): AetherPluginNodeHostCommand {
...
export function createCodexNodeExecServerInvokePolicy(): AetherPluginNodeInvokePolicy {
  return {
