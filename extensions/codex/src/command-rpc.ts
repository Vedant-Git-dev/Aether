import { prepareAgentRuntimeAuth } from "aether/plugin-sdk/agent-harness-runtime";
...
import { resolveSessionModelRef } from "aether/plugin-sdk/model-session-runtime";
...
export async function prepareCodexControlSessionAuth(
  ...
  // process cannot resume that thread, even after its Aether binding is gone.
