...
} from "aether/plugin-sdk/migration-runtime";
...
const CODEX_PLUGIN_LOAD_WARNING =
  "Some Codex plugins could not be migrated. Run `aether migrate codex` after onboarding.";
...
const TARGET_CODEX_MARKETPLACE_DISCOVERY_TIMEOUT_ENV =
  "AETHER_CODEX_MIGRATION_PLUGIN_LIST_TIMEOUT_MS";
