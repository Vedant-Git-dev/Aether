...
/** Builds the terminal coordination error used when a newer Aether session owns the binding. */
...
/** Lets the authoritative Aether session generation claim a stale stable binding row. */
            ...
            if (mutation.kind === "reclaim-generation") {
              ...
              if (ownsGeneration) {
                if (
                  ...
                  // Reset boundaries now retain the Aether session id. The
