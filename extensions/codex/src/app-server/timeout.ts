/**
 * Thin Codex app-server timeout adapter around Aether's shared timeout helper.
 */
import { withTimeout as withSharedTimeout } from "aether/plugin-sdk/time-runtime";
