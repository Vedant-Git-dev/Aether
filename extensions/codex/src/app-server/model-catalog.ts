import type { AgentHarnessModelCatalogParams } from "aether/plugin-sdk/agent-harness-runtime";
...
// Manifest contract (aether.plugin.json discovery.timeoutMs default): live model
