...
import type { EmbeddedRunAttemptParams } from "aether/plugin-sdk/agent-harness-runtime";
import type { AgentPlanStep } from "aether/plugin-sdk/channel-outbound";
import { truncateUtf8Prefix } from "aether/plugin-sdk/text-utility-runtime";
import { stripInvisibleUnicode } from "aether/plugin-sdk/web-content-extractor";
...
const RESTORED_PLAN_PREAMBLE =
  "Aether restored the session progress card after context compaction. " +
