...
import { splitCommandArgs } from "aether/plugin-sdk/process-runtime";
...
import type { AetherExecAsk, AetherExecSecurity } from "./config-contracts.shared.js";
import type { CodexServiceTier } from "./protocol.js";

const START_OPTIONS_KEY_SECRET_SYMBOL = Symbol.for("aether.codexAppServerStartOptionsKeySecret");
...
export function readExecSecurity(value: unknown): AetherExecSecurity | undefined {
  return value === "deny" || value === "allowlist" || value === "full" ? value : undefined;
}

export function readExecAsk(value: unknown): AetherExecAsk | undefined {
