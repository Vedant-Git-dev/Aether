...
const ARTIFACT_HASH_DOMAIN = "aether-codex-app-server-runtime-artifact-v1\0";
...
const ARTIFACT_BINDINGS_SYMBOL = Symbol.for("aether.codexAppServerRuntimeArtifactBindings");
