  ...
  return {
    message:
      timeout.kind === "execution"
        ...
        : "Codex finished its turn, but Aether could not finish processing the result. Some work may already have been performed; verify the current state before continuing.",
    replayInvalid: true,
