...
import { parseSqliteSessionFileMarker } from "aether/plugin-sdk/session-store-runtime";
...
// Codex owns proactive auto-compaction, but Aether must not resume a native
