...
import { createDedupeCache } from "aether/plugin-sdk/dedupe-runtime";
...
export async function maybeCompactCodexAppServerSession(
  ...
  warnIfIgnoringAetherCompactionOverrides(params);
...
function warnIfIgnoringAetherCompactionOverrides(
  params: CompactEmbeddedAgentSessionParams,
): void {
  ...
  embeddedAgentLog.warn(
    "ignoring Aether compaction overrides for Codex app-server compaction; Codex uses native server-side compaction",
    {
        ...
        const completionWatch = watchCodexNativeCompactionCompletion({
          ...
          retireUnconfirmed: async () => {
            ...
            if (usesSupervisionConnection) {
              ...
              // Aether-owned remote binding. Keep the lifecycle fence held
