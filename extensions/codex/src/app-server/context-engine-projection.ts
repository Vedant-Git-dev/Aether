import { IMAGE_BLOCK_TOKENS } from "aether/plugin-sdk/agent-core";
/**
 * Projects Aether context-engine assemblies into Codex prompt text while
 * preserving safety boundaries and redacting tool payloads.
 */
import {
  isAetherRuntimeContextCustomMessage,
  type AgentMessage,
} from "aether/plugin-sdk/agent-harness-runtime";
import type { ImageContent } from "aether/plugin-sdk/llm";
import { redactSensitiveFieldValue, redactToolPayloadText } from "aether/plugin-sdk/logging-core";
...
const CONTEXT_HEADER = "Aether assembled context for this turn:";
...
export function isCodexDurableCustomMessage(message: AgentMessage): boolean {
  return (
    ...
    !isAetherRuntimeContextCustomMessage(message)
  );
}

/** Projects assembled Aether context-engine messages into Codex prompt inputs. */
