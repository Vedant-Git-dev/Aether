import type { AgentHarnessV2 } from "aether/plugin-sdk/agent-harness-runtime";
...
export async function readCodexNativeSubagentHistory(
  ...
  try {
    ...
    // Nested children share the Aether requester, but native lineage records their immediate parent.
