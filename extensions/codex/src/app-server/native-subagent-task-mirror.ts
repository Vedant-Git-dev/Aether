/**
 * Mirrors Codex native subagent thread lifecycle events into Aether task
 * runtime rows so parent sessions can observe child progress.
 */
import type { AgentHarnessTaskRuntime } from "aether/plugin-sdk/agent-harness-task-runtime";
import {
...
/** Converts a Codex child thread id into the Aether task-runtime run id. */
