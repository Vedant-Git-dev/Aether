/**
 * Routes Codex app-server plugin approval prompts through Aether's gateway
 * approval tool and maps gateway decisions back to Codex outcomes.
 */
import type { EmbeddedRunAttemptParamsV2 as EmbeddedRunAttemptParams } from "aether/plugin-sdk/agent-harness-runtime";
import { isApprovalNotFoundError, toErrorObject } from "aether/plugin-sdk/error-runtime";
...
/** Starts a two-phase plugin approval request through the Aether gateway. */
