...
import { buildNativeHookRelayCommandPlan } from "aether/plugin-sdk/native-hook-relay-runtime";
...
import { resolveAetherExecPolicyForCodexAppServer } from "./config-exec-approvals.js";
...
export async function prepareCanonicalCodexFork(params: {
  ...
  const runtime = resolveCodexSupervisionAppServerRuntimeOptions({
    ...
    execPolicy: resolveAetherExecPolicyForCodexAppServer({
      config,
      agentId: created.agentId,
