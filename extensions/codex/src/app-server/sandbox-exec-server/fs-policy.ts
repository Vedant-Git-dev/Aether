/**
 * Resolves Codex filesystem sandbox policy payloads into Aether path/glob
...
function readFsSandboxCwd(execServer: AetherExecServer, sandbox: JsonObject): string {
