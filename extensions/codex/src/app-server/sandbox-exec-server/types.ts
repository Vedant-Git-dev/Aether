...
/** Locally interpreted exec-server protocol backed by an Aether sandbox. */
export type AetherExecServer = AetherExecServerLease & {
...
export type AetherNodeExecServer = AetherExecServerLease & {
  node: {
    id: string;
...
export type AetherLeasedExecServer = AetherExecServer | AetherNodeExecServer;
