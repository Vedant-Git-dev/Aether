...
import { buildRemoteCommand, sanitizeEnvVars } from "aether/plugin-sdk/sandbox";
...
import type { ManagedProcess, AetherExecServer, ProcessChunk } from "./types.js";
...
function assertSupportedProcessSandbox(execServer: AetherExecServer, record: JsonObject): void {
