...
import type { AssistantMessage, Usage } from "aether/plugin-sdk/llm";
import type { SessionTranscriptMessageEntry } from "aether/plugin-sdk/session-transcript-runtime";
          ...
          ? attachCodexMirrorIdentity(
              {
                ...
                ...(turn.status === "failed" && turn.error?.message
                  ...
                  : {}),
                ...(phase ? { phase } : {}),
                ...(asyncDelivery && itemId ? { aetherAsyncDelivery: { itemId } } : {}),
                timestamp,
      ...
      .filter(
        ({ message }) =>
          ...
          (message.stopReason !== "aborted" &&
            ...
            !("aetherAsyncDelivery" in message)),
      )
  ...
  for (const entry of entries) {
    ...
    if (
      ...
      (("stopReason" in entry.message &&
        ...
        "aetherAsyncDelivery" in entry.message)
    ) {
      continue;
    }
