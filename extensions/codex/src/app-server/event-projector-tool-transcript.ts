...
import type { Usage } from "aether/plugin-sdk/llm";
...
const MISSING_TOOL_RESULT_ERROR =
  "Aether recorded a native Codex tool.call without a matching tool.result before the turn completed.";
  ...
  private createToolResultMessage(
    ...
    return {
      ...
      ...(params.resultContentSource
        ? { __aether: { resultContentSource: params.resultContentSource } }
        : {}),
      timestamp: this.nextTranscriptTimestamp(),
