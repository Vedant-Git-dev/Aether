...
import { buildCodexUserMcpServersThreadConfigPatchForRun } from "aether/plugin-sdk/codex-mcp-projection";
...
export async function prepareCodexThreadLifecyclePreflight(params: CodexStartOrResumeThreadParams) {
  ...
  const hostSystemAgentActive =
    params.hostSystemAgentActive ?? isHostScopedAgentToolActive("aether");
