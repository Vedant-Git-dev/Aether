import { withTrustedEnvProxyGuardedFetchMode } from "aether/plugin-sdk/fetch-runtime";
// Deepinfra provider module implements model/runtime integration.
import { isProviderApiKeyConfigured } from "aether/plugin-sdk/provider-auth";
import { fetchLiveProviderModelRows } from "aether/plugin-sdk/provider-catalog-live-runtime";
import { getCachedLiveCatalogValue } from "aether/plugin-sdk/provider-catalog-shared";
import type { ModelDefinitionConfig } from "aether/plugin-sdk/provider-model-shared";
...
import { asPositiveSafeInteger, isRecord } from "aether/plugin-sdk/string-coerce-runtime";
import {
  DEEPINFRA_BASE_URL,
...
const DEEPINFRA_MODELS_URL = `${DEEPINFRA_BASE_URL}/models?sort_by=aether&filter=with_meta`;
...
// Static fallback. Chat rows live in aether.plugin.json (manifest-validated);
...
// `/v1/openai/models?sort_by=aether&filter=with_meta` projection is the
