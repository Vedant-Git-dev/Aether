...
} from "aether/plugin-sdk/provider-auth-runtime";
import {
...
type GoogleTransportApi = CanonicalGoogleTransportApi | "aether-google-generative-ai-transport";
...
const GOOGLE_GEMINI3_FIRST_RESPONSE_RETRY_ENV = "AETHER_GOOGLE_GEMINI_FIRST_RESPONSE_RETRY_MS";
...
function normalizeGoogleTransportRouteApi(
  ...
  switch (api) {
    ...
    case "aether-google-generative-ai-transport":
