...
import { withTimeout } from "aether/plugin-sdk/text-utility-runtime";
import {
...
const VERTEX_ADC_TEST_API_KEY = Symbol.for("aether.google.vertexAdcTestApi");
 ...
 * existing fetchImpl test seam and the Aether upstream behaviour); when the
