...
import type { tryReadSecretFileSync } from "aether/plugin-sdk/secret-file-runtime";
...
export type ClickClackAccountConfig = {
  ...
  commandMenu?: boolean;
  /** Create and synchronize one managed ClickClack channel per Aether session. */
...
/** Aether config narrowed to include ClickClack channel settings. */
export type CoreConfig = AetherConfig & {
