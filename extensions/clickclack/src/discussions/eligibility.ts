import type { SessionDiscussionInfo } from "aether/plugin-sdk/session-discussion";
...
export function discussionInfoForBinding(
  ...
  return {
    ...
    embedUrl: `${baseUrl}/embed/channel/${encodeURIComponent(binding.workspaceRouteId)}/${encodeURIComponent(binding.channelRouteId)}?aetherHostTheme=1`,
