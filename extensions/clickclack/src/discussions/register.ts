...
import { registerSessionDiscussionProvider } from "aether/plugin-sdk/session-discussion";
import { createSessionVisibilityChecker } from "aether/plugin-sdk/session-visibility";
...
export function registerClickClackDiscussions(api: AetherPluginApi): void {
