...
import type { AetherPluginGatewayEvents, PluginRuntime } from "aether/plugin-sdk/core";
import type {
  SessionDiscussionInfo,
  SessionDiscussionProvider,
} from "aether/plugin-sdk/session-discussion";
...
type DiscussionServiceOptions = {
  ...
  gatewayEvents?: Pick<AetherPluginGatewayEvents, "onSessionsChanged">;
  startTimer?: boolean;
...
export class ClickClackDiscussionService {
  ...
  bindGatewayEvents(
    gatewayEvents: Pick<AetherPluginGatewayEvents, "onSessionsChanged"> | undefined,
  ): void {
