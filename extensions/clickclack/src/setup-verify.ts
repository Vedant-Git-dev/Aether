...
import { hasConfiguredSecretInput } from "aether/plugin-sdk/setup";
...
const GATEWAY_RUNNING_MESSAGE = "Aether is running — ClickClack will connect automatically.";
const GATEWAY_NOT_RUNNING_MESSAGE = "Start Aether to connect: aether gateway";
const GATEWAY_UNKNOWN_MESSAGE =
  "If Aether is running it connects automatically; otherwise start it with: aether gateway";
