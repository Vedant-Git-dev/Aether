...
} from "aether/plugin-sdk/channel-route";
import type { AetherConfig } from "aether/plugin-sdk/config-contracts";
import { normalizeMessageChannel } from "aether/plugin-sdk/routing";
import {
...
type ApprovalForwardingConfig = NonNullable<NonNullable<AetherConfig["approvals"]>["plugin"]>;
...
function resolvePluginApprovalForwardingConfig(cfg: AetherConfig) {
