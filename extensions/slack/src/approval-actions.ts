...
import { buildApprovalResolutionRef } from "aether/plugin-sdk/approval-reference-runtime";
import type { MessagePresentationAction } from "aether/plugin-sdk/interactive-runtime";
import { SLACK_BUTTON_VALUE_MAX } from "./presentation.js";

const SLACK_APPROVAL_VALUE_PREFIX = "aether:approval:v1:";
export const SLACK_APPROVAL_HEADER_BLOCK_ID = "aether_approval_header";
