...
} from "aether/plugin-sdk/allowlist-config-edit";
import { adaptScopedAccountAccessor } from "aether/plugin-sdk/channel-config-helpers";
import {
...
//
// `aether/plugin-sdk/channel-policy` is intentionally NOT lazy here —
...
const EXTENSION_SHARED_MODULE_ID = "aether/plugin-sdk/extension-shared";
const TARGET_RESOLVER_RUNTIME_MODULE_ID = "aether/plugin-sdk/target-resolver-runtime";
  ...
  base: {
    ...
    actions: createSlackActions(SLACK_CHANNEL, {
      invoke: async (action, cfg, toolContext) =>
        ...
        )(action, cfg as AetherConfig, toolContext as SlackActionContext | undefined),
    }),
