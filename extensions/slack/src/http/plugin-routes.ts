...
import type { AetherPluginApi } from "aether/plugin-sdk/channel-plugin-common";
...
function resolveSlackWebhookPaths(config: AetherPluginApi["config"]): string[] {
...
export function registerSlackPluginHttpRoutes(api: AetherPluginApi): void {
