...
type BuildCommandTextFromArgs =
  typeof import("aether/plugin-sdk/command-auth-native").buildCommandTextFromArgs;
type FindCommandByNativeName =
  typeof import("aether/plugin-sdk/command-auth-native").findCommandByNativeName;
type ListNativeCommandSpecsForConfig =
  typeof import("aether/plugin-sdk/command-auth-native").listNativeCommandSpecsForConfig;
type ParseCommandArgs = typeof import("aether/plugin-sdk/command-auth-native").parseCommandArgs;
type ResolveCommandArgMenu =
  typeof import("aether/plugin-sdk/command-auth-native").resolveCommandArgMenu;
