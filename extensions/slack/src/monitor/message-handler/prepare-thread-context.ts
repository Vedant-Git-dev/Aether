...
import type { ContextVisibilityMode, AetherConfig } from "aether/plugin-sdk/config-contracts";
...
} from "aether/plugin-sdk/security-runtime";
...
type SlackSessionFreshnessRuntime = {
  session?: {
    resolveEntryResetFreshness?: (params: {
      ...
      storePath?: string;
      sessionKey: string;
      sessionCfg?: AetherConfig["session"];
      resetType: "thread";
...
export async function resolveSlackThreadContextData(params: {
  ...
  envelopeOptions: ReturnType<
    typeof import("aether/plugin-sdk/channel-inbound").resolveEnvelopeFormatOptions
  >;
