...
import { logVerbose, getChildLogger } from "aether/plugin-sdk/runtime-env";
...
export type SlackMonitorContext = {
  ...
  slashCommand: Required<import("aether/plugin-sdk/config-contracts").SlackSlashCommandConfig>;
  textLimit: number;
