...
} from "aether/plugin-sdk/reply-chunking";
import { resolveTextChunksWithFallback } from "aether/plugin-sdk/reply-payload";
import { logVerbose } from "aether/plugin-sdk/runtime-env";
import { safeEqualSecret } from "aether/plugin-sdk/security-runtime";
import {
  normalizeOptionalString,
  normalizeOptionalString as normalizeSlackApiString,
  normalizeTrimmedStringList,
} from "aether/plugin-sdk/string-coerce-runtime";
import { sliceUtf16Safe, truncateCodePoints } from "aether/plugin-sdk/text-utility-runtime";
...
const SLACK_DELIVERY_METADATA_EVENT = "aether_delivery";
const SLACK_DELIVERY_METADATA_KEY = "aether_delivery_id";
const SLACK_DELIVERY_METADATA_PART_INDEX_KEY = "aether_delivery_part_index";
const SLACK_DELIVERY_METADATA_PART_COUNT_KEY = "aether_delivery_part_count";
const SLACK_DELIVERY_METADATA_SIGNATURE_KEY = "aether_delivery_signature";
...
function createSlackDeliveryMetadataId(queueId?: string): string | undefined {
  ...
  // store key inside Aether while retaining a stable provider-side marker.
