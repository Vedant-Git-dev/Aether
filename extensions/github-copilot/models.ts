...
import { readProviderJsonArrayFieldResponse } from "aether/plugin-sdk/provider-http";
import type { ModelDefinitionConfig } from "aether/plugin-sdk/provider-model-shared";
import { normalizeModelCompat } from "aether/plugin-sdk/provider-model-shared";
import {
...
export function resolveCopilotForwardCompatModel(
  ...
  // by simply adding them to agents.defaults.models in aether.json — no
