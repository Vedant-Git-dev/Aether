...
import { supportsClaudeAdaptiveThinking } from "aether/plugin-sdk/claude-model-runtime";
import { buildManifestModelProviderConfig } from "aether/plugin-sdk/provider-model-metadata";
