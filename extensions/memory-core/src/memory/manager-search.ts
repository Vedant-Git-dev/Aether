...
const EXACT_PATH_SPECIFICITY_SQL_FUNCTION = "aether_memory_exact_path_specificity";
const NORMALIZED_CONTAINS_SQL_FUNCTION = "aether_memory_normalized_contains";
