...
const MEMORY_INDEX_MANAGER_CACHE_KEY = Symbol.for("aether.memoryIndexManagers");
const MEMORY_INDEX_MANAGER_SCOPE_CLOSES_KEY = Symbol.for("aether.memoryIndexManagerScopeCloses");
const MEMORY_INDEX_MANAGER_GLOBAL_LIFECYCLE_KEY = Symbol.for(
  "aether.memoryIndexManagerGlobalLifecycle.v3",
);
