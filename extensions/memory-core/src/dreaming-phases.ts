...
import { extractErrorCode } from "aether/plugin-sdk/error-runtime";
import { truncateUtf16Safe } from "aether/plugin-sdk/memory-core-host-engine-foundation";
import { listSessionTranscriptCorpusEntriesForAgent } from "aether/plugin-sdk/memory-core-host-engine-sessions";
import { listMemoryArtifactProvenance } from "aether/plugin-sdk/memory-core-host-runtime-core";
...
} from "aether/plugin-sdk/memory-core-host-status";
...
type Logger = Pick<AetherPluginApi["logger"], "info" | "warn" | "error">;
...
const MANAGED_DAILY_DREAMING_BLOCKS = [
  {
    heading: "## Light Sleep",
    startMarker: "<!-- aether:dreaming:light:start -->",
    endMarker: "<!-- aether:dreaming:light:end -->",
  },
  {
    heading: "## REM Sleep",
    startMarker: "<!-- aether:dreaming:rem:start -->",
    endMarker: "<!-- aether:dreaming:rem:end -->",
  },
] as const;
