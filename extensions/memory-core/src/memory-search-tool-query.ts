...
import type { AetherConfig } from "aether/plugin-sdk/memory-core-host-runtime-core";
  ...
  const cause =
    diagnostic.owner === "configuration"
      ...
      : diagnostic.code === "metadata_missing"
        ...
        : `this Aether version changed the memory index format (${diagnostic.reason}); no configuration change is needed`;
