...
import { replaceManagedMarkdownBlock } from "aether/plugin-sdk/memory-host-markdown";
import { readRegularFile, replaceFileAtomic } from "aether/plugin-sdk/security-runtime";
...
const DEEP_START_MARKER = "<!-- aether:dreaming:deep:start -->";
const DEEP_END_MARKER = "<!-- aether:dreaming:deep:end -->";
...
const DIARY_START_MARKER = "<!-- aether:dreaming:diary:start -->";
const DIARY_END_MARKER = "<!-- aether:dreaming:diary:end -->";
const BACKFILL_ENTRY_MARKER = "aether:dreaming:backfill-entry";
