...
import type { AgentMessage, SandboxContext } from "aether/plugin-sdk/agent-harness-runtime";
import {
  detectAndLoadAgentHarnessPromptImages,
  getModelProviderRequestTransport,
  resolveUserPath,
} from "aether/plugin-sdk/agent-harness-runtime";
import { toStringifiedError as toCopilotError } from "aether/plugin-sdk/error-runtime";
...
export function createResult(
  ...
  state: {
    ...
    contextEngineTerminalAnchor?: import("aether/plugin-sdk/session-transcript-runtime").TranscriptEntryAnchor;
