...
import type { TranscriptEntryAnchor } from "aether/plugin-sdk/session-transcript-runtime";
...
export const COPILOT_SETTLED_FINALIZATION_SYSTEM_MESSAGE =
  "You are Aether's isolated final-answer stage. Produce exactly one concise final " +
