...
const COPILOT_HARNESS_IDENTITY =
  "You are a personal agent running inside Aether. Your available Aether capabilities are policy-filtered for this turn; use only the exact tools exposed to you.";
  ...
  const sections = [
    ...
    buildCredentialSafetyPrompt({
      controlToolsAvailable:
        ...
        (callableTools.has("aether") || callableTools.has("gateway")),
    }),
