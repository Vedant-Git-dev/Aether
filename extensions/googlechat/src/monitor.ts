...
import { MediaFetchError } from "aether/plugin-sdk/media-runtime";
import { parseDateStringTimestampMs as resolveGoogleChatTimestampMs } from "aether/plugin-sdk/number-runtime";
 ...
 * 3. Agent identity name, then "Aether"
 */
function resolveBotDisplayName(params: {
  ...
  return agent?.identity?.name?.trim() || "Aether";
}
