// Xiaomi plugin entrypoint registers its Aether integration.
...
import {
  ...
  validateApiKeyInput,
} from "aether/plugin-sdk/provider-auth-api-key";
...
import { PROVIDER_LABELS } from "aether/plugin-sdk/provider-usage";
import {
...
async function runXiaomiApiKeyAuth(
  ...
  params: {
    ...
    expectedKind: "payg" | "token-plan";
    defaultModel: string;
    applyConfig: (cfg: AetherConfig) => AetherConfig;
  },
