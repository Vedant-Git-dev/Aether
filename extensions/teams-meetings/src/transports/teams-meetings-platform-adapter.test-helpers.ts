...
export const MEETING_STATE_KEY = "__aetherTeamsMeeting";
...
export async function runStatusScript(params: StatusScriptParams) {
  ...
  if (params.priorAudioOutputs) {
    window["__aetherTeamsAudioOutputs"] = params.priorAudioOutputs;
  }
  if (params.priorCaptions) {
    window["__aetherTeamsCaptions"] = params.priorCaptions;
  }
...
export function continueStatusScript(previous: StatusScriptPage, params: StatusScriptParams = {}) {
  return runStatusScript({
    ...params,
    priorAudioOutputs: previous.window["__aetherTeamsAudioOutputs"] as unknown[],
...
export function runCaptionRows(
  ...
  return runCaptionStatusScript({
    captionRows,
    priorCaptions: previous?.window["__aetherTeamsCaptions"],
    ...params,
  });
}
