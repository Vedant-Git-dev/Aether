...
import { asOptionalRecord as asPayloadRecord } from "aether/plugin-sdk/string-coerce-runtime";
import {
  isQwen38ModelId,
  ...
  return createPayloadPatchStreamWrapper(
    ...
    ({ payload: payloadObj, model, options }) => {
      ...
      if (isQwen38ModelId(model.id) && effectiveThinkingFormat === undefined) {
        ...
        // GLM accepts Aether's reasoning levels directly; only GLM 5.2 accepts max.
        patchTokenPlanGlmPayload(
          payloadObj,
