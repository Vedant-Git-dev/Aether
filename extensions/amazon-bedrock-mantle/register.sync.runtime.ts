...
import type { AetherPluginApi, ProviderRuntimeModel } from "aether/plugin-sdk/plugin-entry";
...
/** Register the Amazon Bedrock Mantle provider with Aether. */
export function registerBedrockMantlePlugin(api: AetherPluginApi): void {
