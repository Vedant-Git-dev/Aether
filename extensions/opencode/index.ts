// Opencode plugin entrypoint registers its Aether integration.
import { runLiveProviderCatalog } from "aether/plugin-sdk/provider-catalog-live-runtime";
import { resolveFirstProviderCatalogAuth } from "aether/plugin-sdk/provider-catalog-shared";
...
import { createOpenAICompatibleCompletionsThinkingOffWrapper } from "aether/plugin-sdk/provider-stream-shared";
