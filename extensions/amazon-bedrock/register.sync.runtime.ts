...
import type { Context, Model } from "aether/plugin-sdk/llm";
...
import { splitSystemPromptCacheBoundary } from "aether/plugin-sdk/provider-transport-runtime";
 ...
 * the Aether config region differs from the profile's home region.
 */
...
export function registerAmazonBedrockPlugin(api: AetherPluginApi): void {
