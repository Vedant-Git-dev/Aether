 ...
 */
import { resolveAwsSdkEnvVarName } from "aether/plugin-sdk/provider-auth-runtime";
import type { ModelProviderConfig } from "aether/plugin-sdk/provider-model-shared";

/** Resolve the config auth marker that tells Aether to use AWS SDK credentials. */
