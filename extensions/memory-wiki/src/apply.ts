...
import { readFiniteNumberParam } from "aether/plugin-sdk/param-readers";
...
const GENERATED_START = "<!-- aether:wiki:generated:start -->";
const GENERATED_END = "<!-- aether:wiki:generated:end -->";
const HUMAN_START = "<!-- aether:human:start -->";
const HUMAN_END = "<!-- aether:human:end -->";
