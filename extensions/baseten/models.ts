...
import { asNonArrayRecord, filterStringEntries } from "aether/plugin-sdk/string-coerce-runtime";
...
/** Projects Baseten's authenticated `/models` response into Aether model rows. */
