 ...
 */
const ACCOUNT_STATES_KEY = Symbol.for("aether.mattermost.slash-account-states");
...
export function activateSlashCommands(params: {
  ...
  triggerMap?: Map<string, string>;
  api: {
    cfg: import("./runtime-api.js").AetherConfig;
 ...
 */
export function registerSlashCommandRoute(api: AetherPluginApi) {
