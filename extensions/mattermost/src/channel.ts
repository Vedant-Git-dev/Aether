...
import { identityEntryAuthenticationClassifier } from "aether/plugin-sdk/channel-ingress-runtime";
import { createChannelMessageAdapterFromOutbound } from "aether/plugin-sdk/channel-outbound";
import { createLoggedPairingApprovalNotifier } from "aether/plugin-sdk/channel-pairing";
import { createRestrictSendersChannelSecurity } from "aether/plugin-sdk/channel-policy";
import {
  attachChannelToResult,
  createAttachedChannelResultAdapter,
  type ChannelOutboundAdapter,
} from "aether/plugin-sdk/channel-send-result";
import type { AetherConfig } from "aether/plugin-sdk/config-contracts";
import { createChannelDirectoryAdapter } from "aether/plugin-sdk/directory-runtime";
import { buildPassiveProbedChannelStatusSummary } from "aether/plugin-sdk/extension-shared";
import {
  type MessagePresentation,
  resolveMessagePresentationButtonAction,
} from "aether/plugin-sdk/interactive-runtime";
import { createLazyRuntimeModule } from "aether/plugin-sdk/lazy-runtime";
import { resolvePayloadMediaUrls, sendTextMediaPayload } from "aether/plugin-sdk/reply-payload";
import { isPrivateNetworkOptInEnabled } from "aether/plugin-sdk/ssrf-runtime";
import {
...
export const mattermostPlugin: ChannelPlugin<ResolvedMattermostAccount> = createChatChannelPlugin({
  ...
  pairing: {
    text: {
      ...
      message: "Aether: your access has been approved.",
