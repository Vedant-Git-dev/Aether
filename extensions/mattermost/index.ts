// Mattermost plugin entrypoint registers its Aether integration.
import {
...
function registerSlashCommandRoute(api: AetherPluginApi): void {
  const register = loadBundledEntryExportSync<(api: AetherPluginApi) => void>(import.meta.url, {
