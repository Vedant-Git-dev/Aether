...
import { CUSTOM_LOCAL_AUTH_MARKER } from "aether/plugin-sdk/provider-auth";
...
export function registerLlamaCppProvider(api: AetherPluginApi): void {
    ...
    auth: [
      ...
      },
      {
        ...
        wizard: {
          ...
          choiceHint: "Connect to a llama.cpp server managed outside Aether",
          groupId: LLAMA_CPP_PROVIDER_ID,
          groupLabel: "Local llama.cpp",
          groupHint: "Managed or external llama.cpp server",
