...
import { asBoolean, asPositiveSafeInteger } from "aether/plugin-sdk/string-coerce-runtime";
...
/** Maps one llama-server model row plus optional runtime properties into Aether config. */
