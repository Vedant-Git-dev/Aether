...
import { applyProviderDefaultModel } from "aether/plugin-sdk/provider-setup";
import {
...
function stripLlamaServerEndpointAuth(config: AetherConfig): AetherConfig {
...
async function removeDefaultAuthProfile(config: AetherConfig, agentDir?: string): Promise<void> {
