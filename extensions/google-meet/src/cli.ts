...
import { generateHexPkceVerifierChallenge } from "aether/plugin-sdk/provider-auth";
import { generateOAuthState } from "aether/plugin-sdk/provider-auth-runtime";
...
export function registerGoogleMeetCli(params: {
  ...
  const root = params.program
    ...
    .addHelpText("after", () => `\nDocs: https://docs.aether.ai/plugins/google-meet\n`);
