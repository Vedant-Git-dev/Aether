...
export const legacyConfigRules: LegacyConfigRule[] = [
  {
    ...
    message:
      'plugins.entries.google-meet.config.realtime.provider="google" is legacy for Gemini Live bidi mode; use realtime.voiceProvider="google" and realtime.transcriptionProvider="openai". Run "aether doctor --fix".',
    match: hasLegacyGoogleRealtimeProvider,
  },
];

function migrateGoogleMeetLegacyRealtimeProvider(config: AetherConfig): {
  config: AetherConfig;
  changes: string[];
} | null {
