...
export const GoogleMeetToolSchema = Type.Object({
  ...
  mode: Type.Optional(
    Type.String({
      ...
      description:
        "Join mode. agent uses realtime transcription, the configured Aether agent, and regular TTS. bidi uses the realtime voice model directly. transcribe joins observe-only.",
    }),
  ),
