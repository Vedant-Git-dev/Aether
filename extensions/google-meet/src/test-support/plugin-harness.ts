...
import type { AnyAgentTool, AetherPluginApi } from "aether/plugin-sdk/plugin-entry";
import { createTestPluginApi } from "aether/plugin-sdk/plugin-test-api";
...
export function setupGoogleMeetPlugin(
  ...
  const api = createTestPluginApi({
    ...
    } as unknown as AetherPluginApi["runtime"],
    logger: noopLogger,
