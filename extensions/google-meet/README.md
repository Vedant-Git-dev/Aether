...
Official Google Meet participant plugin for Aether.
...
```bash
aether plugins install @aether/google-meet
```
...
- https://docs.aether.ai/plugins/google-meet

## Package

- Plugin id: `google-meet`
- Tool: `google_meet`
- Package: `@aether/google-meet`
- Minimum Aether host: `2026.4.20`
