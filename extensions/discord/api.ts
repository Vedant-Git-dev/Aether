...
// Deprecated compatibility surface for existing @aether/discord/api.js consumers.
...
export { resolveOpenProviderRuntimeGroupPolicy as resolveDiscordRuntimeGroupPolicy } from "aether/plugin-sdk/runtime-group-policy";
...
/**
 * @deprecated Shipped `@aether/discord/api` compatibility only. Use native
