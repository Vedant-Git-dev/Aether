...
import type { ExecApprovalActionDescriptor } from "aether/plugin-sdk/approval-reply-runtime";
...
import { logDebug, logError } from "aether/plugin-sdk/logging-core";
...
function createApprovalContainer(params: {
  ...
  const approvalLabel = plugin ? "Plugin" : systemAgent ? "Aether Change" : "Exec";
