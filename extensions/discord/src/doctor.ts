...
export function scanDiscordNumericIdEntries(cfg: AetherConfig): DiscordNumericIdHit[] {
...
function collectDiscordTranscriptsAutoStartWarnings(cfg: AetherConfig): string[] {
...
function collectDiscordMutableAllowlistWarnings(cfg: AetherConfig): string[] {
