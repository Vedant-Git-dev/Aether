...
import type { OutboundMediaAccess } from "aether/plugin-sdk/media-runtime";
...
import { hasNonEmptyString, uniqueStrings } from "aether/plugin-sdk/string-coerce-runtime";
