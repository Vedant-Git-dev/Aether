...
import { createSubsystemLogger, formatDurationSeconds } from "aether/plugin-sdk/runtime-env";

export type DiscordListenerLogger = ReturnType<
  typeof import("aether/plugin-sdk/runtime-env").createSubsystemLogger
>;
