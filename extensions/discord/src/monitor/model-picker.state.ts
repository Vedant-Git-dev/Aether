...
import type { ModelsProviderData } from "aether/plugin-sdk/models-provider-runtime";
import { parseStrictInteger, parseStrictPositiveInteger } from "aether/plugin-sdk/number-runtime";
...
const loadModelsProviderRuntime = createLazyRuntimeModule(
  () => import("aether/plugin-sdk/models-provider-runtime"),
);
...
export async function loadDiscordModelPickerData(
  ...
  agentId?: string,
  options?: Parameters<
    typeof import("aether/plugin-sdk/models-provider-runtime").buildPreparedModelsProviderData
  >[2],
): ReturnType<
  typeof import("aether/plugin-sdk/models-provider-runtime").buildPreparedModelsProviderData
> {
