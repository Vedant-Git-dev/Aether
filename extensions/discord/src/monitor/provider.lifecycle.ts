...
import { createTransportActivityStatusPatch } from "aether/plugin-sdk/gateway-runtime";
import { asDateTimestampMs, parseStrictPositiveInteger } from "aether/plugin-sdk/number-runtime";
import { danger, sleepWithAbort } from "aether/plugin-sdk/runtime-env";
...
const DISCORD_GATEWAY_READY_TIMEOUT_ENV = "AETHER_DISCORD_READY_TIMEOUT_MS";
const DISCORD_GATEWAY_RUNTIME_READY_TIMEOUT_ENV = "AETHER_DISCORD_RUNTIME_READY_TIMEOUT_MS";
