...
import type { DiscordAccountConfig } from "aether/plugin-sdk/config-contracts";
import { createNodeProxyAgent } from "aether/plugin-sdk/fetch-runtime";
import {
  captureWsEvent,
  resolveEffectiveDebugProxyUrl,
  resolveDebugProxySettings,
} from "aether/plugin-sdk/proxy-capture";
import { danger, warn } from "aether/plugin-sdk/runtime-env";
...
type ResolveDiscordGatewayIntentsParams = {
  intentsConfig?: import("aether/plugin-sdk/config-contracts").DiscordIntentsConfig;
...
function createGatewayPlugin(params: {
  ...
  class AetherGatewayPlugin extends discordGateway.GatewayPlugin {
  ...
  return new AetherGatewayPlugin();
}
...
export function createDiscordGatewayPlugin(params: {
  ...
  return createGatewayPlugin({
    options: {
      ...
      intents,
      // Aether registers its own async interaction listener.
