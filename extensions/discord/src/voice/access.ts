...
import { resolveCommandAuthorizedFromAuthorizers } from "aether/plugin-sdk/command-auth-native";
import type { AetherConfig, DiscordAccountConfig } from "aether/plugin-sdk/config-contracts";
