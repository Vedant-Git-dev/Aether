...
export function resolveDiscordCommandOwnerEntries(cfg: AetherConfig): string[] | undefined {
...
export function resolveDiscordCommandOwnerAllowFrom(cfg: AetherConfig): string[] | undefined {
