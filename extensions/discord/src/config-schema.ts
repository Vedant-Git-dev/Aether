import { normalizeLegacyDmAliases } from "aether/plugin-sdk/channel-config-helpers";
...
import * as channelConfigSchema from "aether/plugin-sdk/channel-config-schema";
