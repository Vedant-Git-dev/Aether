...
import { readStringParam, withNormalizedTimestamp } from "aether/plugin-sdk/channel-actions";
...
export type DiscordMessagingActionContext = {
  ...
  withOpts: (extra?: Record<string, unknown>) => { cfg: AetherConfig; accountId?: string };
