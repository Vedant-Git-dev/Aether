...
export function registerBrowserFilesAndDownloadsCommands(
  ...
  browser
    ...
    .argument(
      "<paths...>",
      "File paths to upload from Aether temp uploads or managed inbound media (e.g. /tmp/aether/uploads/file.pdf or media://inbound/<id>)",
    )
  ...
  browser
    ...
    .argument(
      "[path]",
      "Save path within aether temp downloads dir (default: /tmp/aether/downloads/...; fallback: os.tmpdir()/aether/downloads/...)",
    )
    .option("--target-id <id>", BROWSER_TAB_REFERENCE_HELP)
    .option(
      "--timeout-ms <ms>",
  ...
  browser
    ...
    .argument(
      "<path>",
      "Save path within aether temp downloads dir (e.g. report.pdf or /tmp/aether/downloads/report.pdf)",
    )
    .option("--target-id <id>", BROWSER_TAB_REFERENCE_HELP)
    .option(
      "--timeout-ms <ms>",
