...
const volatileStateSymbol = Symbol.for("aether.browser.session-tabs.volatile");
const volatileCleanupStateSymbol = Symbol.for("aether.browser.session-tabs.volatile-cleanup");
const activeDurableStateSymbol = Symbol.for("aether.browser.session-tabs.active-durable-keys");
const coldNativeActivityStateSymbol = Symbol.for(
  "aether.browser.session-tabs.cold-native-activity",
);
