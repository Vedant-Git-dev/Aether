...
export const BROWSER_RELAY_EXTENSION_SUBPROTOCOL = "aether-extension-relay.v2";
export const BROWSER_RELAY_AUTH_CHALLENGE_PATH = "/_aether/relay/auth/v2/challenge";
export const BROWSER_RELAY_AUTH_COMPLETE_PATH = "/_aether/relay/auth/v2/complete";
