 ...
 *
 * The relay authenticates the loopback link between Aether and the paired
...
import { createSecretFileAtomic, tryReadSecretFileSync } from "aether/plugin-sdk/secret-file";
 ...
 * startup and `aether browser extension pair` — both run on the machine that
