...
// Aether operations short-circuit instead of re-running the SSRF check on a
...
// Quarantine and close a tab that Aether itself navigated to a blocked URL.
...
/** Quarantine and close a tab that Aether navigated to a blocked URL. */
