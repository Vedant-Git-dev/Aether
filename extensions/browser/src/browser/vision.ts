...
import type { describeImageFile as DescribeImageFileFn } from "aether/plugin-sdk/media-understanding-runtime";
...
export async function describeBrowserScreenshot(
  ...
  const agentId = ctx.agentDir
    ? undefined
    : (await import("aether/plugin-sdk/agent-scope-runtime")).resolveSessionAgentIdStrict({
        agentId: ctx.agentId,
