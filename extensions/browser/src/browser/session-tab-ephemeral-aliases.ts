...
const durableAliasStateSymbol = Symbol.for(
  "aether.browser.session-tabs.interaction-storage-keys",
);
const durableExactStateSymbol = Symbol.for(
  "aether.browser.session-tabs.exact-interaction-storage-keys",
);
const volatileAliasStateSymbol = Symbol.for("aether.browser.session-tabs.volatile-aliases");
const volatileExactStateSymbol = Symbol.for("aether.browser.session-tabs.exact-volatile-aliases");
