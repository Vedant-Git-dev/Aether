// Pure helpers for the Aether extension: pairing-string parsing, reconnect
...
export const AETHER_TAB_GROUP_TITLE = "Aether";
export const ACCESS_MODE_ALL = "all";
export const ACCESS_MODE_SELECTED = "selected";
const EXTENSION_RELAY_PROTOCOL = "aether-extension-relay.v2";
...
const UNSUPPORTED_PROXY_PREFIX_HINT =
  "Stored proxy-prefixed browser relay pairing is no longer supported. Re-run `aether browser extension pair` with a Gateway URL that has no path prefix.";
...
/**
 * Parse a pairing string printed by `aether browser extension pair`.
