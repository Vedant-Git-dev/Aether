...
} from "aether/plugin-sdk/speech-provider";
import {
...
function resolveConfiguredPortalTtsBaseUrl(cfg: AetherConfig | undefined): string | undefined {
...
async function resolveMinimaxPortalProfileToken(
  ...
  const { resolveProviderAuthProfileApiKey } = await import("aether/plugin-sdk/provider-auth");
