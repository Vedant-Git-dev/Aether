/**
 * Voice call response generator - uses the embedded Aether agent for tool support.
...
} from "aether/plugin-sdk/model-session-runtime";
import { isValidAgentHarnessSessionStoreEntry } from "aether/plugin-sdk/session-store-runtime";
import {
  isRecord,
  filterStringEntries,
...
/**
 * Generate a voice response using the embedded Aether agent with full tool support.
