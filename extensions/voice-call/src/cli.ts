...
import { MAX_TCP_PORT } from "aether/plugin-sdk/number-runtime";
import {
  isRecord,
...
function buildSetupStatus(config: VoiceCallConfig, coreConfig: AetherConfig): SetupStatus {
...
export function registerVoiceCallCli(params: {
  ...
  const root = program
    ...
    .addHelpText("after", () => `\nDocs: https://docs.aether.ai/cli/voicecall\n`);
