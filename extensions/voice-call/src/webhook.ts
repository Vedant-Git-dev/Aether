...
import { resolveConfiguredCapabilityProvider } from "aether/plugin-sdk/provider-selection-runtime";
import type { TalkEvent } from "aether/plugin-sdk/realtime-voice";
import {
...
import { rejectWebSocketUpgrade } from "aether/plugin-sdk/websocket-runtime";
import {
...
export class VoiceCallWebhookServer {
  ...
  private coreConfig: AetherConfig | null;
  private fullConfig: AetherConfig | null;
  private agentRuntime: AetherPluginApi["runtime"]["agent"] | null;
  ...
  constructor(
    ...
    coreConfig?: AetherConfig,
    fullConfig?: AetherConfig,
    agentRuntime?: AetherPluginApi["runtime"]["agent"],
    logger?: Logger,
  ) {
  ...
  private async initializeMediaStreaming(): Promise<void> {
    ...
    const pluginConfig =
      this.fullConfig ?? (this.coreConfig as unknown as AetherConfig | undefined);
    ...
    const resolution = resolveConfiguredCapabilityProvider({
      ...
      cfg: pluginConfig,
      cfgForResolve: pluginConfig ?? ({} as AetherConfig),
    ...
    const streamConfig: MediaStreamConfig = {
      ...
      providerConfig,
      cfg: this.fullConfig ?? (this.coreConfig as AetherConfig | null) ?? undefined,
