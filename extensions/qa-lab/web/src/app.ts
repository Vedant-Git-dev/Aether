import { formatErrorMessage as formatSharedErrorMessage } from "aether/plugin-sdk/error-runtime";
import type { QaBusStateSnapshot } from "aether/plugin-sdk/qa-channel-protocol";
  ...
  function bindEvents() {
    ...
    root.querySelector<HTMLSelectElement>("#runtime-pair")?.addEventListener("change", (e) => {
      const runtimePair: RunnerSelection["runtimePair"] =
        (e.currentTarget as HTMLSelectElement).value === "aether,codex"
          ? ["aether", "codex"]
          : null;
