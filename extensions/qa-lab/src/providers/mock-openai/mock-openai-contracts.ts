...
import { readRequestBodyWithLimit } from "aether/plugin-sdk/webhook-ingress";
...
export const QA_WHATSAPP_BROADCAST_PROMPT_RE =
  /\baetherqa broadcast fanout check\s+([A-Z0-9_]+)\b/i;
...
const QA_GROUP_AUDIO_TRANSCRIPTION_TEXT =
  "aetherqa reply with only this exact marker after group audio preflight: WHATSAPP_QA_GROUP_AUDIO_TRANSCRIPT_OK";
const QA_GROUP_AUDIO_TRIGGER_SENTINEL = "AETHER_QA_GROUP_AUDIO_TRIGGER";
