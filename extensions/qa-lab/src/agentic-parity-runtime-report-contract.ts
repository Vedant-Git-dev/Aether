...
export type QaRuntimeParityScenarioReport = {
  ...
  driftDetails?: string;
  aetherStatus: "pass" | "fail" | "missing";
  codexStatus: "pass" | "fail" | "missing";
  aetherTokens: number;
  codexTokens: number;
  aetherUsage: QaRuntimeParityCacheUsage | null;
  codexUsage: QaRuntimeParityCacheUsage | null;
  aetherCacheDiagnostics?: RuntimeParityCacheDiagnostics;
  ...
  aetherBootstrapWallClockMs?: number;
...
export type QaRuntimeParityReport = {
  ...
  usage: {
    aether: QaRuntimeParityCacheUsage | null;
