...
type SlackQaRuntime = typeof import("@aether/slack/test-api.js");
...
export const SLACK_QA_APPROVAL_ACTION_PREFIX = "aether:approval:v1:";
...
export const SLACK_QA_APPROVAL_CHECKPOINT_DIR_ENV = "AETHER_QA_SLACK_APPROVAL_CHECKPOINT_DIR";
export const SLACK_QA_APPROVAL_CHECKPOINT_TIMEOUT_MS_ENV =
  "AETHER_QA_SLACK_APPROVAL_CHECKPOINT_TIMEOUT_MS";
export const SLACK_QA_WEB_API_TIMEOUT_MS = 45_000;
export const SLACK_QA_ENV_KEYS = [
  "AETHER_QA_SLACK_CHANNEL_ID",
  "AETHER_QA_SLACK_DRIVER_BOT_TOKEN",
  "AETHER_QA_SLACK_SUT_BOT_TOKEN",
  "AETHER_QA_SLACK_SUT_APP_TOKEN",
] as const;
