...
import { formatDurationCompact } from "aether/plugin-sdk/time-runtime";
...
\`\`\``;
  ...
  const prompt = `You are grading Aether natural character conversation transcripts for naturalness, vibes, and funniness.
