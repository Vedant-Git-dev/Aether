...
import type {
  AetherCrablineInbound,
  AetherCrablineInboundInput,
  StartedAetherCrablineAdapter,
  StartedAetherCrablineCorrelatedAdapter,
...
export function createCrablineProviderDelivery(
  adapter: Pick<StartedAetherCrablineCorrelatedAdapter, "channel" | "createAgentDelivery">,
  target: string,
) {
