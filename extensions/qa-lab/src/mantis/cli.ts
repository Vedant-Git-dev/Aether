...
export function registerMantisCli(qa: Command) {
  ...
  mantis
    ...
    .option("--guild-id <id>", "Override AETHER_QA_DISCORD_GUILD_ID")
    .option("--channel-id <id>", "Override AETHER_QA_DISCORD_CHANNEL_ID")
  ...
  mantis
    ...
    .option("--gateway-setup", "Start a persistent Aether Slack gateway inside the VNC VM")
    .option(
