...
import { resolveMigrationConfigRuntime } from "aether/plugin-sdk/migration";
import type { MigrationProviderContext } from "aether/plugin-sdk/plugin-entry";
import { applyAuthProfileConfig, type AetherConfig } from "aether/plugin-sdk/provider-auth";
...
export async function applyAuthProfileConfigWithConflictCheck(params: {
  ctx: MigrationProviderContext;
  profile: HermesAuthProfileConfig;
  applyConfigPatch?: (config: AetherConfig) => AetherConfig;
