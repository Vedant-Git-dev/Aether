...
import { updateAuthProfileStoreWithLock } from "aether/plugin-sdk/provider-auth";
...
async function buildOpenCodeSecretCandidates(
  ...
  // Aether's Copilot token profile cannot preserve OpenCode enterprise routing yet.
