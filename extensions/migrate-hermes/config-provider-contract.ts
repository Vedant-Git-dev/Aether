...
import { asPositiveFiniteNumber as readPositiveNumber } from "aether/plugin-sdk/number-runtime";
...
export const HERMES_TRANSPORTS: Record<string, AetherModelApi> = {
...
export function resolveHermesImplicitBaseUrl(providerId: string | undefined): string | undefined {
  ...
  // Aether's qwen default is already Hermes' coding-plan endpoint; no override needed.
...
function normalizeProviderBaseUrl(baseUrl: string, api: AetherModelApi): string {
