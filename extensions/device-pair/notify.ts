...
import type { AetherPluginService } from "aether/plugin-sdk/core";
import { listDevicePairing } from "aether/plugin-sdk/device-bootstrap";
...
import type { PluginStateKeyedStore } from "aether/plugin-sdk/plugin-state-runtime";
...
function openNotifySubscriberStore(api: AetherPluginApi): NotifySubscriberStore {
...
async function notifyPendingPairingRequests(params: { api: AetherPluginApi }): Promise<void> {
...
async function runNotifyPoll(api: AetherPluginApi): Promise<void> {
...
export function createPairingNotifierService(api: AetherPluginApi): AetherPluginService {
