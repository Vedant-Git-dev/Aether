...
import { addApprovalReactionHintToText } from "aether/plugin-sdk/approval-reaction-runtime";
...
import { sleep as delay } from "aether/plugin-sdk/runtime-env";
...
import { resolvePreferredAetherTmpDir, withTempWorkspace } from "aether/plugin-sdk/temp-path";
import {
...
async function withOriginalIMessageAttachmentPath<T>(
  ...
  return await withTempWorkspace(
    { rootDir: resolvePreferredAetherTmpDir(), prefix: "aether-imessage-outbound-" },
