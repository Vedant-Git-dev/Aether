...
import { createAccountListHelpers } from "aether/plugin-sdk/account-helpers";
...
function mergeIMessageAccountConfig(cfg: AetherConfig, accountId: string): IMessageAccountConfig {
...
// caused duplicate inbound handling in aether/aether#65141.
...
function resolveIMessageAccountSourceOwner(params: {
  ...
  // bindings tied to the named account keep working (aether/aether#65141).
 ...
 * watchers (aether/aether#65141) without otherwise marking the duplicate
...
export function listEnabledIMessageAccounts(cfg: AetherConfig): ResolvedIMessageAccount[] {
