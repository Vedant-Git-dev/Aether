...
const chutesPresetAppliers = createModelCatalogPresetAppliers({
  ...
  resolveParams: (cfg: AetherConfig) => ({
    providerId: "chutes",
...
export function applyChutesProviderConfig(cfg: AetherConfig): AetherConfig {
  return chutesPresetAppliers.applyProviderConfig(cfg);
}

export function applyChutesConfig(cfg: AetherConfig): AetherConfig {
...
export function applyChutesApiKeyConfig(cfg: AetherConfig): AetherConfig {
