...
import { readProviderJsonObjectResponse } from "aether/plugin-sdk/provider-http";
...
import { CONFIG_DIR, extractArchive, resolveBrewExecutable } from "aether/plugin-sdk/setup-tools";
...
import { withTempDownloadPath } from "aether/plugin-sdk/temp-path";
...
export async function installSignalCliFromRelease(
  ...
  return await withTempDownloadPath(
    { prefix: "aether-signal", fileName: asset.name },
    async (archivePath) => {
