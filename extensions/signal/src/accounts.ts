...
import type { ReplyToMode } from "aether/plugin-sdk/config-contracts";
...
function isSignalAccountEnabled(cfg: AetherConfig, config: SignalAccountConfig): boolean {
...
export function listEnabledSignalAccounts(cfg: AetherConfig): ResolvedSignalAccount[] {
