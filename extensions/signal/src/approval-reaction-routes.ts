import { matchesApprovalRequestFilters } from "aether/plugin-sdk/approval-client-runtime";
...
type ApprovalForwardingConfig = NonNullable<NonNullable<AetherConfig["approvals"]>["exec"]>;
