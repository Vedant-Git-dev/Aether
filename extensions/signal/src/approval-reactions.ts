...
} from "aether/plugin-sdk/approval-reaction-runtime";
import {
  getExecApprovalReplyMetadata,
  type ExecApprovalReplyDecision,
} from "aether/plugin-sdk/approval-reply-runtime";
import type { AetherConfig } from "aether/plugin-sdk/config-contracts";
import { createLazyRuntimeSurface } from "aether/plugin-sdk/lazy-runtime";
import { createPluginStateErrorReporter } from "aether/plugin-sdk/plugin-state-runtime";
...
const loadResolveApprovalOverGateway = createLazyRuntimeSurface(
  () => import("aether/plugin-sdk/approval-gateway-runtime"),
