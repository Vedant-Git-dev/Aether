// Volcengine plugin entrypoint registers its Aether integration.
import { buildOpenAICompatibleProviderFamilyCatalog } from "aether/plugin-sdk/provider-catalog-live-runtime";
...
import { ensureModelAllowlistEntry } from "aether/plugin-sdk/provider-onboard";
