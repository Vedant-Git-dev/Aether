...
import { buildAgentSessionKey, parseAgentSessionKey } from "aether/plugin-sdk/routing";
import {
...
import type { listSessionEntries } from "aether/plugin-sdk/session-store-runtime";
...
async function collectLegacyZalouserDmEntries(
  ...
  const { deliveryContextFromSession, listSessionEntries, resolveStorePath } =
    await import("aether/plugin-sdk/session-store-runtime");
