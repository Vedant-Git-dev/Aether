...
function mergeZalouserAccountConfig(cfg: AetherConfig, accountId: string): ZalouserAccountConfig {
...
function resolveZalouserAccountBase(params: { cfg: AetherConfig; accountId?: string | null }) {
