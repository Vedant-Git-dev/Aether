...
function pruneRetiredXaiBuiltinModels(cfg: AetherConfig): AetherConfig {
...
export function applyXaiProviderConfig(cfg: AetherConfig): AetherConfig {
  return xaiPresetAppliers.applyProviderConfig(pruneRetiredXaiBuiltinModels(cfg));
}

export function applyXaiConfig(cfg: AetherConfig): AetherConfig {
