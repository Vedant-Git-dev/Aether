import type { ImageGenerationProvider } from "aether/plugin-sdk/image-generation";
...
} from "aether/plugin-sdk/realtime-transcription";
import { createRealtimeVoiceAudioQueue } from "aether/plugin-sdk/realtime-voice-audio-queue";
import {
...
} from "aether/plugin-sdk/realtime-voice-provider";
import type {
  SpeechProviderPlugin,
  SpeechSynthesisStreamRequest,
  SpeechTelephonySynthesisRequest,
} from "aether/plugin-sdk/speech";
import type { VideoGenerationProvider } from "aether/plugin-sdk/video-generation";
import {
