...
} from "aether/plugin-sdk/secret-ref-readonly";
...
function readPluginXaiWebSearchApiKeyResult(cfg?: AetherConfig): ReadOnlyEnvSecretRefResolution {
...
export function resolveFallbackXaiAuth(cfg?: AetherConfig): XaiFallbackAuth | undefined {
