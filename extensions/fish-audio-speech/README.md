...
Official Aether speech provider for Fish Audio's hosted S2.1 API.

Install it with:

```bash
aether plugins install @aether/fish-audio-speech
```
...
See [Fish Audio](https://docs.aether.ai/providers/fish-audio) for setup,
