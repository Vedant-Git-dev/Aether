...
import { optionalFiniteNumberSchema, stringEnum } from "aether/plugin-sdk/channel-actions";
...
import type { AnyAgentTool, AetherConfig, AetherPluginToolContext } from "../api.js";
...
export function createDiffsTool(params: {
  ...
  const loadScreenshotter = async (config: AetherConfig) =>
