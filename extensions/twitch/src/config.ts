...
export function getAccountConfig(
  ...
  const cfg = coreConfig as AetherConfig;
...
export const twitchConfigAdapter = {
  ...
  resolveDefaultTo: ({ cfg, accountId }: { cfg: AetherConfig; accountId?: string | null }) =>
    resolveTwitchAccountContext(cfg, accountId).account?.channel,
  isConfigured: (account: ResolvedTwitchAccount, cfg: AetherConfig) =>
