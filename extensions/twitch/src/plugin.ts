/**
 * Twitch channel plugin for Aether.
 *
...
import { buildChannelConfigSchema } from "aether/plugin-sdk/channel-config-schema";
import {
...
} from "aether/plugin-sdk/channel-pairing";
 ...
 * for Aether. Supports message sending, receiving, access control, and
 * status monitoring.
 */
    ...
    base: {
      ...
      resolver: {
        resolveTargets: async ({
          ...
          runtime: import("aether/plugin-sdk/runtime-env").RuntimeEnv;
