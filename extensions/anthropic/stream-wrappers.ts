...
import { streamSimple } from "aether/plugin-sdk/llm";
...
const AETHER_DEFAULT_ANTHROPIC_BETAS = [
  "fine-grained-tool-streaming-2025-05-14",
  "interleaved-thinking-2025-05-14",
] as const;
const AETHER_OAUTH_ANTHROPIC_BETAS = [
  "claude-code-20250219",
  "oauth-2025-04-20",
  ...AETHER_DEFAULT_ANTHROPIC_BETAS,
] as const;
...
export { isAnthropicOAuthApiKey } from "aether/plugin-sdk/provider-stream-shared";
...
/** Wrap a stream function to merge Aether and configured Anthropic beta headers. */
export function createAnthropicBetaHeadersWrapper(
  ...
  return (model, context, options) => {
    ...
    const aetherBetas = isOauth
      ? (AETHER_OAUTH_ANTHROPIC_BETAS as readonly string[])
      : (AETHER_DEFAULT_ANTHROPIC_BETAS as readonly string[]);
    const allBetas = [...new Set([...aetherBetas, ...effectiveBetas])];
