 ...
 */
import type { AetherConfig, ProviderAuthResult } from "aether/plugin-sdk/provider-auth";
import {
  isRecord,
...
type AgentDefaultsModel = NonNullable<NonNullable<AetherConfig["agents"]>["defaults"]>["model"];
type AgentDefaultsModels = NonNullable<NonNullable<AetherConfig["agents"]>["defaults"]>["models"];
...
export function buildAnthropicCliMigrationResult(config: AetherConfig): ProviderAuthResult {
