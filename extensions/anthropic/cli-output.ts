...
import { findCodeRegions, type CodeRegion } from "aether/plugin-sdk/text-chunking";

const CLAUDE_RAW_TOOL_OUTPUT_ERROR =
  "Claude CLI returned malformed tool output (invalid request format): raw tool protocol appeared as assistant text. Aether refused to persist or deliver it.";
