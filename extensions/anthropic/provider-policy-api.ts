...
} from "aether/plugin-sdk/claude-model-runtime";
import type { ModelProviderConfig } from "aether/plugin-sdk/provider-model-types";
...
/** Profile ids that native Claude auth has retired from Aether ownership. */
