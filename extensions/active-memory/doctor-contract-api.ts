...
export const legacyConfigRules = [
  {
    ...
    message:
      'plugins.entries.active-memory.config.qmd is retired because the QMD memory backend was removed. Run "aether doctor --fix".',
  },
];
...
/** State migrations exposed to Aether doctor for Active Memory. */
