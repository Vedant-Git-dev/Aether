...
import { readSessionTranscriptEvents } from "aether/plugin-sdk/session-transcript-runtime";
...
async function runRecallSubagent(params: {
  ...
  try {
    ...
    // sessionFile carry a native sessionId, not an Aether transcript identity.
