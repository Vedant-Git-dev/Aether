...
import { resolveRememberAcrossConversations } from "aether/plugin-sdk/memory-core-host-runtime-core";
import {
  normalizePluginsConfig,
  resolvePluginConfigObject,
} from "aether/plugin-sdk/plugin-config-runtime";
import type { AetherPluginApi } from "aether/plugin-sdk/plugin-entry";
import { parseAgentSessionKey, parseThreadSessionSuffix } from "aether/plugin-sdk/routing";
...
function openActiveMemoryToggleStore(api: AetherPluginApi) {
...
function isActiveMemoryGloballyEnabled(cfg: AetherConfig): boolean {
...
function isActiveMemoryPluginEnabled(cfg: AetherConfig): boolean {
...
function shouldRememberAcrossConversations(cfg: AetherConfig, agentId: string): boolean {
