...
const PRIVATE_QA_BUILD_ENV = "AETHER_BUILD_PRIVATE_QA";
const PRIVATE_QA_NONCE_HEADER = "x-aether-msteams-qa-nonce";
const PRIVATE_QA_RUNTIME_SYMBOL = Symbol.for("aether.msteams.privateQaRuntime");
...
export function resolveMSTeamsPrivateQaRuntime(
  ...
  if (env[PRIVATE_QA_BUILD_ENV] !== "1") {
    throw new Error("Microsoft Teams private QA runtime requires AETHER_BUILD_PRIVATE_QA=1");
  }
