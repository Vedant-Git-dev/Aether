...
export function extractMSTeamsPollVote(
  ...
  const pollId =
    readNestedString(value, ["aetherPollId"]) ??
    readNestedString(value, ["pollId"]) ??
    readNestedString(value, ["aether", "pollId"]) ??
    readNestedString(value, ["aether", "poll", "id"]) ??
    readNestedString(value, ["data", "aetherPollId"]) ??
    readNestedString(value, ["data", "pollId"]) ??
    readNestedString(value, ["data", "aether", "pollId"]) ??
    // Action.Execute (Universal Action Model) payload shape: value.action.data
    readNestedString(value, ["action", "data", "aetherPollId"]) ??
