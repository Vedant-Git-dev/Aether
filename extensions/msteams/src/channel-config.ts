...
import { createTopLevelChannelConfigAdapter } from "aether/plugin-sdk/channel-config-helpers";
...
export function resolveMSTeamsAccount(cfg: AetherConfig): ResolvedMSTeamsAccount {
