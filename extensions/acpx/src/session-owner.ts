...
function requireAcpxOwnerMigration(sessionKey: string): never {
  throw new AcpRuntimeError(
    ...
    `ACP session "${sessionKey}" has an unqualified or unverifiable backend locator. Stop the Gateway and run "aether doctor --fix" to migrate ownership without losing history, then restart.`,
