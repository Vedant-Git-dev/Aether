...
function listConfiguredChannelIds(cfg: AetherConfig): string[] {
...
function listConfiguredChannelAccountIds(cfg: AetherConfig, channelId: string): string[] {
  if (!hasRecord(cfg.channels)) {
    return [];
  }
...
export function collectChannelRouteTargets(cfg: AetherConfig): ChannelRouteTarget[] {
