...
export function listBindings(cfg: AetherConfig): AgentRouteBinding[] {
  return listRouteBindings(cfg);
}

export function listBoundAccountIds(cfg: AetherConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: AetherConfig) {
