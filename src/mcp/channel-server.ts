...
/**
 * MCP stdio server assembly for Aether channel conversations.
 *
 ...
 */
type AetherMcpServeOptions = NonNullable<Parameters<typeof createChannelMcpRuntime>[0]>;

/** Serve the channel MCP server over stdio until transport or process shutdown. */
export async function serveAetherChannelMcp(opts: AetherMcpServeOptions = {}): Promise<void> {
