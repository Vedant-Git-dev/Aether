...
import { ensureColumn, tableHasColumn } from "../state/aether-state-db-schema-helpers.js";
...
// SQL hits the override, losing atomicity under AETHER_STATE_DIR overrides.
