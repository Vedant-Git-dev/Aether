...
plugin.approval.resolve plugins.uiDescriptors plugins.sessionAction aether.chat
aether.chat.history aether.changes.list aether.approval.list aether.setup.detect
aether.setup.activate aether.setup.activate.start aether.setup.auth.start
aether.setup.prepare.start wizard.start wizard.next wizard.cancel wizard.status talk.catalog
...
aether.setup.verify environments.create environments.destroy sessions.catalog.list
