...
const SERIALIZED_EVENT_PAYLOAD = Symbol("aether.serializedEventPayload");
...
/** Event transport for nodes that cannot keep a WebSocket open. */
...
export class NodeRegistry {
  ...
  private committedConfig: AetherConfig | undefined;
  ...
  private isCommandAllowed(nodeId: string, command: string, liveConfig?: AetherConfig): boolean {
