...
export function resolveGatewayAgentSelectionState(cfg: AetherConfig): GatewayAgentSelectionState {
...
export function listGatewayAgentsBasic(cfg: AetherConfig): GatewayAgentSelectionState & {
  mainKey: string;
  scope: SessionScope;
