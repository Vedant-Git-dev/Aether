...
type GatewaySecretDefaults = NonNullable<AetherConfig["secrets"]>["defaults"];
 ...
 * This prevents literal placeholder strings like `${AETHER_GATEWAY_TOKEN}` from being
...
export function createGatewayCredentialPlan(params: {
  ...
  const envPassword = trimToUndefined(env.AETHER_GATEWAY_PASSWORD);
