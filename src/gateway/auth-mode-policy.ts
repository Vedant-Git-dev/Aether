...
export function hasAmbiguousGatewayAuthModeConfig(cfg: AetherConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: AetherConfig): void {
