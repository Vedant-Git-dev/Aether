...
export function resolveChatAttachmentMaxBytes(cfg: AetherConfig): number {
 ...
 */
export function resolveChatAttachmentPolicy(cfg: AetherConfig): ChatAttachmentPolicy {
