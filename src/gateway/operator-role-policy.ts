...
export function operatorSessionCap(client: GatewayClient | null, cfg: AetherConfig) {
  return resolveOperatorRolePolicy(client, cfg)?.sessions.others;
}

export function hasOperatorBoundary(client: GatewayClient | null, cfg: AetherConfig): boolean {
