...
import { aetherStateDatabaseCache } from "../state/aether-state-db-cache.js";
...
export async function prepareGatewayKernelState(params: {
  ...
  const resolveSharedGatewaySessionGenerationForConfig = (config: AetherConfig) =>
  ...
  const getReadiness = createReadinessChecker({
    ...
    getStateDatabaseFailure: () =>
      aetherStateDatabaseCache.getAetherStateDatabaseRuntimeFailure(resolveDatabasePath()),
