...
const CONTROL_UI_ASSISTANT_MEDIA_PREFIX = "/__aether__/assistant-media";
...
const CONTROL_UI_RESOURCE_ROUTES = {
  ...
  catalogIcon: { prefix: "/__aether__/catalog-icon", suffix: "" },
  channelAvatar: { prefix: "/__aether__/channel-avatar", suffix: "" },
  linkFavicon: { prefix: "/__aether__/link-favicon", suffix: "" },
  pluginIcon: { prefix: "/__aether__/plugin-icon", suffix: "" },
  userAvatar: {
    prefix: CONTROL_UI_USER_AVATAR_PATH_PREFIX.slice(0, -1),
    suffix: CONTROL_UI_USER_AVATAR_PATH_SUFFIX,
  },
  workspaceIcon: { prefix: "/__aether__/workspace-icon", suffix: "" },
} as const;
...
export function matchControlUiResourceUrl(
  ...
  try {
    const origin = "http://aether.invalid";
