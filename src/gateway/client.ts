// Aether Gateway client facade.
// Injects Aether host dependencies into the shared gateway-client package.
...
function createAetherGatewayClientHostDeps(
  ...
  const preparedDeviceAuthDeps = preparedDeviceAuth
    ...
    : deviceAuthDeps;
  return {
    // This wrapper is the only place the package reaches into Aether runtime
...
export class GatewayClient {
  ...
  constructor(opts: GatewayClientOptions) {
    ...
    this.#client = new BaseGatewayClient({
      ...
      hostDeps: createAetherGatewayClientHostDeps(
