...
export const GATEWAY_WS_CONNECTION_KIND_PROPERTY = "__aetherConnectionKind";
export const GATEWAY_WS_PREAUTH_BUDGET_PROPERTY = "__aetherPreauthBudget";
...
export type GatewayIngressWebSocket = WebSocket & {
  ...
  __aetherPreauthBudgetClaimed?: boolean;
  __aetherPreauthBudgetKey?: string;
};
