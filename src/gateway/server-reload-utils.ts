...
export function restoreCanonicalSecretRefs(
  ...
  return projectCanonicalSecretRefsOntoRuntime(sourceConfig, runtimeConfig) as AetherConfig;
}

export function revokeActiveSkillReviewsBeforeConfigPublication(config: AetherConfig): void {
