...
export function installGatewaySessionsTestResources(
  ...
  const defaultAgentWorkspace = path.join(os.tmpdir(), "aether-gateway-test");
  ...
  installGatewayTestHooks({
    ...
    setup: async () => {
      ...
      sharedSessionStoreDir = tempDirs.make("aether-sessions-");
      ...
      runQaGatewayFixture(
        ...
        () => {
          ...
          for (const dir of tempDirs.dirs) {
            closeAetherAgentDatabasesForTest(dir);
          }
          tempDirs.cleanup();
