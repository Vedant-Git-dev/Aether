...
export type GatewayHotReloadPublication = {
  ...
  prepareRestartRuntimeConfig?: () => Promise<AetherConfig>;
...
export type GatewayRestartRequestOptions = {
  ...
  prepareRuntimeConfig?: () => Promise<AetherConfig>;
  debtConfig?: AetherConfig;
};
...
export type GatewayReloadHandlerParams = {
  ...
  reloadPluginServices?: (config: AetherConfig, serviceIds: ReadonlySet<string>) => Promise<void>;
...
> & {
  ...
  applyRuntimeConfigOverrides?: (config: AetherConfig) => AetherConfig;
  resolveSharedGatewaySessionGenerationForConfig: (config: AetherConfig) => string | undefined;
  sharedGatewaySessionGenerationState: SharedGatewaySessionGenerationState;
  clients: Iterable<SharedGatewayAuthClient>;
  prepareTerminalConfig: (plan: GatewayReloadPlan, nextConfig: AetherConfig) => void;
  reconcileRuntimePolicy: (
    nextConfig: AetherConfig,
    phase: "committed" | "restart",
  ) => Promise<void> | void;
  assertRuntimeSecurityConfig?: (config: AetherConfig, env?: NodeJS.ProcessEnv) => void;
  commitRuntimePolicy: (nextConfig: AetherConfig) => void;
