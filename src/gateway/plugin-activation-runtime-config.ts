...
export function mergeActivationSectionsIntoRuntimeConfig(params: {
  ...
  return {
    ...runtimeConfig,
    ...(nextChannels === undefined ? {} : { channels: nextChannels as AetherConfig["channels"] }),
    ...(nextPlugins === undefined ? {} : { plugins: nextPlugins as AetherConfig["plugins"] }),
  };
}
...
export function resolveGatewayReloadPluginActivationCandidate(params: {
  ...
  discovery?: PluginDiscoveryResult;
  ambientEnvTriggers?: AmbientEnvTriggerPolicy;
}): { runtimeConfig: AetherConfig; compareConfig: AetherConfig } {
