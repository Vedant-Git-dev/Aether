...
export async function handleToolsInvokeHttpRequest(
  ...
  try {
    ...
    const messageChannel = normalizeMessageChannel(
      getHeader(req, "x-aether-message-channel") ?? "",
    );
    const accountId = normalizeOptionalString(getHeader(req, "x-aether-account-id"));
    const agentTo = normalizeOptionalString(getHeader(req, "x-aether-message-to"));
    const agentThreadId = normalizeOptionalString(getHeader(req, "x-aether-thread-id"));
