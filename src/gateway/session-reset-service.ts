...
import { cleanupSessionResources } from "@aether/ai/internal/runtime";
import { type FastMode, normalizeOptionalString } from "@aether/normalization-core/string-coerce";
...
function resolveLifecycleAgentId(cfg: AetherConfig, agentId?: string): string {
...
const mcpRunEndWatcherState = resolveGlobalSingleton<McpRunEndWatcherState>(
  Symbol.for("aether.mcpRunEndWatchers"),
