...
export const CONTROL_UI_BASE_PATH_ATTRIBUTE = "data-aether-control-ui-base-path";

/** Marks whether the served document CSP permits the terminal WASM runtime. */
export const CONTROL_UI_TERMINAL_ENABLED_ATTRIBUTE = "data-aether-terminal-enabled";

export const CONTROL_UI_ENVIRONMENT_ATTRIBUTE = "data-aether-environment";
