...
import { ensureConfigRevisionKeySchema } from "../state/aether-state-db-schema-additive.js";
...
type ConfigRevisionKeyDatabase = Pick<AetherStateKyselyDatabase, "config_revision_keys">;
...
const CONFIG_REVISION_RAW_DOMAIN = "aether.gateway.config-revision.raw.v1";
const CONFIG_REVISION_RESOLVED_DOMAIN = "aether.gateway.config-revision.resolved.v1";
