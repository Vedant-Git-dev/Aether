...
export const MCP_APP_STANDALONE_PATH = "/__aether__/mcp-app";
export const MCP_APP_STANDALONE_VIEW_PATH = `${MCP_APP_STANDALONE_PATH}/view`;
const WORKER_GATEWAY_PATH = "/__aether__/worker";
const NODE_WORKER_BUNDLE_TRANSFER_NAMESPACE = "/__aether__/worker-bundle";
const NODE_WORKSPACE_TRANSFER_NAMESPACE = "/__aether__/worker-transfer";
export const WORKER_BOOTSTRAP_ARTIFACT_TRANSFER_PATH = "/__aether__/worker-bootstrap";
