...
const DEEP_SLEEP_SYSTEM_EVENT_TEXT = "__aether_memory_core_short_term_promotion_dream__";
...
function resolveDreamingConfig(cfg: AetherConfig): DoctorMemoryDreamingConfigPayload {
...
const SKIPPED_MEMORY_EMBEDDING_PROBE = {
  ok: false,
  checked: false,
  error: "memory embedding readiness not checked; run `aether memory status --deep` to probe",
} as const;
