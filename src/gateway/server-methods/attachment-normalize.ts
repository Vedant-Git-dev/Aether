...
import { asNonNegativeFiniteNumber as normalizeAttachmentNumber } from "@aether/normalization-core/number-coercion";
...
export function normalizeRpcAttachmentsToChatAttachments(
  ...
  // Accept both the Aether attachment fields and Anthropic-style
