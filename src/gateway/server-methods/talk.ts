...
import type { AetherConfig, TtsConfig, TtsProviderConfigMap } from "../../config/types.js";
...
function buildTalkTtsConfig(
  ...
  | { cfg: AetherConfig; provider: string; providerConfig: TalkProviderConfig }
...
function buildTalkCatalog(config: AetherConfig) {
