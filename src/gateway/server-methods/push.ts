// Push gateway methods manage web push subscriptions/VAPID public-key access
// for UI clients and send web-push test notifications.
...
export const pushHandlers: GatewayRequestHandlers = {
  ...
  "push.web.test": async ({ params, respond }) => {
    ...
    const title = normalizeOptionalString(params.title) ?? "Aether";
