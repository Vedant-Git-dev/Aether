...
export function resolveHealthAgentOrder(cfg: AetherConfig) {
...
function buildPluginHealthSummary(cfg: AetherConfig): PluginHealthSummary | undefined {
...
async function readRuntimeHealthConfig(): Promise<AetherConfig> {
