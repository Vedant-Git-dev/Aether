...
const CORE_GATEWAY_METHOD_SPECS = [
  ...
  ["aether.chat", "system-agent", "operator.admin", "<=2026.7"],
  ["aether.chat.history", "system-agent", "operator.admin", "2026.7"],
  ["aether.changes.list", "system-changes", "operator.admin", "<=2026.7"],
  ["aether.approval.list", "system-agent", "operator.approvals", "<=2026.7"],
  ["aether.setup.detect", "system-agent", "operator.admin", "<=2026.7"],
  ...
  ["aether.setup.activate", "system-agent", "operator.admin", "<=2026.7"],
  ["aether.setup.activate.start", "system-agent", "operator.admin", "2026.8"],
  ["aether.setup.auth.start", "system-agent", "operator.admin", "<=2026.7"],
  ["aether.setup.prepare.start", "system-agent", "operator.admin", "<=2026.7"],
  ...
  ["aether.setup.verify", "system-agent", "operator.admin", "<=2026.7"],
