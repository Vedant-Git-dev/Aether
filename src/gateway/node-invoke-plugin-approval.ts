...
import type { AetherPluginNodeInvokePolicyContext } from "../plugins/types.js";
...
export function createPluginNodeInvokeApprovalRuntime(params: {
  ...
  risk: AetherPluginNodeInvokePolicyContext["risk"];
  ...
  isCurrent: () => boolean;
}): AetherPluginNodeInvokePolicyContext["approvals"] | undefined {
