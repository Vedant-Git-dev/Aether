...
export function resolveGatewayLaneConcurrency(cfg: AetherConfig): GatewayLaneConcurrency {
...
export function applyGatewayLaneConcurrency(
  ...
  // is precisely the additive-capacity behaviour aether#98813 was held for.
