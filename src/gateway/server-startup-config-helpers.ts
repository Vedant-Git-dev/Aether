...
export function hasActiveGatewayAuthSecretRef(config: AetherConfig): boolean {
...
export function assertRuntimeGatewayAuthNotKnownWeak(config: AetherConfig): void {
