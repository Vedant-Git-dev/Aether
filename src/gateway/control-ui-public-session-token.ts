...
import { CONTROL_UI_PUBLIC_SESSION_SHARE_TOKEN_MAX_LENGTH } from "@aether/session-url-contract/public-share";
...
const PUBLIC_SESSION_TOKEN_AAD = Buffer.from(
  "aether.public-session-share-locator.aad.v1",
  "utf8",
);
const PUBLIC_SESSION_TOKEN_KEY_SALT = Buffer.from(
  "aether.public-session-share-locator.salt.v1",
  "utf8",
);
const PUBLIC_SESSION_TOKEN_KEY_INFO = Buffer.from(
  "aether.public-session-share-locator.key.v1",
  "utf8",
);
