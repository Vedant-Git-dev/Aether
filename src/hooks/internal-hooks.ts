/**
 * Hook system for Aether agent events
 *
 ...
 */
const INTERNAL_HOOK_HANDLERS_KEY = Symbol.for("aether.internalHookHandlers");
...
const INTERNAL_HOOKS_ENABLED_KEY = Symbol.for("aether.internalHooksEnabled");
