...
homepage: https://docs.aether.ai/automation/hooks#session-memory
metadata:
  {
    "aether":
      {
...
- Uses your workspace directory (`~/.aether/workspace` by default)
...
```bash
aether hooks disable session-memory
```
