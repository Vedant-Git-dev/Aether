import { normalizeOptionalString as readLogString } from "@aether/normalization-core/string-coerce";
...
export function buildMeetingSpeakExactUserMessage(text: string): string {
  return [
    "Speak this exact Aether answer to the meeting, without adding, removing, or rephrasing words.",
