...
import { asPositiveFiniteNumber as positiveExtractionLimit } from "@aether/normalization-core/number-coercion";
...
export function resolveFileExtractionLimits(cfg: AetherConfig): FileExtractionLimits {
