...
async function persistRiskAcknowledgement(config: AetherConfig): Promise<string | undefined> {
...
}): Promise<{ quickstart: boolean; config: AetherConfig; securityAcknowledgedAt: string }> {
