...
const LEGACY_TOOLS_DEV_MD_TEMPLATE =
  "# TOOLS.md - User Tool Notes (editable)\n\nThis file is for _your_ notes about external tools and conventions. It does not define which tools exist; Aether provides built-in tools internally, and skills add the rest.\n\n## Examples\n\n### imsg\n\n" +
