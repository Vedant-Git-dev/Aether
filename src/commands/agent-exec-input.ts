 ...
 */
function stripInheritedAgentLocations(base: AetherConfig): AetherConfig {
 ...
 */
function buildExecConfigDefaults(): AetherConfig {
  return {
...
export function buildExecRunConfig(params: {
  ...
  ) as AetherConfig; // SAFETY: Merging three typed configs preserves the AetherConfig shape.
}
