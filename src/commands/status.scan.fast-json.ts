// Fast `aether status --json` scan policy.
...
function hasExplicitStatusJsonChannelConfig(cfg: AetherConfig): boolean {
...
function hasPotentialConfiguredChannelsForStatusJson(cfg: AetherConfig): boolean {
