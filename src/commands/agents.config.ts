// Agent config mutation and summary builders used by `aether agents` commands.
import {
...
export function buildAgentSummaries(cfg: AetherConfig): AgentSummary[] {
...
export function pruneAgentConfig(
  ...
  const preliminaryConfig: AetherConfig = {
    ...cfg,
