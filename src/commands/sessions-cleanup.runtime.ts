...
function prepareCleanupHarnessOwners(config: AetherConfig, workspaceDir: string) {
...
export async function runLocalSessionsCleanup(
  params: { cfg: AetherConfig; opts: SessionsCleanupOptions; targets: SessionStoreTarget[] },
  runtime: RuntimeEnv,
