...
import type { AetherConfig, ConfigFileSnapshot } from "../../config/types.js";
...
/** Extracts the config fields displayed by `aether gateway status --deep`. */
...
export function buildNetworkHints(cfg: AetherConfig, localPortOverride?: number) {
