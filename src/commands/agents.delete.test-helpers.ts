...
function resolveFixtureStoreAgentId(cfg: AetherConfig, deletedAgentId: string): string {
...
export function createAgentsDeleteFixture(setConfig: (cfg: AetherConfig) => void) {
  return async (params: {
    stateDir: string;
    cfg: AetherConfig;
