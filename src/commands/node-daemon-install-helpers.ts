...
import { AETHER_WRAPPER_ENV_KEY, resolveNodeProgramArguments } from "../daemon/program-args.js";
...
> {
  return {
    AETHER_GATEWAY_TOKEN: "file",
    AETHER_GATEWAY_PASSWORD: "file", // pragma: allowlist secret
...
export async function buildNodeInstallPlan(params: {
  ...
  const wrapperPath = params.wrapperPath ?? params.env[AETHER_WRAPPER_ENV_KEY];
