// Doctor contribution for low disk space around the Aether state directory.
import os from "node:os";
import { expectDefined, formatByteSize } from "@aether/normalization-core";
 ...
 *
 * This catches a common operational failure mode where Aether silently
