...
function hasPotentialPluginConfig(config: AetherConfig, env: NodeJS.ProcessEnv): boolean {
...
function collectConfiguredMemoryEmbeddingProviderIds(config: AetherConfig): ReadonlySet<string> {
...
function hasConfiguredCapabilityPlugin(config: AetherConfig, env: NodeJS.ProcessEnv): boolean {
