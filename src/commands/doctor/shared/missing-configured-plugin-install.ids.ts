...
function addConfiguredAgentRuntimePluginIds(ids: Set<string>, cfg: AetherConfig): void {
...
function addConfiguredSpeechProviderPluginIds(ids: Set<string>, cfg: AetherConfig): void {
  for (const pluginId of resolveOfficialExternalProviderContractPluginIds({
...
function addConfiguredWebFetchProviderPluginIds(ids: Set<string>, cfg: AetherConfig): void {
...
export function collectBlockedPluginIds(cfg: AetherConfig): Set<string> {
  const ids = new Set<string>();
