...
function repairInvalidHeartbeatActiveHours(cfg: AetherConfig, changes: string[]): AetherConfig {
...
function repairNullAgentWorkspaces(cfg: AetherConfig, changes: string[]): AetherConfig {
  let repaired = 0;
