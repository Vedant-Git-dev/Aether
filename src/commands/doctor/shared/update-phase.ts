...
export const UPDATE_IN_PROGRESS_ENV = "AETHER_UPDATE_IN_PROGRESS";
export const UPDATE_POST_CORE_CONVERGENCE_ENV = "AETHER_UPDATE_POST_CORE_CONVERGENCE";
export const UPDATE_DEFER_CONFIGURED_PLUGIN_INSTALL_REPAIR_ENV =
  "AETHER_UPDATE_DEFER_CONFIGURED_PLUGIN_INSTALL_REPAIR";
export const UPDATE_PARENT_SUPPORTS_DOCTOR_CONFIG_WRITE_ENV =
  "AETHER_UPDATE_PARENT_SUPPORTS_DOCTOR_CONFIG_WRITE";
export const UPDATE_PARENT_SUPPORTS_GATEWAY_RESTART_ENV =
  "AETHER_UPDATE_PARENT_SUPPORTS_GATEWAY_RESTART";
export const UPDATE_PARENT_ALLOWS_GATEWAY_SERVICE_REPAIR_ENV =
  "AETHER_UPDATE_PARENT_ALLOWS_GATEWAY_SERVICE_REPAIR";
export const UPDATE_PARENT_ALLOWS_GATEWAY_ACTIVATION_ENV =
  "AETHER_UPDATE_PARENT_ALLOWS_GATEWAY_ACTIVATION";
 ...
 * `AETHER_UPDATE_IN_PROGRESS` directly (`commands/doctor-update.ts`,
 ...
 * `AETHER_UPDATE_IN_PROGRESS`, so configured plugin repair must happen now.
 */
