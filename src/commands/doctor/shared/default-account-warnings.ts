...
export function collectMissingDefaultAccountBindingWarnings(cfg: AetherConfig): string[] {
...
export function collectMissingExplicitDefaultAccountWarnings(cfg: AetherConfig): string[] {
  const warnings: string[] = [];
