...
function collectToolAllowlistSources(cfg: AetherConfig): ToolAllowlistSource[] {
...
function collectConfiguredMcpServerNames(cfg: AetherConfig): string[] {
...
function collectSandboxMcpAllowlistWarnings(cfg: AetherConfig): string[] {
