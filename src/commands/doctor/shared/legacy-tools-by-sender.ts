...
export function scanLegacyToolsBySenderKeys(cfg: AetherConfig): LegacyToolsBySenderKeyHit[] {
...
export function maybeRepairLegacyToolsBySenderKeys(cfg: AetherConfig): {
  config: AetherConfig;
  changes: string[];
} {
