...
function collectExecSafeBinScopes(cfg: AetherConfig): ExecSafeBinScopeRef[] {
...
export function scanExecSafeBinCoverage(cfg: AetherConfig): ExecSafeBinCoverageHit[] {
...
export function maybeRepairExecSafeBinProfiles(cfg: AetherConfig): {
  config: AetherConfig;
  changes: string[];
  warnings: string[];
} {
