    ...
    legacyRules: [
      {
        ...
        message:
          'skills.workshop.autonomous.enabled is retired; use skills.workshop.autonomous.mode. Run "aether vitals --fix".',
      },
    ],
    apply: (raw, changes) => {
    ...
    legacyRules: [
      {
        ...
        message:
          'skills.workshop.allowSymlinkTargetWrites is retired; Skill Workshop writes only inside its own directory. Run "aether vitals --fix".',
      },
    ],
    apply: (raw, changes) => {
