...
const maybeRepairPluginAetherHostLinks = vi.hoisted(() =>
  vi.fn(
    async (_params: {
...
vi.mock("./doctor-plugin-host-links.js", async (importOriginal) => {
  ...
  return { ...actual, maybeRepairPluginAetherHostLinks };
});

export function getMaybeRepairPluginAetherHostLinksMock() {
  return maybeRepairPluginAetherHostLinks;
}
