...
function hasExplicitMemorySearchConfig(cfg: AetherConfig, agentId: string): boolean {
...
export function resolveMemoryPluginStatus(cfg: AetherConfig): MemoryPluginStatus {
