...
import { isStringRecord as isRecordOfStrings } from "@aether/normalization-core/record-coerce";
...
type MigrationDatabase = Pick<AetherStateDatabase, "migration_runs" | "migration_sources">;
type AuthProfileTargetDatabase = Pick<
  AetherAgentKyselyDatabase,
  "auth_profile_store" | "auth_profile_state"
> &
  Pick<AetherStateDatabase, "config_machine_state">;
...
if (process.env.VITEST || process.env.NODE_ENV === "test") {
  (globalThis as Record<PropertyKey, unknown>)[
    Symbol.for("aether.authProfileMigrationReceiptsTestApi")
  ] = {
