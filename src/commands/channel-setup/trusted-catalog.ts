...
function resolveEffectiveTrustConfig(cfg: AetherConfig, env?: NodeJS.ProcessEnv): AetherConfig {
...
function resolveTrustedCatalogExtraPaths(cfg: AetherConfig): string[] | undefined {
