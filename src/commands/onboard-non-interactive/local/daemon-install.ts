...
> {
  ...
  if (process.platform === "linux" && !systemdAvailable) {
    ...
    runtime.log(
      "Systemd user services are unavailable; skipping service install. Use a direct shell run (`aether gateway run`) or rerun without --install-daemon on this session.",
    );
