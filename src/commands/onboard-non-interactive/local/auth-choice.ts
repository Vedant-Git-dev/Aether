...
/** Applies a local non-interactive auth choice to the pending Aether config. */
export async function applyNonInteractiveAuthChoice(params: {
  ...
  if (opts.secretInputMode && !requestedSecretInputMode) {
    rejectOnboardingOption(
      opts,
      runtime,
      `Invalid --secret-input-mode. Use "plaintext" or "ref", or run ${formatCliCommand("aether awaken")} for interactive setup.`,
    );
    return null;
  }
