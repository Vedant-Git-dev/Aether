...
function resolveSpeechProviderPluginEntries(cfg?: AetherConfig): SpeechProviderPlugin[] {
...
export function listLoadedSpeechProviders(_cfg?: AetherConfig): SpeechProviderPlugin[] {
