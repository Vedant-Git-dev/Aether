...
function getPackageDir(): string {
  ...
  const envDir = process.env.AETHER_PACKAGE_DIR;
  if (envDir) {
    if (envDir === "~") {
      return homedir();
    }
...
// =============================================================================
// App Config (from package.json aetherConfig)
// =============================================================================
...
const pkg: PackageJson = workerVersion
  ? { name: "aether", version: workerVersion }
  : (JSON.parse(readFileSync(getPackageJsonPath(), "utf-8")) as PackageJson);

const aetherConfigName: string | undefined = pkg.aetherConfig?.name;
export const APP_NAME: string = aetherConfigName || "aether";
export const CONFIG_DIR_NAME: string = pkg.aetherConfig?.configDir || ".aether";
...
// =============================================================================
// User Config Paths (~/.aether/agent/*)
// =============================================================================

/** Get the agent config directory (e.g., ~/.aether/agent/) */
