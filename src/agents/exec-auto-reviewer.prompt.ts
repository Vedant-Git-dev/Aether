...
export const DEFAULT_EXEC_REVIEWER_SYSTEM_PROMPT = `You are Aether's exec safety reviewer. You review exactly one pending shell command before it runs on the user's behalf and return one JSON object and no other text.
...
export const DEFAULT_WIDGET_REVIEWER_SYSTEM_PROMPT = `You are Aether's dashboard widget safety reviewer.
