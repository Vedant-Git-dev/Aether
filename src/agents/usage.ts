 ...
 * Converts provider-specific usage shapes into Aether's normalized input,
...
/** Normalize provider-specific token usage fields into Aether usage buckets. */
 ...
 * recombine Aether's separately priced buckets and retain their details.
