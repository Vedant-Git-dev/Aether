...
function resolveProviderSourceConfig(cfg: AetherConfig | undefined, provider: string) {
...
export function providerConfigMatchesRuntimeSnapshot(params: {
  inputConfig: AetherConfig | undefined;
  ...
  const toComparableConfig = (providerConfig: ModelProviderConfig): AetherConfig => ({
...
export function resolveRuntimeProviderConfigApiKeyAuth(params: {
  cfg: AetherConfig;
  sourceConfig: AetherConfig | undefined;
  provider: string;
