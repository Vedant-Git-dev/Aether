  ...
  const beforeMessageWrite = (
    ...
    if (
      ...
      const preparedMessage =
        message.role === "user"
          ? { ...message, __aether: { ...Reflect.get(message, "__aether") } }
          : undefined;
      if (preparedMessage?.["__aether"].humanMentions !== undefined) {
        ...
        preparedMessage["__aether"].humanMentions = structuredClone(
          preparedMessage["__aether"].humanMentions,
        );
      }
