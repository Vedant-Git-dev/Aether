...
import { hasNonEmptyString as hasSecret } from "@aether/normalization-core/string-coerce";
...
export function createModelAuthAvailabilityResolver(
  ...
  const evaluateModelAuth = (
    ...
    if (routeAuthDecision.kind === "deferred" && syntheticCodexOwnsAuth) {
      return {
        availability:
          ref.runtimeId === "aether" || params.preparedSyntheticAuthComplete ? false : undefined,
        routeResolution,
        evidence: "synthetic",
      };
    }
