 ...
 */
import type { AgentRunTimeoutPhase } from "@aether/normalization-core/agent-run-terminal-outcome";
...
type EmbeddedRunAttemptToolTerminalObservation = {
  ...
  /** Protocol-owned mutation facts for native tools that do not use Aether definitions. */
  nativeMutation?: {
...
export type EmbeddedRunAttemptParams = EmbeddedRunAttemptBase & {
  ...
  /** Aether-owned runtime policy prepared by the orchestrator for this attempt. */
  ...
  /** Storage-aware trajectory recorder owned by the Aether host. */
  ...
  /**
   * Full auth profile store for Aether tool availability.
...
export type EmbeddedRunAttemptResult = {
  ...
  settledTurnFinalizationContext?:
    | { readonly source: "aether-transcript"; readonly messages: readonly AgentMessage[] }
