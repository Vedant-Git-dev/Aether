...
import {
  ...
  type AetherCodingToolConstructionPlan,
...
const ALL_CODING_TOOL_CONSTRUCTION_PLAN: AetherCodingToolConstructionPlan = {
...
const NO_CODING_TOOL_CONSTRUCTION_PLAN: AetherCodingToolConstructionPlan = {
...
function cloneCodingToolConstructionPlan(
  plan: AetherCodingToolConstructionPlan,
): AetherCodingToolConstructionPlan {
  return { ...plan };
}
...
function resolveCodingToolConstructionPlanForAllowlist(
  ...
  const includeAetherTools = coreFamilies.has("aether");
...
export function resolveEmbeddedAttemptToolConstructionPlan(params: {
  ...
  codingToolConstructionPlan: AetherCodingToolConstructionPlan;
} {
  ...
  const includeCoreTools =
    ...
    codingToolConstructionPlan.includeAetherTools;
