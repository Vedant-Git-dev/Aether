import { getEventStreamCompletion, onLlmRequestActivity } from "@aether/ai/internal/runtime";
import { isCloudModelRef } from "@aether/model-catalog-core/model-catalog-refs";
/**
