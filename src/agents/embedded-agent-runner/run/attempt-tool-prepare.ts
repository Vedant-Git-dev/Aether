...
import { createAetherCodingTools } from "../../agent-tools.js";
...
type AetherCodingToolsOptions = NonNullable<Parameters<typeof createAetherCodingTools>[0]>;
type SkillUsagePaths = AetherCodingToolsOptions["skillUsagePaths"];
...
export async function prepareEmbeddedAttemptToolBase(params: {
  ...
  onYield: NonNullable<AetherCodingToolsOptions["onYield"]>;
  runAbortController: AbortController;
  runTrace: DiagnosticTraceContext;
  skillUsagePaths: SkillUsagePaths;
  skillsSnapshot: EmbeddedRunAttemptParams["skillsSnapshot"];
  codeModeSkills: readonly CodeModeSkill[];
  reviewTranscript?: NonNullable<AetherCodingToolsOptions["exec"]>["reviewTranscript"];
    ...
    const constructedToolsRaw = !shouldConstructTools
      ...
      : (() => {
          ...
          const boundTools = attempt.hostCapabilities
            ...
            : allTools;
          params.markCoreToolStage("attempt:create-aether-coding-tools");
