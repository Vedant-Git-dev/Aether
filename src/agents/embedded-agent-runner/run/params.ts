 ...
 */
import type { FastMode } from "@aether/normalization-core/string-coerce";
import type {
  BlockReplyContext,
  PartialReplyPayload,
...
export type RunEmbeddedAgentParams = {
  ...
  /** Explicit runtime override selected for this turn. Unlike agentHarnessId, this may force Aether. */
