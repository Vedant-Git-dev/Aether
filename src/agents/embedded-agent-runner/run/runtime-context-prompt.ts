...
const AETHER_RUNTIME_EVENT_USER_PROMPT = "Continue the Aether runtime event.";
...
export function resolveRuntimeContextPromptParts(params: {
  ...
  const prompt = runtimeOnly
    ? AETHER_RUNTIME_EVENT_USER_PROMPT
...
export function buildRuntimeContextCustomMessage(
  ...
  return {
    role: "custom",
    customType: AETHER_RUNTIME_CONTEXT_CUSTOM_TYPE,
