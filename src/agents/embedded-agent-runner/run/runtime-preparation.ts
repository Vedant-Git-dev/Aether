...
export async function prepareEmbeddedRunRuntime(input: {
  ...
  pluginHarnessOwnsTransport = agentHarness.id !== "aether";
  ...
  const pluginHarnessNeedsAetherAuthBootstrap =
  ...
  if (!pluginHarnessOwnsTransport || pluginHarnessNeedsAetherAuthBootstrap) {
