...
import type { AetherConfig, AetherConfigInput } from "../../config/config.js";
...
export function makeAetherConfigFixture(input: AetherConfigInput = {}): AetherConfig {
  return input as AetherConfig;
}
