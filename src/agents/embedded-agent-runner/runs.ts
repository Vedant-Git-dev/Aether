...
export function markEmbeddedRunRecoveringTimeout(params: {
  ...
  const recoveryToken = Symbol("aether.embeddedRunTimeoutRecovery");
...
if (process.env.VITEST || process.env.NODE_ENV === "test") {
  (globalThis as Record<PropertyKey, unknown>)[Symbol.for("aether.embeddedRunsTestApi")] =
    testing;
}
