 ...
 */
import { normalizeResolvedPricing } from "@aether/llm-core";
import type { NormalizedModelCatalogRow } from "@aether/model-catalog-core/model-catalog-types";
...
const defaultBundledStaticCatalogConfig: AetherConfig = {};
...
function listBundledStaticCatalogPlugins(
  ...
  const plugins: StaticCatalogPlugin[] = metadataSnapshot
    ...
    : listAetherPluginManifestMetadata(params.env).flatMap((record): StaticCatalogPlugin[] => {
