...
type WebFetchConfig = NonNullable<AetherConfig["tools"]>["web"] extends infer Web
...
function resolveFetchConfig(cfg?: AetherConfig): WebFetchConfig {
 ...
 * authority (e.g. `https:// docs.aether.ai`), which causes `new URL()` to
