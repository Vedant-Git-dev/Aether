...
export function coerceImageModelConfig(cfg?: AetherConfig): ImageModelConfig {
...
function findConfiguredImageModelMatches(params: { cfg?: AetherConfig; ref: string }): string[] {
