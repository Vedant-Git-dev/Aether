...
function asAetherConfig(value: unknown): AetherConfig | undefined {
  return asOptionalRecord(value) as AetherConfig | undefined;
}
...
export function resolvePreparedProviderRuntimeHandle(
  ...
  return {
    ...resolveProviderRuntimePluginHandle({
      ...
      config: asAetherConfig(params.config),
...
export function buildAgentRuntimeDeliveryPlan(
  ...
  const config = asAetherConfig(params.config);
    ...
    prompt: {
      ...
      resolveSystemPromptContribution(context) {
        return resolveProviderSystemPromptContribution({
          ...
          context: {
            ...context,
            config: asAetherConfig(context.config),
          },
        });
      },
