import { readOpenAIResponsesCompactionWindow } from "@aether/ai/internal/openai-responses-payload-policy";
...
type TranscriptReplaySanitizerHelpers = {
  ...
  redactTranscriptStructuredValue: (value: unknown, cfg?: AetherConfig) => unknown;
  redactTranscriptText: (value: string, cfg?: AetherConfig) => string;
};
