...
export const SESSION_MCP_RUNTIME_MANAGER_KEY = Symbol.for("aether.sessionMcpRuntimeManager");
...
export function resolveSessionMcpRuntimeIdleTtlMs(cfg?: AetherConfig): number {
