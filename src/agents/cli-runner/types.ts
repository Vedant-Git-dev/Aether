...
export type RunCliAgentParams = {
  ...
  /** Persist the successful CLI assistant reply into the Aether session transcript. */
  ...
  /** Exact native plus canonical Aether surface for a selectable CLI backend. */
  cliToolAvailability?: {
    native: string[];
    aether: string[];
  };
...
export type PreparedCliRunContext = {
  ...
  contextEngineConfig: AetherConfig;
