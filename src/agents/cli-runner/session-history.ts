...
import { isAetherRuntimeContextCustomMessage } from "../internal-runtime-context.js";
...
/** Builds a reseed prompt that carries prior Aether transcript context. */
export function buildCliSessionHistoryPrompt(params: {
  ...
  const truncationMarker = "[Aether reseed history truncated; older turns dropped]";
  ...
  return [
    "Continue this conversation using the Aether transcript below as prior session history.",
