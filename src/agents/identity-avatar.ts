...
function resolveAvatarSource(cfg: AetherConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: AetherConfig, agentId: string): AgentAvatarResolution {
