...
const oneShotCleanup = resolveGlobalSingleton(
  Symbol.for("aether.oneShotCleanupOutcome"),
...
const AGENT_CLEANUP_STEP_TIMEOUT_ENV = "AETHER_AGENT_CLEANUP_TIMEOUT_MS";
const TRAJECTORY_FLUSH_TIMEOUT_ENV = "AETHER_TRAJECTORY_FLUSH_TIMEOUT_MS";
...
function resolveAgentCleanupStepTimeoutMs(params: {
  ...
  if (params.step === "aether-trajectory-flush") {
