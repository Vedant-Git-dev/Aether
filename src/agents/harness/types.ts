...
import type { ProviderModelRef as ModelRef } from "@aether/model-catalog-core/model-catalog-refs";
...
type AgentHarnessIsolatedCompletionParams = {
  ...
  config: import("../../config/types.aether.js").AetherConfig;
  agentId: string;
  agentDir: string;
  workspaceDir: string;
  systemPrompt: string;
...
export type AgentHarnessIsolatedCompletionAuthorization =
  | {
      /** Aether resolved the exact transport model and credential before handoff. */
      owner: "host";
      model: import("../../llm/types.js").Model;
      auth: import("../model-auth-runtime-shared.js").ResolvedProviderAuth;
      /** Non-reversible proof of the prepared credential owner when available. */
...
export type AgentHarnessSideQuestionParams = {
  ...
  cfg: import("../../config/types.aether.js").AetherConfig;
  agentDir: string;
  provider: string;
  model: string;
  runtimeModel?: import("aether/plugin-sdk/llm").Model<import("aether/plugin-sdk/llm").Api>;
...
> = {
  ...
  /**
   * Canonical Aether tool names whose exact denies the harness can also enforce
...
type AgentHarnessMcpCatalogParams = {
  ...
  sessionKey: string;
  workspaceDir: string;
  /** Aether-configured servers whose session policy this harness can enforce. */
...
type AgentHarnessTaskHistoryCapability = {
  /** Reads native task history without creating an Aether child session. */
  taskHistory?: {
