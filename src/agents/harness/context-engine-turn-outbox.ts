...
import { ensureContextEngineTurnOutboxSchema } from "../../state/aether-agent-context-engine-turn-outbox-schema.js";
import type { DB as AetherAgentDatabaseSchema } from "../../state/aether-agent-db.generated.js";
import type { AetherAgentDatabase } from "../../state/aether-agent-db.js";

type ContextEngineTurnOutboxDatabase = Pick<
  AetherAgentDatabaseSchema,
...
function outboxDb(database: AetherAgentDatabase) {
