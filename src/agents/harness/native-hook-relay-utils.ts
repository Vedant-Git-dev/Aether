import { readNonEmptyStringPreservingWhitespace as readOptionalNonEmptyString } from "@aether/normalization-core/string-coerce";
import { truncateUtf16Safe, truncateWithMarker } from "@aether/normalization-core/utf16-slice";
import type {
  JsonValue,
