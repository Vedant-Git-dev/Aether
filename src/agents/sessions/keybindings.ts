 ...
 *
 * Wraps pi-tui keybindings with Aether-specific actions and per-agent overrides.
 */
...
/** Aether-specific key ids added to the shared pi-tui keybinding registry. */
...
/** Keybinding manager that loads Aether defaults plus optional user overrides. */
