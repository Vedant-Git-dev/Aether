...
export function buildSystemPrompt(options: BuildSystemPromptOptions): string {
  ...
  if (!prompt) {
    ...
    prompt = `You are an expert coding assistant operating inside Aether's embedded coding agent harness. You help users by reading files, executing commands, editing code, and writing new files.
