...
import { clampThinkingLevel } from "@aether/ai/internal/runtime";
...
export interface CreateAgentSessionOptions {
  ...
  cwd?: string;
  /** Global config directory. Default: ~/.aether/agents/default */
  agentDir?: string;
   ...
   *
   * When omitted, Aether enables the default built-in tools (read, bash, edit, write)
...
async function createDefaultSdkSessionManager(
  ...
  const target = {
    ...
    storePath: join(agentDir, "aether-agent.sqlite"),
  };
