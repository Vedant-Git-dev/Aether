...
import { installAetherInternalCorePackageNativeResolver } from "../../../plugins/plugin-sdk-native-resolver.js";
import {
...
const VIRTUAL_MODULES: Record<string, unknown> = {
  ...
  "aether/plugin-sdk/agent-core": bundledAgentCore,
  "@aether/plugin-sdk/agent-core": bundledAgentCore,
  "aether/plugin-sdk/llm": bundledLlm,
  "@aether/plugin-sdk/llm": bundledLlm,
  "aether/plugin-sdk/agent-sessions": bundledAgentSessions,
  "@aether/plugin-sdk/agent-sessions": bundledAgentSessions,
};
...
const EXTENSION_LOADER_ALIAS_IMPORT_PATTERN =
  /(?:@aether\/plugin-sdk|aether\/plugin-sdk|@sinclair\/typebox|typebox)(?:\/[A-Za-z0-9_-]+)?/u;
...
async function loadExtensionSourceTransformModule(
  ...
  if (!context.sourceTransformLoader) {
    installAetherInternalCorePackageNativeResolver({ moduleUrl: import.meta.url });
