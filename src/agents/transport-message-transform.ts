 ...
 */
import { resolveModelBoundThinkingReplayMode } from "@aether/ai/internal/anthropic";
import {
...
const SYNTHETIC_TOOL_RESULT_APIS = new Set<string>([
  ...
  "aether-openai-responses-transport",
  "aether-openai-chatgpt-responses-transport",
  "aether-azure-openai-responses-transport",
]);
...
// Codex, Azure, and their Aether transport aliases; Gemini/Anthropic use their
