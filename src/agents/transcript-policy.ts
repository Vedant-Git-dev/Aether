 ...
 */
import { bindsClaudeThinkingPrefix } from "@aether/llm-core";
...
const transcriptPolicyCache = new WeakMap<AetherConfig, Map<string, TranscriptPolicy>>();

function canCacheTranscriptPolicy(params: {
  config?: AetherConfig;
  env?: NodeJS.ProcessEnv;
}): params is { config: AetherConfig; env?: NodeJS.ProcessEnv } {
  if (!params.config) {
    return false;
  }
