...
import type { AetherPluginToolDelivery } from "../plugins/tool-types.js";
import { resolvePluginTools } from "../plugins/tools.js";
import type { AetherPluginToolContext } from "../plugins/types.js";
...
import {
  resolveAetherPluginToolInputs,
  type AetherPluginToolOptions,
} from "./aether-tools.plugin-context.js";
...
type ResolveAetherPluginToolsOptions = AetherPluginToolOptions & {
...
function createPluginToolDelivery(params: {
  options: ResolveAetherPluginToolsOptions | undefined;
  context: AetherPluginToolContext;
  bindingConfig: AetherConfig | undefined;
  resolveConfig: () => AetherConfig | undefined;
}): AetherPluginToolDelivery | undefined {
...
export function resolveAetherPluginToolsForOptions(params: {
  options?: ResolveAetherPluginToolsOptions;
  resolvedConfig?: AetherConfig;
  ...
  const pluginToolInputs = resolveAetherPluginToolInputs({
