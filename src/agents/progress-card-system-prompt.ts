...
import { shouldIncludeProgressCardToolForAetherTools } from "./aether-tools.registration.js";
...
export async function appendProgressCardSystemPrompt(params: {
  ...
  const progressCardToolAvailable = shouldIncludeProgressCardToolForAetherTools({
    agentId: params.agentId,
