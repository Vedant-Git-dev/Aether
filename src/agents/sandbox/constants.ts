...
export const DEFAULT_SANDBOX_IMAGE = "aether-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "aether-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "aether-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "aether-sandbox-common:bookworm-slim";
...
export const DEFAULT_SANDBOX_BROWSER_PREFIX = "aether-sbx-browser-";
