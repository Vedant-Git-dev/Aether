...
type SandboxRegistryTable = AetherStateKyselyDatabase["sandbox_registry_entries"];
type SandboxRegistryDatabase = Pick<AetherStateKyselyDatabase, "sandbox_registry_entries">;
