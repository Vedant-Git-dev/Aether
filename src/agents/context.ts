...
function primeConfiguredContextWindowsFromConfig(cfg: AetherConfig): AetherConfig {
...
function primeConfiguredContextWindows(): AetherConfig | undefined {
...
export function ensureContextWindowCacheLoaded(cfgOverride?: AetherConfig): Promise<void> {
...
export async function refreshContextWindowCache(cfg: AetherConfig): Promise<void> {
  beginContextWindowCacheRefresh();
  const caches = getContextWindowCaches();
