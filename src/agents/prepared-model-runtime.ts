...
export function advancePreparedModelRuntimeConfig(config: AetherConfig): void {
  for (const owner of owners.values()) {
...
export function refreshPreparedModelRuntimeSnapshots(
  config: AetherConfig | (() => AetherConfig | Promise<AetherConfig>),
  options: PreparedModelRuntimeRefreshOptions = {},
): Promise<void> {
...
if (process.env.VITEST || process.env.NODE_ENV === "test") {
  (globalThis as Record<PropertyKey, unknown>)[Symbol.for("aether.preparedModelRuntimeTestApi")] =
    {
