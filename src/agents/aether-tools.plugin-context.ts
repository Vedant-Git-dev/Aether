...
/**
 * Runtime context resolver for Aether plugin tools.
 *
...
/** Options provided by agent runtime callers when invoking Aether plugin tools. */
...
export function resolveAetherPluginToolInputs(params: {
  options?: AetherPluginToolOptions;
