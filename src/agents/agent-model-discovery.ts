...
function createAetherModelRegistry(
...
export function discoverModels(
  ...
  return createAetherModelRegistry(
    authStorage,
...
export function discoverModelsFromCapturedSources(
  ...
  return createAetherModelRegistry(authStorage, CAPTURED_MODELS_JSON_SOURCE_PATH, undefined, {
    ...options,
