        ...
        : [
            ...
            ...(params.acpEnabled
              ? [
                  ...
                  "Local subagent list/status tools cover Aether runtime=subagent only; ACP ids come from `acp.allowedAgents`.",
                  "Never ask the user for slash/CLI or exec aether/acpx when delegation tools can act.",
                ]
              : []),
          ]),
      "",
