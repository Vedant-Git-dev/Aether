...
import { asFiniteNumber as normalizeFiniteNumber } from "@aether/normalization-core/number-coercion";
...
type SubagentRunsTable = AetherStateKyselyDatabase["subagent_runs"];
type SubagentRegistryDatabase = Pick<AetherStateKyselyDatabase, "subagent_runs">;
