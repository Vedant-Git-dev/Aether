...
function resolveSubagentWaitTimeoutMs(cfg: AetherConfig, runTimeoutSeconds?: number) {
...
const SUBAGENT_REGISTRY_TEST_HANDLE = Symbol.for("aether.subagentRegistryTestApi");
