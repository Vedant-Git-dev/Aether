...
import { asOptionalRecord as toRecord } from "@aether/normalization-core/record-coerce";
import {
...
const PRESENTATION_FALLBACK_CONTINUATION = Symbol.for(
  "aether.presentation.fallback-continuation",
);
...
export type MessagePresentationAction =
  ...
  | {
      ...
      url: string;
      /** Aether hosted-widget ID whose launch mechanics are owned by the channel. */
      widgetId?: string;
    }
  | {
      /** Launch a channel-native web app. */
