...
export type ChannelMessageSendTextContext<TConfig = AetherConfig> = {
  cfg: TConfig;
  to: string;
  text: string;
...
export type ChannelMessageSendMediaContext<TConfig = AetherConfig> =
...
export type ChannelMessageSendPayloadContext<TConfig = AetherConfig> =
  ChannelMessageSendTextContext<TConfig> & {
...
export type ChannelMessageSendPollContext<TConfig = AetherConfig> = Omit<
  ChannelMessageSendTextContext<TConfig>,
  "text" | "threadId"
> & {
  poll: PollInput;
...
export type ChannelMessageSendAttemptContext<TConfig = AetherConfig> =
...
type ChannelMessageSendFailureContext<TConfig = AetherConfig> =
  ChannelMessageSendAttemptContext<TConfig> & {
    error: unknown;
    attemptToken?: unknown;
  };
...
export type ChannelMessageUnknownSendContext<TConfig = AetherConfig> = {
  cfg: TConfig;
  queueId: string;
  channel: string;
  to: string;
...
export type ChannelMessageDeferredDeliveryAdmissionContext<TConfig = AetherConfig> = {
  cfg: TConfig;
  channel: string;
  to: string;
  accountId?: string | null;
