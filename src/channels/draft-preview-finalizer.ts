...
/**
 * @deprecated Use `LivePreviewFinalizerDraft` from `aether/plugin-sdk/channel-outbound`.
 */
export type DraftPreviewFinalizerDraft<TId> = LivePreviewFinalizerDraft<TId>;

/**
 * @deprecated Use `LivePreviewFinalizerResult` from `aether/plugin-sdk/channel-outbound`.
 */
...
/**
 * @deprecated Use `deliverFinalizableLivePreview` from `aether/plugin-sdk/channel-outbound`.
 */
