...
function resolveLegacyChannelConfig(cfg: AetherConfig, channel: string): Record<string, unknown> {
...
export async function promptLegacyChannelAllowFromForAccount<TAccount>(params: {
  ...
  resolveAccount: (cfg: AetherConfig, accountId: string) => TAccount;
  resolveExisting: (account: TAccount, cfg: AetherConfig) => Array<string | number>;
