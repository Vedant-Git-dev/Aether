...
function getChannelSection(cfg: AetherConfig, channelKey: string): ChannelSectionWithAccounts {
...
}): { cfg: AetherConfig; restore: (cfg: AetherConfig) => AetherConfig } {
  ...
  return {
    ...
    configure: async ({
      ...
      const accountScope = shouldScopeAccount
        ...
        : { cfg, restore: (currentCfg: AetherConfig) => currentCfg };
