...
export async function configureChannelAccessWithAllowlist<TResolved>(params: {
  ...
  setPolicy: (cfg: AetherConfig, policy: ChannelAccessPolicy) => AetherConfig;
  resolveAllowlist?: (params: { cfg: AetherConfig; entries: string[] }) => Promise<TResolved>;
  applyAllowlist?: (params: { cfg: AetherConfig; resolved: TResolved }) => AetherConfig;
