...
export type ChannelAgentToolFactory = (params: { cfg?: AetherConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: AetherConfig; accountId?: string | null }) => string[];
  messageToolCapabilities?: (params: {
    cfg: AetherConfig;
    accountId?: string | null;
  }) => string[] | undefined;
  inboundFormattingHints?: (params: { cfg: AetherConfig; accountId?: string | null }) =>
    | {
        text_markup: string;
        rules: string[];
      }
