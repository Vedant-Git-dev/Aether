...
export type ChannelConfigAdapter<ResolvedAccount> = {
  ...
  resolveAccount: (cfg: AetherConfig, accountId?: string | null) => ResolvedAccount;
  inspectAccount?: (cfg: AetherConfig, accountId?: string | null) => unknown;
  ...
  deleteAccount?: (params: { cfg: AetherConfig; accountId: string }) => AetherConfig;
  isEnabled?: ChannelAdapterCallback<(account: ResolvedAccount, cfg: AetherConfig) => boolean>;
  disabledReason?: ChannelAdapterCallback<
    (account: ResolvedAccount, cfg: AetherConfig) => string
  >;
  isConfigured?: ChannelAdapterCallback<
    (account: ResolvedAccount, cfg: AetherConfig) => boolean | Promise<boolean>
  >;
  ...
  describeAccount?: ChannelAdapterCallback<
    (account: ResolvedAccount, cfg: AetherConfig) => ChannelAccountSnapshot
  >;
  ...
  hasPersistedAuthState?: (params: { cfg: AetherConfig; env?: NodeJS.ProcessEnv }) => boolean;
...
export type ChannelStatusAdapter<ResolvedAccount, Probe = unknown, Audit = unknown> = {
  ...
  probeAccount?: ChannelAdapterCallback<
    (params: { account: ResolvedAccount; timeoutMs: number; cfg: AetherConfig }) => Promise<Probe>
  >;
...
export type ChannelGatewayContext<ResolvedAccount = unknown> = {
   ...
   * @see {@link https://docs.aether.ai/plugins/building-plugins | Plugin SDK documentation}
   */
...
export type ChannelGatewayAdapter<ResolvedAccount = unknown> = {
  ...
  resolveGatewayAuthBypassPaths?: (params: { cfg: AetherConfig }) => string[];
...
export type ChannelDoctorAdapter = {
  ...
  normalizeCompatibilityConfig?: (params: { cfg: AetherConfig }) => ChannelDoctorConfigMutation;
...
export type ChannelLifecycleAdapter = {
  onAccountConfigChanged?: (params: {
    prevCfg: AetherConfig;
    nextCfg: AetherConfig;
    accountId: string;
    runtime: RuntimeEnv;
  }) => Promise<void> | void;
...
type ChannelApprovalDeliveryAdapter = {
  hasConfiguredDmRoute?: (params: { cfg: AetherConfig }) => boolean;
...
export type ChannelAllowlistAdapter = {
  applyConfigEdit?: (params: {
    ...
    | Promise<
      ...
      >
    | null;
  readConfig?: (params: { cfg: AetherConfig; accountId?: string | null }) =>
    | {
...
export type ChannelConversationBindingSupport = {
  ...
  createManager?: (params: { cfg: AetherConfig; accountId?: string | null }) =>
    | {
