...
function getChannelConfigRecord(cfg: AetherConfig, channelId: string): Record<string, unknown> {
...
function listManifestChannelAccountIds(cfg: AetherConfig, channelId: string): string[] {
...
function resolveManifestChannelDefaultAccountId(cfg: AetherConfig, channelId: string): string {
  const channelConfig = getChannelConfigRecord(cfg, channelId);
