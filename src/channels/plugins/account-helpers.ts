...
>(
  ...
  options?: {
    ...
    additionalAccountIds?: (cfg: AetherConfig) => Iterable<string>;
    fallbackAccountIdWhenEmpty?: string | false;
    implicitDefaultAccount?: {
      channelKeys?: readonly string[];
      envVars?: readonly string[];
    };
    hasImplicitDefaultAccount?: (cfg: AetherConfig) => boolean;
    resolveImplicitAccountId?: (cfg: AetherConfig) => string | undefined;
  },
) {
  function hasImplicitDefaultAccount(cfg: AetherConfig): boolean {
  ...
  function resolveConfiguredDefaultAccountId(cfg: AetherConfig): string | undefined {
    const channel = cfg.channels?.[channelKey] as Record<string, unknown> | undefined;
  ...
  function listConfiguredAccountIds(cfg: AetherConfig): string[] {
  ...
  function listAccountIds(cfg: AetherConfig): string[] {
  ...
  function resolveDefaultAccountId(cfg: AetherConfig): string {
  ...
  return {
    ...
    resolveAccountConfig: (cfg: AetherConfig, accountId: string): TConfig => {
