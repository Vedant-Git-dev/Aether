...
const TASK_REGISTRY_REVISION_KEY = Symbol.for("aether.taskRegistry.revision");
...
export const TASK_REGISTRY_DELIVERY_RUNTIME_OVERRIDE_KEY = Symbol.for(
  "aether.taskRegistry.deliveryRuntimeOverride",
);
export const TASK_REGISTRY_CONTROL_RUNTIME_OVERRIDE_KEY = Symbol.for(
  "aether.taskRegistry.controlRuntimeOverride",
);
