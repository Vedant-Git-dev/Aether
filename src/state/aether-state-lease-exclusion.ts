...
import { acquireAetherStateDatabaseFileExclusion } from "./aether-state-db-cache.js";
import type { AetherStateMutationOperation } from "./aether-state-lease-context.js";
import type { CaptureOwner, LeaseExclusionParams } from "./aether-state-lease-owner.js";
...
async function perform<T>(
  ...
  let exclusion: ReturnType<typeof acquireAetherStateDatabaseFileExclusion> | undefined;
  ...
  try {
    ...
    exclusion = acquireAetherStateDatabaseFileExclusion(databasePath);
...
export function createAetherStateLeaseExclusion(params: LeaseExclusionParams) {
  ...
  return {
    ...
    runMutation<T, R>(operation: AetherStateMutationOperation<T, R>): Promise<R> {
