...
export type AetherStateLeaseIdentity = { scope: string; key: string; owner: string };
...
export function acquireAetherStateLeaseInTransaction(
  db: DatabaseSync,
  identity: AetherStateLeaseIdentity,
  leaseMs: number,
): number | undefined {
...
export function readAetherStateLeaseExpiry(
  db: DatabaseSync,
  identity: AetherStateLeaseIdentity,
): number | undefined {
...
export function renewAetherStateLeaseInTransaction(
  db: DatabaseSync,
  identity: AetherStateLeaseIdentity,
  leaseMs: number,
): number | undefined {
...
export function releaseAetherStateLeaseInTransaction(
  db: DatabaseSync,
  identity: AetherStateLeaseIdentity,
): void {
  executeSqliteQuerySync(
