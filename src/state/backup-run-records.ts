...
import type { DB as AetherStateDatabase } from "./aether-state-db.generated.js";
...
type BackupRunDatabase = Pick<AetherStateDatabase, "backup_runs">;
...
export function recordBackupRunOutcome(params: {
  ...
  if (!existsSync(resolveAetherStateSqlitePath(params.env ?? process.env))) {
    return;
  }
