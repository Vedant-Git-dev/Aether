...
} from "./aether-state-lease-heartbeat-shared.js";
import {
...
const renew = () => {
  ...
  try {
        ...
        () =>
          runSqliteImmediateTransactionSync(
            ...
            () => {
              ...
              return renewAetherStateLeaseInTransaction(db, params.identity, params.leaseMs);
            },
            { logger: { warn() {} } },
          ),
    ...
    expiresAt = readAetherStateLeaseExpiry(db, params.identity);
  }
