...
type UserPreferencesDatabase = Pick<AetherStateKyselyDatabase, "user_preferences">;
...
export const ensureUserPreferencesSchema = createAetherStateSchemaEnsurer({
...
function openUserPreferencesDatabase(options: AetherStateDatabaseOptions = {}) {
