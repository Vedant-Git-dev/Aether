...
// Re-exports the Aether CLI entry point for package execution.
...
if (
  ...
  (existsSync(new URL(".aether-lifecycle-pending", packageRootUrl)) ||
    existsSync(new URL("dist/aether-install-guard", packageRootUrl)))
) {
