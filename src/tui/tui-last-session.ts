...
import { normalizeLowercaseStringOrEmpty as normalizeMarker } from "@aether/normalization-core/string-coerce";
...
type TuiLastSessionDatabase = Pick<AetherStateKyselyDatabase, "config_machine_state">;
...
export function clearTuiLastSessionPointers(params: {
  ...
  const matchingKeys = withExistingAetherStateDatabaseReadOnly(({ db }) => {
