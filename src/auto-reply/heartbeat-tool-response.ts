...
import { normalizeOptionalString as readString } from "@aether/normalization-core/string-coerce";
...
const HEARTBEAT_RESPONSE_CHANNEL_DATA_KEY = "aetherHeartbeatResponse";
