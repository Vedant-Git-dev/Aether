import { asPositiveFiniteNumber as normalizePairingQrExpiresAtMs } from "@aether/normalization-core/number-coercion";
import {
  readNonBlankString,
...
const PAIRING_QR_REPLY_CHANNEL_DATA_KEY = "aetherPairingQr";
...
export function isFastModeAutoProgressPayload(payload: Pick<ReplyPayload, "channelData">): boolean {
  return payload.channelData?.aetherProgressKind === FAST_MODE_AUTO_PROGRESS_KIND;
}
...
export type ReplyPayloadMetadata = {
  ...
  /**
   * Internal Aether notices and host-owned artifacts are not assistant source
