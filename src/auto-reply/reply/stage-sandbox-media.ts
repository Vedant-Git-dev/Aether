...
import { isInboundPathAllowed } from "@aether/media-core/inbound-path-policy";
...
export async function stageSandboxMedia(params: {
  ...
  // For remote attachments without sandbox, use ~/.aether/media (not agent workspace for privacy).
  // Managed local inbound refs are already in Aether's media store; when no sandbox is
