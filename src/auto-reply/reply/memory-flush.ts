...
import { resolveAnthropicServerCompactionPlan } from "@aether/ai/internal/anthropic";
import { resolveOpenAIResponsesServerCompactionPlan } from "@aether/ai/internal/openai-responses-payload-policy";
...
export function resolveMaxActiveTranscriptBytes(cfg?: AetherConfig): number | undefined {
