import { asFiniteNumber as readFiniteNumberValue } from "@aether/normalization-core/number-coercion";
import { asOptionalRecord as readRecordValue } from "@aether/normalization-core/record-coerce";
