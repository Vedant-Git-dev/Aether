...
import { basenameFromAnyPath } from "@aether/media-core/file-name";
import { isPassThroughRemoteMediaSource } from "@aether/media-core/media-source-url";
...
export function createReplyMediaPathNormalizer(params: {
  ...
  // `aether agent --deliver` with `--reply-channel/--reply-to`) still get
