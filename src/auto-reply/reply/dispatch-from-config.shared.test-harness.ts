...
const acpMocks = vi.hoisted(() => ({
  ...
  readAcpSessionEntry: vi.fn<
    (params: { sessionKey: string; agentId?: string; cfg?: AetherConfig }) => unknown
  >(() => null),
...
const ttsMocks = vi.hoisted(() => {
  ...
  return {
    ...
    resolveTtsConfig: vi.fn((_cfg: AetherConfig) => ({ mode: "final" })),
  };
});
...
vi.mock("./dispatch-acp-manager.runtime.js", () => ({
  ...
  readAcpSessionEntry: (params: { sessionKey: string; agentId?: string; cfg?: AetherConfig }) =>
...
vi.mock("../../tts/tts.js", () => ({
  ...
  resolveTtsConfig: (cfg: AetherConfig) => ttsMocks.resolveTtsConfig(cfg),
}));
...
vi.mock("../../tts/tts-config.js", () => ({
  normalizeTtsAutoMode: (value: unknown) => ttsMocks.normalizeTtsAutoMode(value),
  resolveConfiguredTtsMode: (cfg: AetherConfig) => ttsMocks.resolveTtsConfig(cfg).mode,
  resolveEffectiveTtsConfig: (cfg: AetherConfig) => cfg.tts ?? {},
...
export const emptyConfig = {} as AetherConfig;
