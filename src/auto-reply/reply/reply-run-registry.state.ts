...
import type { AetherAgentDatabaseIdentity } from "../../state/aether-agent-db-identity.js";
...
export type ReplyRunAdmissionSource = {
  ...
  databaseIdentity?: AetherAgentDatabaseIdentity;
};

export type ReplyRunAdmissionBarrier = {
  settled: Promise<void>;
  source: ReplyRunAdmissionSource;
  sources: Map<AetherAgentDatabaseIdentity | undefined, ReplyRunAdmissionSource>;
};

type ReplyOperationAdmission = {
  lease?: SessionWorkAdmissionLease;
  readonly databaseIdentity?: AetherAgentDatabaseIdentity;
};
...
const REPLY_RUN_STATE_KEY = Symbol.for("aether.replyRunRegistry");
