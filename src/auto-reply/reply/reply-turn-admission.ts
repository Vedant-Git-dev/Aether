...
import type { AetherAgentDatabaseClaim } from "../../state/aether-agent-db-identity.js";
import {
...
export async function admitReplyTurn(
  ...
  let admittedDatabaseClaim: AetherAgentDatabaseClaim | undefined;
  let owned = false;
  const assertDatabaseOwnerCurrent = (nextClaim?: AetherAgentDatabaseClaim) => {
    if (
