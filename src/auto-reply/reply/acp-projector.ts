// Projects ACP runtime events into Aether-visible session update records.
import type { AcpRuntimeEvent, AcpSessionUpdateTag } from "@aether/acp-core/runtime/types";
import {
