...
export function buildBuiltinChatCommands(
  ...
  const commands: ChatCommandDefinition[] = [
    ...
    defineBuiltinCommand(
      "aether",
      "Run the Aether setup and repair helper.",
      "management",
      "essential",
      {
        nativeName: false,
    ...
    defineBuiltinCommand("mcp", "Show or set Aether MCP servers.", "management", "power", {
      args: [
        defineCommandArgument("action", "show | get | set | unset", {
          choices: ["show", "get", "set", "unset"],
        }),
    ...
    defineBuiltinCommand("restart", "Restart Aether.", "tools", "power"),
    defineBuiltinCommand("update", "Update Aether and restart.", "tools", "power"),
