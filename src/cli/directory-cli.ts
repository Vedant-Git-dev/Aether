    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["aether directory self --channel slack", "Show the connected account identity."],
          [
            'aether directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["aether directory groups list --channel discord", "List available groups/channels."],
          [
            "aether directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.aether.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
