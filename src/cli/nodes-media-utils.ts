...
import { extnameFromAnyPath } from "@aether/media-core/file-name";
import { resolvePreferredAetherTmpDir } from "../infra/tmp-aether-dir.js";
export { asFiniteNumber as asNumber } from "@aether/normalization-core/number-coercion";
export { asRecord } from "@aether/normalization-core/record-coerce";
export { readStringValue } from "@aether/normalization-core/string-coerce";
...
export function resolveTempPathParts(opts: { ext: string; tmpDir?: string; id?: string }): {
  ...
  const tmpDir = opts.tmpDir ?? resolvePreferredAetherTmpDir();
