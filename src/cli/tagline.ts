...
const DEFAULT_TAGLINE = "All your chats, one Aether.";
...
const TAGLINES: string[] = [
  ...
  "You had me at 'aether gateway start.'",
  ...
  "If found wandering, please return to ~/.aether.",
  ...
  "Aether Support will never DM you first. I, on the other hand, absolutely will.",
  ...
  "The artist formerly known as Aether.",
...
export function pickTagline(options: TaglineOptions = {}): string {
  ...
  const override = env?.AETHER_TAGLINE_INDEX;
