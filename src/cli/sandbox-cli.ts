...
const SANDBOX_EXAMPLES = {
  main: [
    ["aether sandbox list", "List all sandbox containers."],
    ["aether sandbox list --browser", "List only browser containers."],
    ["aether sandbox recreate --all", "Recreate all containers."],
    ["aether sandbox recreate --session main", "Recreate a specific session."],
    ["aether sandbox recreate --agent mybot", "Recreate agent containers."],
    ["aether sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["aether sandbox list", "List all sandbox containers."],
    ["aether sandbox list --browser", "List only browser containers."],
    ["aether sandbox list --json", "JSON output."],
  ],
  recreate: [
    ["aether sandbox recreate --all", "Recreate all containers."],
    ["aether sandbox recreate --session main", "Recreate a specific session."],
    ["aether sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["aether sandbox recreate --browser --all", "Recreate only browser containers."],
    ["aether sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["aether sandbox explain", "Show effective sandbox config."],
    ["aether sandbox explain --session agent:main:main", "Explain a specific session."],
    ["aether sandbox explain --agent work", "Explain an agent sandbox."],
    ["aether sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.aether.ai/cli/sandbox")}\n`,
    )
    .action(() => {
