...
/** Parse `aether health` flags for the route-first status family. */
...
/** Parse `aether status` flags without registering the full command tree. */
...
/** Parse `aether gateway status` RPC-only flags accepted by the fast route. */
...
/** Parse machine-readable `aether gateway health` calls for route-first execution. */
...
/** Parse `aether sessions` filters for JSON/list route execution. */
...
/** Parse `aether agents list` display switches for route-first execution. */
...
/** Parse `aether config get <path>` while preserving root option handling. */
...
/** Parse `aether config unset <path>` and its mutation guard flags. */
...
/** Parse `aether models list` filters for the lightweight model catalog route. */
...
/** Parse both parent aliases and `aether models status` through one status owner. */
...
/** Parse `aether channels list` display flags for the route-first list path. */
...
/** Parse `aether channels status` probe flags without full CLI registration. */
...
/** Parse `aether plugins list` flags for the metadata-only inventory path. */
...
/** Parse both `aether tasks --json` and `aether tasks list --json` aliases. */
...
/** Parse JSON-only `aether tasks audit` filters for the route-first audit path. */
