...
const subCliCommandDescriptors = [
  ...
  },
  {
    name: "devices",
    description:
      "Device pairing and auth tokens (for mobile app setup codes, use `aether qr` instead)",
    hasSubcommands: true,
  ...
  {
    name: "connect",
    description: "Connect this machine to an Aether Gateway as a node",
  ...
  {
    name: "docs",
    description: "Search the live Aether docs",
    hasSubcommands: false,
  },
  {
    name: "qa",
  ...
  {
    name: "proxy",
    description: "Run the Aether debug proxy and inspect captured traffic",
    hasSubcommands: true,
  ...
  {
    name: "plugins",
    description: "Manage Aether plugins and extensions",
    hasSubcommands: true,
    parentDefaultHelp: true,
  },
  {
