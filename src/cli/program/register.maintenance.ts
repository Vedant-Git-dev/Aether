...
/** Register maintenance commands that inspect or mutate local Aether state. */
export function registerMaintenanceCommands(program: Command) {
  const doctor = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/doctor", "docs.aether.ai/cli/doctor")}\n`,
    )
    ...
    .option(
      "--github-issue",
      "With --session-sqlite recover: prepare and optionally create an aether/aether issue",
      false,
    )
    ...
    .action(async (opts, command) => {
      ...
      if (hasSessionSqliteOnlyDoctorOptions(opts)) {
        return exitDoctorError(
          "doctor session SQLite options require --session-sqlite. Use `aether vitals --session-sqlite dry-run ...`.",
      ...
      if (opts.lint !== true && hasLintOnlyDoctorOptions(opts)) {
        return exitDoctorError(
          "doctor lint options require --lint. Use `aether vitals --lint ...`.",
          opts.json === true,
        );
      }
      if (lintMode) {
  ...
  program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/triage", "docs.aether.ai/cli/triage")}\n`,
    )
  ...
  program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/dashboard", "docs.aether.ai/cli/dashboard")}\n`,
    )
  ...
  program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/reset", "docs.aether.ai/cli/reset")}\n`,
    )
  ...
  program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/uninstall", "docs.aether.ai/cli/uninstall")}\n`,
    )
