...
export const CORE_CLI_COMMAND_DESCRIPTORS = [
  {
    name: "ignite",
    description: "Chat with Aether; onboard when setup is incomplete",
    hasSubcommands: false,
  },
  {
    name: "setup", // hidden alias
    description: "Deprecated: use aether ignite",
    hasSubcommands: false,
    hidden: true,
  },
  {
  ...
  {
    name: "onboard", // hidden alias
    description: "Deprecated: use aether awaken",
    hasSubcommands: true,
    hidden: true,
  },
  {
  ...
  {
    name: "configure", // hidden alias
    description: "Deprecated: use aether tune",
    hasSubcommands: false,
    hidden: true,
  },
  {
  ...
  {
    name: "claws",
    description: "Inspect and add experimental Aether Claws",
    hasSubcommands: true,
  ...
  {
    name: "doctor", // hidden alias
    description: "Deprecated: use aether vitals",
    hasSubcommands: false,
    hidden: true,
    machineOutput: isDoctorMachineOutput,
  },
