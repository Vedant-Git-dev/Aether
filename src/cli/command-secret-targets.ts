...
function resolveFetchConfig(config: AetherConfig): Record<string, unknown> | undefined {
...
function resolveSearchConfig(config: AetherConfig): Record<string, unknown> | undefined {
...
function getCapabilityWebSearchAutoDetectTargets(config: AetherConfig): CommandSecretTargetScope {
...
function getCapabilityWebFetchAutoDetectTargets(config: AetherConfig): CommandSecretTargetScope {
  return getCapabilityWebProviderAutoDetectTargets({
    config,
...
function isScopedChannelSecretTargetEntry(params: {
  ...
  return (
    ...
    params.entry.configFile === "aether.json" &&
 ...
 */
export function getAgentRuntimeOptionalCommandSecretPaths(config: AetherConfig): Set<string> {
...
type CapabilityWebCommandSecretTargetParams = {
  ...
  autoDetectTargets: (config: AetherConfig) => CommandSecretTargetScope;
  selectedProviderTargetIds: (
    config: AetherConfig,
    providerId?: string | null,
  ) => SelectedProviderTargetIds;
