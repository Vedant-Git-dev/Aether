...
const QA_PARENT_PID_ENV = "AETHER_QA_PARENT_PID";
const QA_TEMP_ROOT_ENV = "AETHER_QA_TEMP_ROOT";
const QA_STAGED_RUNTIME_ROOT_ENV = "AETHER_QA_STAGED_RUNTIME_ROOT";

const DEFAULT_QA_PARENT_WATCHDOG_INTERVAL_MS = 1000;
const QA_TEMP_ROOT_PREFIX = "aether-qa-suite-";
