...
const LOCAL_MODEL_RUN_SYSTEM_PROMPT = "You are a personal assistant running inside Aether.";
...
async function loadModelCatalogForInspection(cfg: AetherConfig, rawAgentId?: string) {
  const agentId =
