...
import type { AetherDatabaseSchemaPreflight } from "../../state/aether-database-preflight.js";
...
export async function preflightUpdateCommandSchemas(params: {
  ...
  packageTargetSchemaVersions?: AetherSchemaVersions;
  ...
  { packageSchemaPreflight: AetherDatabaseSchemaPreflight; preflightNotes: string[] } | undefined
> {
  const {
    root,
    updateInstallKind,
  ...
  let packageSchemaPreflight: AetherDatabaseSchemaPreflight = {
    incompatible: [],
    indeterminate: [],
  };
