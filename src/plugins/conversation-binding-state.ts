...
type PluginBindingApprovalsDatabase = Pick<AetherStateKyselyDatabase, "plugin_binding_approvals">;
...
const pluginBindingGlobalStateKey = Symbol.for("aether.plugins.binding.global-state");
