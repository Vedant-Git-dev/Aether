...
import { resolveUnsupportedToolSchemaKeywords } from "@aether/ai/internal/tool-schema";
import { resolveOpenAICompletionsCompat } from "@aether/ai/transports";
...
// Tool-schema compat predicates moved into @aether/ai (agent-tools-parameter-schema);
