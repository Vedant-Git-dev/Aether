...
export type AetherPluginActiveModelContext = {
  provider?: string;
  modelId?: string;
  modelRef?: string;
};
...
export type AetherPluginToolDelivery = {
  send: (params: { text?: string; mediaUrl?: string }) => Promise<void>;
};

/** Trusted execution context passed to plugin-owned agent tool factories. */
export type AetherPluginToolContext = {
  config?: AetherConfig;
   ...
   * the local operator, installed plugin code, or a modified Aether runtime.
   */
  activeModel?: AetherPluginActiveModelContext;
  browser?: {
  ...
  delivery?: AetherPluginToolDelivery;
...
export type AetherPluginToolFactory = (
  ctx: AetherPluginToolContext,
) => AnyAgentTool | AnyAgentTool[] | null | undefined;

export type AetherPluginToolOptions = {
  name?: string;
  names?: string[];
  optional?: boolean;
};

export type AetherPluginHookOptions = {
  entry?: HookEntry;
  name?: string;
  description?: string;
  register?: boolean;
