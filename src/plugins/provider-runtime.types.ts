 ...
 *
 * Runs after Aether resolves an explicit/discovered/dynamic model and before
 ...
 *
 * The helper methods cover the common Aether auth resolution paths:
 *
 ...
 *
 * Called when OAuth refresh fails and Aether wants a provider-specific repair
...
/**
 * Provider-owned extra-param normalization before Aether builds its generic
 ...
 */
/** Provider-facing effort after Aether lowers orchestration-only modes. */
