...
}): Promise<{ config: AetherConfig; warnings: string[] }> {
 ...
 * the same target `aether vitals --fix` and `aether plugins update`
 ...
 * per-plugin `versionBoundToAether` descriptor that a managed install request
