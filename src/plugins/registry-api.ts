...
import type { AetherPluginApi, PluginLogger, PluginRegistrationMode } from "./types.js";
          ...
          ? {
              ...
              enqueueNextTurnInjection: async (injection) => {
                ...
                return enqueuePluginNextTurnInjection({
                  cfg: registryParams.runtime.config.current() as AetherConfig,
                  pluginId: record.id,
              ...
              sendSessionAttachment: async (attachment) => {
                ...
                try {
                  ...
                  const runtimeConfig =
                    (registryParams.runtime.config?.current?.() as AetherConfig | undefined) ??
                    params.config;
