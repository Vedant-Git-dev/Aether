...
type RuntimeConfigMutationContext = {
  snapshot: import("../../config/types.aether.js").ConfigFileSnapshot;
...
type RuntimeMutateConfigFileParams<T = void> = {
  ...
  mutate: (
    draft: import("../../config/types.aether.js").AetherConfig,
    context: RuntimeConfigMutationContext,
  ) => Promise<T | void> | T | void;
};
type RuntimeReplaceConfigFileParams = {
  nextConfig: import("../../config/types.aether.js").AetherConfig;
  baseHash?: string;
  afterWrite: RuntimeConfigAfterWrite;
  writeOptions?: RuntimeWriteConfigOptions;
};
...
export type PluginRuntimeCore = {
  ...
  config: {
    ...
    current: () => DeepReadonly<import("../../config/types.aether.js").AetherConfig>;
    /**
  ...
  media: {
    ...
    detectMime: typeof import("@aether/media-core/mime").detectMime;
    mediaKindFromMime: typeof import("@aether/media-core/constants").mediaKindFromMime;
  ...
  modelAuth: {
    ...
    getApiKeyForModel: (params: {
      model: import("aether/plugin-sdk/llm").Model<import("aether/plugin-sdk/llm").Api>;
      cfg?: import("../../config/types.aether.js").AetherConfig;
      workspaceDir?: string;
