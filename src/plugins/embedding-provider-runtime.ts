...
export function listEmbeddingProviders(cfg?: AetherConfig): EmbeddingProviderAdapter[] {
...
function resolveEmbeddingProviderLookupIds(id: string, cfg?: AetherConfig): string[] {
