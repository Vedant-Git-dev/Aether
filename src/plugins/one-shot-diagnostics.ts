...
function suppressOtelStdoutLogSink(config: AetherConfig): AetherConfig {
...
function isOtelExportConfigured(config: AetherConfig): boolean {
 ...
 * startup; one-shot `aether agent --local` runs execute the agent in the CLI
