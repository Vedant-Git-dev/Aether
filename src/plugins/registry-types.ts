...
import type {
  AetherPluginHttpRouteAuth,
  AetherPluginHttpRouteUpgradeHandler,
} from "./types.js";
...
type AetherPluginCliRootCommandDescriptor =
  import("./types.js").AetherPluginCliRootCommandDescriptor;
type AetherPluginCliRegistrar = import("./types.js").AetherPluginCliRegistrar;
type AetherPluginCommandDefinition = import("./types.js").AetherPluginCommandDefinition;
type PluginInteractiveHandlerRegistration =
  import("./types.js").PluginInteractiveHandlerRegistration;
type AetherPluginGatewayRuntimeScopeSurface =
  import("./types.js").AetherPluginGatewayRuntimeScopeSurface;
type AetherGatewayDiscoveryService = import("./types.js").AetherGatewayDiscoveryService;
type AetherPluginHttpRouteHandler = import("./types.js").AetherPluginHttpRouteHandler;
type AetherPluginHttpRouteMatch = import("./types.js").AetherPluginHttpRouteMatch;
type AetherPluginHostedMediaResolver = import("./types.js").AetherPluginHostedMediaResolver;
type AetherPluginReloadRegistration = import("./types.js").AetherPluginReloadRegistration;
type AetherPluginSecurityAuditCollector =
  import("./types.js").AetherPluginSecurityAuditCollector;
type AetherPluginService = import("./types.js").AetherPluginService;
type AetherPluginToolFactory = import("./types.js").AetherPluginToolFactory;
...
export type PluginToolRegistration = PluginRegistrationOwner & {
  factory: AetherPluginToolFactory;
  names: string[];
...
type PluginCliRegistration = PluginRegistrationOwner & {
  register: AetherPluginCliRegistrar;
  parentPath: string[];
  commands: string[];
  descriptors: AetherPluginCliRootCommandDescriptor[];
};
...
type PluginHostedMediaResolverRegistration = PluginRegistrationOwner & {
  resolver: AetherPluginHostedMediaResolver;
};
...
type PluginSecurityAuditCollectorRegistration = PluginRegistrationOwner & {
  collector: AetherPluginSecurityAuditCollector;
};

export type PluginCommandRegistration = PluginRegistrationOwner & {
  command: AetherPluginCommandDefinition;
