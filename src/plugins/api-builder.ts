...
import { attachPluginApiFacades, type AetherPluginApiWithoutFacades } from "./api-facades.js";
import type { PluginRuntime } from "./runtime/types.js";
import type { AetherPluginApi, PluginLogger } from "./types.js";
...
type BuildPluginApiParams = {
  ...
  handlers?: Partial<Pick<AetherPluginApi, keyof typeof noops>>;
};
...
const noops = {
  ...
  on: () => {},
} satisfies Partial<AetherPluginApi>;
...
export function buildPluginApi(params: BuildPluginApiParams): AetherPluginApi {
  ...
  const api: AetherPluginApiWithoutFacades = {
    id: params.id,
    name: params.name,
