...
export function createMemoryRegistrars(state: PluginRegistryState) {
  ...
  const registerMemoryCapability = (
    record: PluginRecord,
    capability: Parameters<AetherPluginApi["registerMemoryCapability"]>[0],
  ) => {
  ...
  const registerMemoryPromptSupplement = (
    record: PluginRecord,
    builder: Parameters<AetherPluginApi["registerMemoryPromptSupplement"]>[0],
  ) => {
  ...
  const registerMemoryPromptPreparation = (
    record: PluginRecord,
    prepare: Parameters<AetherPluginApi["registerMemoryPromptPreparation"]>[0],
  ) => {
  ...
  const registerMemoryCorpusSupplement = (
    record: PluginRecord,
    supplement: Parameters<AetherPluginApi["registerMemoryCorpusSupplement"]>[0],
  ) => {
