...
function resolveManagedPluginMetadataParams(config: AetherConfig, env: NodeJS.ProcessEnv) {
...
function resolveManagedPluginMetadata(config: AetherConfig, env: NodeJS.ProcessEnv) {
...
export function loadFreshManagedPluginMetadata(config: AetherConfig, env: NodeJS.ProcessEnv) {
