...
import { inspectTlsCertificateError } from "@aether/ai/internal/shared";
...
const OPENAI_AUTH_PROBE_URL =
  "https://auth.openai.com/oauth/authorize?response_type=code&client_id=aether-preflight&redirect_uri=http%3A%2F%2Flocalhost%3A1455%2Fauth%2Fcallback&scope=openid+profile+email";
...
function hasOpenAICodexOAuthProfile(cfg: AetherConfig): boolean {
