...
export const PLUGIN_COMPAT_RECORDS = [
  ...
  },
  {
    ...
    surfaces: [
      "aether/plugin-sdk/llm registerApiProvider",
      "aether/plugin-sdk/llm unregisterApiProviders",
    ],
  ...
  },
  {
    ...
    surfaces: [
      ...
      "aether/plugin-sdk/memory-core-host-engine-embeddings registerMemoryEmbeddingProvider",
  ...
  },
  {
    ...
    surfaces: [
      "aether/plugin-sdk/session-store-runtime loadSessionStore",
      "aether/plugin-sdk/session-store-runtime updateSessionStore",
      "aether/plugin-sdk/session-store-runtime resolveSessionFilePath",
      "aether/plugin-sdk/session-store-runtime resolveSessionStoreEntry",
      "aether package root loadSessionStore",
      "aether package root saveSessionStore",
    ],
  ...
  },
  {
    ...
    surfaces: [
      "aether/plugin-sdk/agent-scope-runtime resolveSessionAgentIds and resolveSessionAgentId",
      "aether/plugin-sdk/agent-runtime session-agent resolver aliases",
      "aether/plugin-sdk/agent-harness-runtime session-agent resolver aliases",
      "aether/plugin-sdk/memory-core-host-runtime-core session-agent resolver alias",
      "aether/plugin-sdk/memory-host-core session-agent resolver alias",
    ],
  ...
  },
  {
    ...
    surfaces: [
      "aether/plugin-sdk/agent-harness-runtime buildCredentialSafetyPrompt string argument",
    ],
  ...
  },
  {
    ...
    surfaces: [
      "@aether/whatsapp WebInboundMessage flat fields",
  ...
  },
  {
    ...
    docsPath: "/plugins/compatibility",
    surfaces: [
      "@aether/whatsapp WebInboundMessage top-level admission fields",
      "WhatsApp monitorWebInbox onMessage callback",
      "WhatsApp monitorWebChannel listenerFactory injected messages",
    ],
    diagnostics: ["plugin compatibility registry and compatibility guide"],
  ...
  },
  {
    ...
    docsPath: "/plugins/compatibility",
    surfaces: [
      "aether/plugin-sdk reply-runtime MsgContext.UntrustedContext and UntrustedStructuredContext",
      "aether/plugin-sdk reply-runtime UntrustedStructuredContextEntry",
      "aether/plugin-sdk channel-inbound SupplementalContextFacts.untrustedContext",
      "aether/plugin-sdk security-runtime buildUntrustedChannelMetadata",
    ],
  ...
  },
  {
    ...
    surfaces: [
      "aether/plugin-sdk/discord component message helpers",
      "aether/plugin-sdk/telegram-account resolveTelegramAccount",
    ],
  ...
  },
  {
    ...
    surfaces: [
      ...
      "aether/plugin-sdk/channel-route ChannelRouteExplicitTarget",
      "aether/plugin-sdk/channel-route ChannelRouteExplicitTargetParser",
      "aether/plugin-sdk/channel-route resolveChannelRouteTargetWithParser",
    ],
  ...
  },
  {
    ...
    owner: "sdk",
    introduced: "2026-04-28",
    replacement: "`aether/plugin-sdk/channel-targets`",
    docsPath: "/plugins/sdk-migration",
    surfaces: ["aether/plugin-sdk/messaging-targets"],
    diagnostics: ["plugin SDK compatibility warning"],
    tests: [
      "src/plugins/compat/registry.test.ts",
    ...
    releaseNote:
      "The deprecated `aether/plugin-sdk/messaging-targets` subpath was removed; import target helpers from `aether/plugin-sdk/channel-targets`.",
  },
  {
  ...
  },
  {
    ...
    surfaces: ["aether/plugin-sdk/agent-harness", "aether/plugin-sdk/agent-harness-runtime"],
    diagnostics: ["plugin SDK compatibility warning"],
  ...
  },
  {
    ...
    surfaces: [
      ...
      "aether/extension-api runEmbeddedPiAgent",
      "aether/plugin-sdk/agent-harness-runtime EmbeddedPi* aliases",
    ],
    diagnostics: ["plugin SDK compatibility registry"],
    tests: [
  ...
  },
  {
    ...
    replacement:
      "retain until supported published packages migrate to plugin-owned config schemas plus generic `aether/plugin-sdk/channel-config-schema` and `aether/plugin-sdk/setup-runtime` primitives",
    docsPath: "/plugins/sdk-migration#published-channel-setup-compatibility",
    surfaces: [
      "aether/plugin-sdk/bundled-channel-config-schema SlackConfigSchema",
      "aether/plugin-sdk/bundled-channel-config-schema DiscordConfigSchema",
      "aether/plugin-sdk/bundled-channel-config-schema SignalConfigSchema",
      "aether/plugin-sdk/bundled-channel-config-schema MSTeamsConfigSchema",
      "aether/plugin-sdk/setup-runtime createLegacyCompatChannelDmPolicy",
      "aether/plugin-sdk/setup-runtime promptLegacyChannelAllowFromForAccount",
    ],
    diagnostics: [
    ...
    releaseNote:
      "Published Aether channel packages through 2026.7.1 remain loadable while they migrate to plugin-owned config and setup helpers.",
  },
  {
