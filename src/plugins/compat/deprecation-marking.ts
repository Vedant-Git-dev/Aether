...
export const DEPRECATION_MARKING_COMPAT_RECORDS = [
  ...
  },
  {
    ...
    surfaces: [
      "aether/plugin-sdk/agent-runtime",
      "aether/plugin-sdk/agent-runtime loadModelCatalog params.useCache",
      "aether/plugin-sdk/agent-runtime loadModelCatalog params.cacheOnly",
      "aether/plugin-sdk/agent-runtime loadModelCatalog params.metadataSnapshot",
      "aether/plugin-sdk/agent-runtime loadModelCatalog",
      "aether/plugin-sdk/cli-runtime",
      "aether/plugin-sdk/conversation-runtime",
      "aether/plugin-sdk/hook-runtime",
      "aether/plugin-sdk/media-runtime",
      "aether/plugin-sdk/media-runtime buildAgentMediaPayload",
      "aether/plugin-sdk/plugin-runtime",
  ...
  },
  {
    ...
    docsPath: "/plugins/sdk-migration#compatibility-policy",
    surfaces: [
      "aether/plugin-sdk/provider-stream GOOGLE_THINKING_STREAM_HOOKS",
      "aether/plugin-sdk/provider-stream KILOCODE_THINKING_STREAM_HOOKS",
      "aether/plugin-sdk/provider-stream MOONSHOT_THINKING_STREAM_HOOKS",
      "aether/plugin-sdk/provider-stream MINIMAX_FAST_MODE_STREAM_HOOKS",
      "aether/plugin-sdk/provider-stream OPENAI_RESPONSES_STREAM_HOOKS",
      "aether/plugin-sdk/provider-stream OPENROUTER_THINKING_STREAM_HOOKS",
      "aether/plugin-sdk/provider-stream TOOL_STREAM_DEFAULT_ON_HOOKS",
      "aether/plugin-sdk/provider-stream-shared defaultToolStreamExtraParams",
      "aether/plugin-sdk/provider-stream-shared stripTrailingAnthropicAssistantPrefillWhenThinking",
      "aether/plugin-sdk/provider-stream-shared createAnthropicThinkingPrefillPayloadWrapper",
      "aether/plugin-sdk/provider-stream-shared OpenAICompatibleThinkingLevel",
      "aether/plugin-sdk/provider-stream-shared isOpenAICompatibleThinkingEnabled",
      "aether/plugin-sdk/provider-stream-shared DeepSeekV4ThinkingLevel",
      "aether/plugin-sdk/provider-stream-shared DeepSeekV4ReasoningEffort",
      "aether/plugin-sdk/provider-stream-shared createDeepSeekV4OpenAICompatibleThinkingWrapper",
      "aether/plugin-sdk/provider-stream-shared createThinkingOnlyFinalTextWrapper",
      "aether/plugin-sdk/provider-stream-shared createGoogleThinkingPayloadWrapper",
      "aether/plugin-sdk/provider-stream-shared createGoogleThinkingStreamWrapper",
      "aether/plugin-sdk/provider-model-shared isProxyReasoningUnsupportedModelHint",
      "aether/plugin-sdk/provider-model-shared OPENAI_COMPATIBLE_REPLAY_HOOKS",
      "aether/plugin-sdk/provider-model-shared ANTHROPIC_BY_MODEL_REPLAY_HOOKS",
      "aether/plugin-sdk/provider-model-shared NATIVE_ANTHROPIC_REPLAY_HOOKS",
      "aether/plugin-sdk/provider-model-shared PASSTHROUGH_GEMINI_REPLAY_HOOKS",
      "aether/plugin-sdk/provider-auth DEFAULT_COPILOT_API_BASE_URL",
      "aether/plugin-sdk/provider-auth deriveCopilotApiBaseUrlFromToken",
      "aether/plugin-sdk/provider-auth resolveCopilotApiToken",
      "aether/plugin-sdk/provider-auth-copilot-cache CachedCopilotToken",
      "aether/plugin-sdk/oauth-utils toFormUrlEncoded",
      "aether/plugin-sdk/oauth-utils generatePkceVerifierChallenge",
      "aether/plugin-sdk/provider-oauth-runtime OAuthProvider",
      "aether/plugin-sdk/provider-oauth-runtime OAuthProviderInfo",
    ],
    diagnostics: [
  ...
  },
  {
    ...
    surfaces: [
      ...
      "aether/plugin-sdk/reply-payload ReplyPayload.interactive",
      "reduceInteractiveReply",
      "@aether/discord buildDiscordInteractiveComponents",
      "@aether/slack buildSlackInteractiveBlocks",
      "@aether/telegram buildTelegramInteractiveButtons",
    ],
    diagnostics: [
  ...
  },
  {
    ...
    docsPath: "/plugins/sdk-migration#compatibility-policy",
    surfaces: [
      "aether/plugin-sdk/acp-runtime __testing",
      "aether/plugin-sdk/approval-reaction-runtime",
      "aether/plugin-sdk/channel-inbound BuildChannelTurnContextParams",
      "aether/plugin-sdk/channel-inbound BuiltChannelTurnContext",
      "aether/plugin-sdk/channel-inbound buildChannelTurnContext",
      "aether/plugin-sdk/channel-inbound finalizeChannelInboundContext",
      "aether/plugin-sdk/channel-inbound filterChannelTurnSupplementalContext",
      "aether/plugin-sdk/channel-send-result ChannelSendRawResult",
      "aether/plugin-sdk/command-auth",
      "aether/plugin-sdk/command-auth ResolveSenderCommandAuthorizationParams",
      "aether/plugin-sdk/command-auth resolveCommandAuthorizedFromAuthorizers",
      "aether/plugin-sdk/command-auth CommandAuthorizationRuntime",
      "aether/plugin-sdk/command-auth ResolveSenderCommandAuthorizationWithRuntimeParams",
      "aether/plugin-sdk/command-auth resolveDirectDmAuthorizationOutcome",
      "aether/plugin-sdk/command-auth resolveSenderCommandAuthorizationWithRuntime",
      "aether/plugin-sdk/command-auth resolveSenderCommandAuthorization",
      "aether/plugin-sdk/keyed-async-queue KeyedAsyncQueue.getTailMapForTesting",
      "aether/plugin-sdk/persistent-dedupe PersistentDedupeLegacyPathOptions.lockOptions",
      "aether/plugin-sdk/retry-runtime createTelegramRetryRunner",
      "aether/plugin-sdk/ssrf-policy SsrfPolicyOptions.allowPrivateNetwork",
      "aether/plugin-sdk/ssrf-policy ssrfPolicyFromAllowPrivateNetwork",
      "aether/plugin-sdk/tts-runtime TtsSynthesisStreamResult",
      "aether/plugin-sdk/tts-runtime TtsRuntimeFacade._test",
    ],
    diagnostics: [
  ...
  },
  {
    ...
    surfaces: [
      "@aether/google-meet __testing",
      "@aether/discord buildDiscordInteractiveComponents",
      "@aether/discord normalizeDiscordListenerTimeoutMs",
      "@aether/discord normalizeDiscordInboundWorkerTimeoutMs",
      "@aether/discord isAbortError",
      "@aether/discord runDiscordTaskWithTimeout",
      "@aether/slack buildSlackInteractiveBlocks",
    ],
    diagnostics: [
  ...
  },
  {
    ...
    docsPath: "/plugins/sdk-migration#compatibility-policy",
    surfaces: [
      "@aether/memory-host-sdk ensureMemoryIndexSchema.embeddingCacheTable",
      "@aether/memory-host-sdk ensureMemoryIndexSchema.ftsTable",
      "@aether/memory-host-sdk/runtime-core loadConfig",
      "@aether/memory-host-sdk/host/aether-runtime loadConfig",
    ],
    diagnostics: [
  ...
  },
  {
    ...
    docsPath: "/plugins/sdk-migration#compatibility-policy",
    surfaces: [
      "AetherPluginApi.registerSessionExtension",
      "AetherPluginApi.enqueueNextTurnInjection",
      "AetherPluginApi.registerControlUiDescriptor",
      "AetherPluginApi.registerRuntimeLifecycle",
      "AetherPluginApi.registerAgentEventSubscription",
      "AetherPluginApi.emitAgentEvent",
      "AetherPluginApi.setRunContext",
      "AetherPluginApi.getRunContext",
      "AetherPluginApi.clearRunContext",
      "AetherPluginApi.registerSessionSchedulerJob",
      "AetherPluginApi.registerSessionAction",
      "AetherPluginApi.sendSessionAttachment",
      "AetherPluginApi.scheduleSessionTurn",
      "AetherPluginApi.unscheduleSessionTurnsByTag",
