...
export const MEDIA_LEGACY_PROJECTION_COMPAT_RECORD = {
  ...
  replacement:
    "ordered `MsgContext.media` / `InboundMediaFacts[]`; typed hook `media` and `originalMedia`; `Attachment*` template variables; and `aether/plugin-sdk/media-local-roots`",
  docsPath: "/plugins/sdk-migration#media-legacy-projection",
  surfaces: [
    "MsgContext MediaPath/MediaUrl/MediaType and plural/staging fields",
    "aether/plugin-sdk/agent-media-payload",
