...
const PLUGIN_SDK_SUBPATH_SEEDS = [
  {
    ...
    status: "removed",
    owner: "channel",
    replacement: "`aether/plugin-sdk/channel-outbound`",
    releaseNote:
  ...
  },
  {
    ...
    replacement:
      "`api.pluginConfig`, `aether/plugin-sdk/config-mutation`, `aether/plugin-sdk/runtime-config-snapshot`, and `aether/plugin-sdk/config-contracts`; retain until supported external plugin migration is verified",
  },
  {
    ...
    replacement: "`aether/plugin-sdk/channel-inbound` and `aether/plugin-sdk/channel-outbound`",
  },
  {
    ...
    removeAfter: "2026-10-01",
    replacement:
      "`aether/plugin-sdk/channel-outbound`; retain until supported external plugin migration is verified",
  },
  {
    ...
    removeAfter: "2026-10-01",
    replacement:
      "focused subpaths including `aether/plugin-sdk/delivery-queue-runtime`, `aether/plugin-sdk/diagnostic-runtime`, `aether/plugin-sdk/error-runtime`, `aether/plugin-sdk/exec-approvals-runtime`, `aether/plugin-sdk/fetch-runtime`, and `aether/plugin-sdk/ssrf-runtime`; retain until supported external plugin migration is verified and system-event snapshot inspection and consumption have a modern public replacement",
  },
  {
    ...
    owner: "sdk",
    replacement:
      "`aether/plugin-sdk/logging-core`, `aether/plugin-sdk/text-chunking`, `aether/plugin-sdk/text-utility-runtime`, and `aether/plugin-sdk/string-coerce-runtime`",
    releaseNote:
  ...
  },
  {
    ...
    owner: "channel",
    replacement:
      "`aether/plugin-sdk/channel-secret-basic-runtime` and `aether/plugin-sdk/channel-secret-tts-runtime`",
    releaseNote:
  ...
  },
  {
    ...
    status: "removed",
    owner: "config",
    replacement: "`aether/plugin-sdk/channel-config-schema`",
    releaseNote:
  ...
  },
  {
    ...
    status: "removed",
    owner: "channel",
    replacement: "`aether/plugin-sdk/run-command`",
    releaseNote:
  ...
  },
  {
    ...
    removeAfter: "2026-10-01",
    replacement:
      "`aether/plugin-sdk/channel-outbound` and `aether/plugin-sdk/channel-inbound`; retain until supported external plugin migration is verified",
  },
  {
    ...
    status: "removed",
    owner: "channel",
    replacement: "`aether/plugin-sdk/channel-ingress-runtime`",
    releaseNote:
...
function buildPluginSdkSubpathRecord(seed: (typeof PLUGIN_SDK_SUBPATH_SEEDS)[number]) {
  ...
  if ("status" in seed && seed.status === "removed") {
    return {
      ...
      surfaces: [`aether/plugin-sdk/${seed.subpath}`],
...
const BUNDLED_ONLY_PUBLIC_PLUGIN_SDK_SUBPATH_SEEDS = [
  {
    ...
    replacement:
      "`api.registerMediaUnderstandingProvider(...)` with provider-owned request helpers and types from `aether/plugin-sdk/plugin-entry`; retain the public subpath through the 2026-09-30 window while official plugin consumers migrate",
  ...
  },
  {
    ...
    removeAfter: "2026-09-30",
    replacement:
      "host-prepared memory prompts via `aether/plugin-sdk/core` and memory capability registration through the injected plugin API; retain the facade through the 2026-09-30 window and until a focused public-artifact read seam exists",
...
function buildPublicSdkSubpathRecord({
  ...
  return {
    ...
    ...compat,
    surfaces: [`aether/plugin-sdk/${subpath}`],
