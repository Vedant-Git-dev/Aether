...
import { normalizeAetherVersionBase } from "../config/version.js";
...
function resolveReportedPluginVersion(
  ...
  return (
    normalizeAetherVersionBase(resolveCompatibilityHostVersion(env)) ??
    normalizeAetherVersionBase(plugin.version) ??
    plugin.version
  );
}
