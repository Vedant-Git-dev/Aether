...
export const resolveRuntimePluginRegistry =
  createPluginRuntimeRegistryResolver(loadAetherPlugins);
...
export function loadAetherPlugins(options: PluginLoadOptions = {}): PluginRegistry {
  return loadAetherPluginsCore(options, loaderBindings);
}
...
export function loadAetherPluginsWithInternalOverrides(
...
function loadRegistryWithInternalOverrides(
  ...
  return loadAetherPluginsCore(options, loaderBindings, { ...overrides, runtime }, resources);
}
