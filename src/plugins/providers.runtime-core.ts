...
export function createProviderRegistryResolver(dependencies: {
  loadAetherPlugins: (options: PluginLoadOptions) => PluginRegistry;
  ...
  const { loadAetherPlugins, resolveRuntimePluginRegistry, isPluginRegistryLoadInFlight } =
    dependencies;
