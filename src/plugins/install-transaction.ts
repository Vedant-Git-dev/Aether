...
const PLUGIN_INSTALL_TRANSACTION = Symbol.for("aether.pluginInstallTransaction");
const PLUGIN_INSTALL_TRANSACTION_REQUEST = Symbol.for("aether.pluginInstallTransactionRequest");
const PLUGIN_INSTALL_OWNER_MIGRATIONS = Symbol.for("aether.pluginInstallOwnerMigrations");
