...
import { setCurrentManifestModelIdNormalizationPolicies } from "@aether/model-catalog-core/provider-model-id-normalization";
...
export const currentPluginMetadataConfigIdentityCache = {
  ...
  has(config: AetherConfig): boolean {
