...
import { loadAetherPlugins } from "./loader-runtime-load.js";
...
export { loadAetherPluginCliRegistry } from "./loader-cli-registry.js";
export {
...
export function loadPluginRegistryHandle(options: PluginLoadOptions = {}) {
  return loadAetherPlugins({ ...options, activate: false });
}
...
export function loadAndActivateRootPluginRegistry(options: PluginLoadOptions = {}) {
  return loadAetherPlugins({ ...options, activate: true });
}
