...
export type WebSearchProviderPlugin = {
  ...
  getConfiguredCredentialValue?: (config?: AetherConfig) => unknown;
  setConfiguredCredentialValue?: (configTarget: AetherConfig, value: unknown) => void;
  getConfiguredCredentialFallback?: (
    config?: AetherConfig,
  ) => WebSearchProviderConfiguredCredentialFallback | undefined;
  applySelectionConfig?: (config: AetherConfig) => AetherConfig;
  runSetup?: (ctx: WebSearchProviderSetupContext) => AetherConfig | Promise<AetherConfig>;
