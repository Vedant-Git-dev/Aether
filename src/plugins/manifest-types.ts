import type { ModelPricingProvider } from "@aether/model-catalog-core/model-catalog-pricing";
import type { ModelCatalog } from "@aether/model-catalog-core/model-catalog-types";
...
export type PluginFormat = "aether" | "bundle";
...
export type PluginManifestDoctorContract = {
   ...
   * Removal plan: remove the module fallback in Aether 2027.1 after external plugins migrate.
   */
...
export type PluginManifestQaRunner = {
  /** Subcommand mounted beneath `aether qa`, for example `matrix`. */
  commandName: string;
