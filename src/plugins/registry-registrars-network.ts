...
import type {
  ...
  AetherPluginMcpServerConnectionResolver,
...
export function createNetworkRegistrars(state: PluginRegistryState) {
  ...
  const registerHttpRoute = (record: PluginRecord, params: AetherPluginHttpRouteParams) => {
  ...
  const registerMcpServerConnectionResolver = (
    record: PluginRecord,
    resolver: AetherPluginMcpServerConnectionResolver,
  ) => {
  ...
  const registerChannel = (
    record: PluginRecord,
    registration: AetherPluginChannelRegistration | ChannelPlugin,
    ...
    const normalized =
      typeof (registration as AetherPluginChannelRegistration).plugin === "object"
        ? (registration as AetherPluginChannelRegistration)
