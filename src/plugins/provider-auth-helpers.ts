...
const resolveAuthAgentDir = (agentDir?: string, config?: AetherConfig) =>
...
function resolveProviderDefaultEnvSecretRef(provider: string, config?: AetherConfig): SecretRef {
...
export function configReferencesAuthProfile(cfg: AetherConfig, profileId: string): boolean {
  return (
 ...
 */
export function removeAuthProfileConfig(cfg: AetherConfig, profileId: string): AetherConfig {
