/** Loads and normalizes Aether plugin manifests, including contracts and config schemas. */
...
export const PLUGIN_MANIFEST_FILENAME = "aether.plugin.json";
...
export function loadPluginManifest(
  ...
  if (isCoreReservedPluginId(id)) {
    return cacheResult({
      ok: false,
      error: `plugin manifest id "${id}" is reserved by Aether core`,
      manifestPath,
    });
  }
