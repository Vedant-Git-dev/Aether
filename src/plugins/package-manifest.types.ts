...
/** package.json Aether metadata used for plugin setup and catalog discovery. */
...
type AetherPackageSetupFeatures = {
...
type AetherPackageCompat = {
  pluginApi?: string;
  minGatewayVersion?: string;
};

export type AetherPackageBuild = {
  bundledDist?: boolean;
  aetherVersion?: string;
  pluginSdkVersion?: string;
};

export type AetherPackageManifest = {
  extensions?: string[];
  runtimeExtensions?: string[];
  setupEntry?: string;
  runtimeSetupEntry?: string;
  controlUi?: string;
  setupFeatures?: AetherPackageSetupFeatures;
  plugin?: {
    id?: string;
    label?: string;
  };
  channel?: PluginPackageChannel;
  compat?: AetherPackageCompat;
  install?: PluginPackageInstall;
  build?: AetherPackageBuild;
};
...
} & Partial<Record<ManifestKey, AetherPackageManifest>>;
