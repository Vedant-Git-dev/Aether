...
type CurrentPluginMetadataCacheState = {
  ...
  revision: symbol;
  configIdentities: WeakSet<AetherConfig>;
};
...
export type PluginCacheMetadata = {
  metadata: {
    ...
    staticCatalogStates: WeakMap<object, WeakMap<AetherConfig, BundledStaticCatalogState>>;
    modelSuppressionResolvers: WeakMap<
      PluginMetadataSnapshot,
      {
        unconfigured?: ManifestModelSuppressionResolver;
        byConfig: WeakMap<AetherConfig, ManifestModelSuppressionResolver>;
      }
    >;
  };
};
