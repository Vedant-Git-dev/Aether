...
export function normalizePluginsConfigForInstalledIndex(
  config: AetherConfig["plugins"] | undefined,
...
function resolveGatewayStartupDreamingEngineId(config: AetherConfig): string | undefined {
...
function resolveGatewayStartupDreamingSelectedPluginId(config: AetherConfig): string | undefined {
...
export function collectConfiguredProviderIds(config: AetherConfig): string[] {
...
export function collectValidationConfiguredRefs(config: AetherConfig) {
