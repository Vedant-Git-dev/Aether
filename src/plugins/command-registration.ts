...
import {
  ...
  type AetherPluginCommandDefinition,
} from "./types.js";
...
/** Returns true when a command name is owned by built-in Aether command handling. */
...
function listPluginInvocationKeys(command: AetherPluginCommandDefinition): string[] {
