const PLUGIN_CANDIDATE_INSTALL_OWNER = Symbol.for("aether.pluginCandidateInstallOwner");
const PLUGIN_INSTALL_OWNER_LOOKUP = Symbol.for("aether.pluginInstallOwnerLookup");
