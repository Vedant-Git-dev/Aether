...
import { normalizeOptionalString as normalizeTrimmedString } from "@aether/normalization-core/string-coerce";
...
const PLUGIN_MANIFEST_FILENAME = "aether.plugin.json";
...
function resolvePackageRootsForSourceManifestMetadata(): string[] {
  ...
  for (const params of [
    ...
    const root = resolveAetherPackageRootSync(params);
...
export function listAetherPluginManifestMetadata(
