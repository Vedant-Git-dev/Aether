...
export type PluginCliCommandGroupEntry = {
  ...
  placeholders: readonly AetherPluginCliRootCommandDescriptor[];
  names: readonly string[];
  register: (program: AetherPluginCliContext["program"]) => Promise<void>;
};
...
): Promise<AetherPluginCliRootCommandDescriptor[]> {
  try {
