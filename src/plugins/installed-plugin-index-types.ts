...
import type { AetherPackageBuild, PluginPackageChannel } from "./package-manifest.types.js";
...
export const INSTALLED_PLUGIN_INDEX_WARNING =
  "DO NOT EDIT. This file is generated by Aether from plugin manifests, install records, and config policy. Use `aether plugins registry --refresh`, `aether plugins install/update/uninstall`, or `aether plugins enable/disable` instead.";
...
export type InstalledPluginIndexRecord = {
  ...
  /**
   * Package-authored aether.install metadata. This describes catalog/package
