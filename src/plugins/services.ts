...
import type { AetherPluginServiceContext, PluginLogger } from "./types.js";
...
function createServiceContext(params: {
  ...
  serviceHealth: NonNullable<AetherPluginServiceContext["serviceHealth"]>;
  gatewayEvents?: AetherPluginServiceContext["gatewayEvents"];
  getCron?: AetherPluginServiceContext["getCron"];
...
export type PluginServicesHandle = {
  reload: (config: AetherConfig, serviceIds: ReadonlySet<string>) => Promise<void>;
