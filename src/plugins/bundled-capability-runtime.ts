...
import { discoverAetherPlugins, type PluginDiscoveryResult } from "./discovery.js";
import {
  acquirePluginRegistryWithInternalOverrides,
  loadAetherPluginsWithInternalOverrides,
...
export function loadBundledCapabilityRuntimeRegistry(params: BundledCapabilityRuntimeParams) {
  ...
  return loadAetherPluginsWithInternalOverrides(options, overrides);
}
...
function prepareBundledCapabilityRuntime(params: BundledCapabilityRuntimeParams): {
  ...
  overrides: Parameters<typeof loadAetherPluginsWithInternalOverrides>[1];
} {
