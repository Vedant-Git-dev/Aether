...
function resolveConfiguredDefaultModelPrimary(cfg: AetherConfig): string | undefined {
...
async function applyDefaultModelFromAuthChoice(params: {
  ...
  workspaceDir?: string;
  beforePersistentEffect?: () => void | Promise<void>;
  runSelectedModelHook: (config: AetherConfig) => Promise<void>;
...
export async function runProviderPluginAuthMethod(params: {
  ...
  opts?: Partial<ProviderAuthOptionBag>;
}): Promise<{ config: AetherConfig; defaultModel?: string }> {
