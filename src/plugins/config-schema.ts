...
import type { AetherPluginConfigSchema } from "./types.js";
...
type BuildPluginConfigSchemaOptions = {
  /** @deprecated Declare top-level `uiHints` in `aether.plugin.json`. */
  uiHints?: Record<string, PluginConfigUiHint>;
  safeParse?: AetherPluginConfigSchema["safeParse"];
};
...
export function emptyPluginConfigSchema(): AetherPluginConfigSchema {
  return {
