...
import { normalizeOptionalString as normalizeStringField } from "@aether/normalization-core/string-coerce";
import { normalizeSortedUniqueStringEntries } from "@aether/normalization-core/string-normalization";
...
export function buildInstalledPluginIndexRecords(params: {
  ...
  return params.registry.plugins.map((record): InstalledPluginIndexRecord => {
    ...
    if (record.format && record.format !== "aether") {
