...
export const SQLITE_READONLY_CHILD_ARG = "--aether-sqlite-readonly-child";
...
export const runtimeProcessEntrypoints = {
  ...
  databaseVerify: {
    currentModuleUrl,
    sourceWorkerName: "../state/aether-database-verify.worker",
    distWorkerPath: "state/aether-database-verify.worker.js",
  },
  stateLeaseHeartbeat: {
    currentModuleUrl,
    sourceWorkerName: "../state/aether-state-lease-heartbeat.worker",
    distWorkerPath: "state/aether-state-lease-heartbeat.worker.js",
  },
