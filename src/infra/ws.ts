import { rawDataToString as gatewayRawDataToString } from "@aether/gateway-client/websocket-data";
import type WebSocket from "ws";

// Keep the declaration owner stable for the shipped webhook-ingress SDK export;
// WebSocket conversion itself is canonical in @aether/gateway-client.
