...
const LAUNCHER_ENCODING_MARKER_PREFIX = "@rem aether-launcher-encoding=";
const LAUNCHER_ENCODING_MARKER_RE = /^@rem aether-launcher-encoding=(\S+)\s*$/;
...
/** Decodes launcher scripts written by any Aether version (UTF-16 LE BOM, marked code page, or UTF-8). */
