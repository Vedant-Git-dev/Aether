...
type DeliveryQueueTable = AetherStateKyselyDatabase["delivery_queue_entries"];
...
export type DeliveryQueueDatabase = Pick<AetherStateKyselyDatabase, "delivery_queue_entries">;
