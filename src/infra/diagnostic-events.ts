...
const DIAGNOSTIC_EVENTS_STATE_KEY = Symbol.for("aether.diagnosticEvents.state.v1");
...
export function isDiagnosticsEnabled(config?: AetherConfig): boolean {
...
/** Emits an untrusted event whose trace context came from Aether-owned scope. */
