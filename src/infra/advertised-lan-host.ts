// Resolves the LAN host Aether should advertise to nearby devices.
import { isRfc1918Ipv4Address } from "@aether/net-policy/ip";
import { normalizeLowercaseStringOrEmpty as normalizeInterfaceName } from "@aether/normalization-core/string-coerce";
