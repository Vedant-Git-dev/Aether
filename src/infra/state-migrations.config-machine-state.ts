// Imports machine-owned aether.json values into the shared SQLite state store.
...
export function migrateLegacyConfigMachineState(params: {
  ...
  if (plugins && Object.hasOwn(plugins, "bundledDiscovery")) {
    ...
    (typeof meta?.lastTouchedVersion !== "string" ||
      compareAetherVersions(meta.lastTouchedVersion, BUNDLED_DISCOVERY_STATE_CUTOVER_VERSION) ===
        -1)
  ) {
