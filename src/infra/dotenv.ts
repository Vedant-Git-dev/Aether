...
const BLOCKED_WORKSPACE_DOTENV_KEYS = new Set([
  ...
  "OPENAI_API_KEYS",
  "AETHER_AGENT_DIR",
  "AETHER_ALLOW_PLUGIN_INSTALL_OVERRIDES",
  "AETHER_ALLOW_INSECURE_PRIVATE_WS",
  "AETHER_ALLOW_PROJECT_LOCAL_BIN",
  "AETHER_BROWSER_EXECUTABLE_PATH",
  "AETHER_BROWSER_CONTROL_MODULE",
  "AETHER_BUNDLED_HOOKS_DIR",
  "AETHER_BUNDLED_PLUGINS_DIR",
  "AETHER_BUNDLED_SKILLS_DIR",
  "AETHER_CACHE_TRACE",
  "AETHER_CACHE_TRACE_FILE",
  "AETHER_CACHE_TRACE_MESSAGES",
  "AETHER_CACHE_TRACE_PROMPT",
  "AETHER_CACHE_TRACE_SYSTEM",
  "AETHER_CONFIG_PATH",
  "AETHER_GATEWAY_PASSWORD",
  "AETHER_GATEWAY_PORT",
  "AETHER_GATEWAY_SECRET",
  ...
  "AETHER_MPM_CATALOG_PATHS",
  "AETHER_NODE_EXEC_FALLBACK",
  "AETHER_NODE_EXEC_HOST",
  "AETHER_OAUTH_DIR",
  "AETHER_PINNED_PYTHON",
  "AETHER_PINNED_WRITE_PYTHON",
  "AETHER_PLUGIN_INSTALL_OVERRIDES",
  "AETHER_PLUGIN_CATALOG_PATHS",
  "AETHER_PROFILE",
  "AETHER_RAW_STREAM",
  "AETHER_RAW_STREAM_PATH",
  "AETHER_SHOW_SECRETS",
  "AETHER_SKIP_BROWSER_CONTROL_SERVER",
  "AETHER_STATE_DIR",
  "AETHER_TEST_TAILSCALE_BINARY",
  "PATH",
  "PI_CODING_AGENT_DIR",
...
const BLOCKED_WORKSPACE_DOTENV_PREFIXES = [
  ...
  "AWS_ENDPOINT_URL_",
  "OPENAI_API_KEY_",
  // Workspace .env is untrusted; reserve the full Aether runtime namespace
  // for shell/global config so new AETHER_* controls are fail-closed by default.
  "AETHER_",
  "AETHER_DISABLE_",
  "AETHER_SKIP_",
  "AETHER_UPDATE_",
...
export function loadDotEnv(opts?: { quiet?: boolean }) {
  ...
  // Then load global fallback: ~/.aether/.env (or AETHER_STATE_DIR/.env),
