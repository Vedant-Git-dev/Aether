// Resolves Aether home and platform-specific config directories.
...
function resolveRawHomeDir(env: NodeJS.ProcessEnv, homedir: () => string): string | undefined {
  const explicitHome = normalize(env.AETHER_HOME);
  if (!explicitHome) {
...
/** Resolves Aether's effective home, honoring AETHER_HOME before OS homes. */
...
/** Resolves the underlying OS user home, ignoring AETHER_HOME overrides. */
...
export function resolveRequiredHomeDir(
  ...
  throw new Error(
    "Unable to resolve an Aether home: set AETHER_HOME, HOME, or USERPROFILE, or run from an existing directory.",
  );
}
...
/** Resolves a user-supplied path against the OS home, ignoring AETHER_HOME. */
