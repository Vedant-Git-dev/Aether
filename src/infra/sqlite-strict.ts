// Migrates Aether-owned SQLite tables to canonical STRICT schemas.
...
const STRICT_MIGRATION_TABLE_PREFIX = "__aether_strict_migration_";
...
/** Atomically upgrade Aether-owned tables described by a canonical STRICT schema. */
