...
export const CONTROL_PLANE_UPDATE_SENTINEL_META_ENV = "AETHER_CONTROL_PLANE_UPDATE_SENTINEL_META";
// Internal helper/orchestrator correlation; never persisted as an operator setting.
export const UPDATE_RUN_ID_ENV = "AETHER_UPDATE_RUN_ID";
...
export function resolveManagedServiceUpdateFailureExitCode(result: UpdateRunResult): number {
  return process.env.AETHER_UPDATE_RUN_HANDOFF === "1" &&
