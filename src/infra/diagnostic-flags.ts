...
import { normalizeUniqueStringEntriesLower } from "@aether/normalization-core/string-normalization";
import type { AetherConfig } from "../config/types.aether.js";

const DIAGNOSTICS_ENV = "AETHER_DIAGNOSTICS";
...
/** Resolves enabled diagnostic flags from config plus `AETHER_DIAGNOSTICS` overrides. */
