// Resolves Aether-managed proxy TLS trust for non-Undici transports.
...
const MANAGED_PROXY_ENV_PREFIX = ["AETHER", "PROXY"].join("_");
...
/** Resolves managed proxy TLS trust only when the target proxy is Aether's active proxy. */
