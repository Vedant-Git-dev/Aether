...
// adding Aether NO_PROXY CIDR/wildcard bypass checks.
 ...
 * - Aether extension: IPv4 CIDR and octet-wildcard entries
 ...
 * in provider HTTP helpers; see aether#64974 review thread on NO_PROXY
 * SSRF bypass.
 */
