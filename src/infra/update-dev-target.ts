import { safeParseJson, stableStringify } from "@aether/normalization-core";
import { isRecord } from "@aether/normalization-core/record-coerce";

export const UPDATE_DEV_TARGET_REF_ENV = "AETHER_UPDATE_DEV_TARGET_REF";
const TRACKED_DEV_TARGET_PREFIX = "aether-dev-target:v1:";
