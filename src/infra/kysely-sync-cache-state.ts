...
export const { kyselyByDatabase, queryErrorHandlerByDatabase } = resolveGlobalSingleton(
  Symbol.for("aether.sqliteKyselyCacheState"),
  () => ({
...
const statementCacheSymbol = Symbol.for("aether.kyselySyncStatementCache");
const statementInvalidationSymbol = Symbol.for("aether.kyselySyncStatementInvalidation");
const statementCacheEnabledSymbol = Symbol.for("aether.kyselySyncStatementCacheEnabled");
const authorizerActiveSymbol = Symbol.for("aether.kyselySyncAuthorizerActive");
