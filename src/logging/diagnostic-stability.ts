...
function getDiagnosticStabilityState(): DiagnosticStabilityState {
  const globalStore = globalThis as typeof globalThis & {
    __aetherDiagnosticStabilityState?: DiagnosticStabilityState;
  };
  globalStore["__aetherDiagnosticStabilityState"] ??= createState();
  return globalStore["__aetherDiagnosticStabilityState"];
}
...
export function resetDiagnosticStabilityRecorderForTest(): void {
  ...
  globalStore["__aetherDiagnosticStabilityState"] = next;
}
