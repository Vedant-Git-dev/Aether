...
import { clampTimerTimeoutMs } from "@aether/normalization-core/number-coercion";
...
type CapabilityProviderCandidate = {
  ...
  isConfigured?: (ctx: { cfg?: AetherConfig; agentDir?: string }) => boolean;
};
...
function resolveCurrentDefaultProviderId(cfg?: AetherConfig): string {
...
function resolveAutoCapabilityFallbackRefs(params: {
  cfg: AetherConfig;
  agentDir?: string;
  listProviders: (cfg?: AetherConfig) => CapabilityProviderCandidate[];
}): string[] {
