// Installs Aether-owned transport and diagnostic policy before package helpers;
// direct imports need the same wiring as the process-default stream facade.
import { configureAiTransportHost } from "@aether/ai";
import { configureProviderErrorRedactor } from "@aether/ai/diagnostics";
