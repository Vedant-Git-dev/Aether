...
import type { ClawAetherProfile } from "./types.js";

type ClawToolSettings = NonNullable<ClawAetherProfile["agent"]["tools"]>;
...
export function materializeClawToolProfile(
  settings: ClawAetherProfile["agent"],
  options: { allowLegacyDynamicProfile?: boolean } = {},
): ClawAetherProfile["agent"] {
