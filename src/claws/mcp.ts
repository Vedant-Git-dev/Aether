...
export const CLAW_MCP_REF_SCHEMA_VERSION = "aether.clawMcpServerRef.v1" as const;
...
export function planClawMcpServerRemoval(
  ref: PersistedClawMcpServerRef,
  options: AetherStateDatabaseOptions & { referencedCleanup?: ClawReferencedCleanup } = {},
