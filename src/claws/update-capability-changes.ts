...
function resolveHeartbeat(config: AetherConfig, agentId: string): unknown {
...
function resolvePortableTools(config: AetherConfig, agentId: string): unknown {
...
function resolvePortableMemorySearch(config: AetherConfig, agentId: string): unknown {
