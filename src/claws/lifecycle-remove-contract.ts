...
export const CLAW_REMOVE_PLAN_SCHEMA_VERSION = "aether.clawRemovePlan.v1" as const;
...
export type ClawRemovePlanOptions = AetherStateDatabaseOptions & {
  config?: AetherConfig;
...
export const CLAW_REMOVE_RESULT_SCHEMA_VERSION = "aether.clawRemoveResult.v1" as const;
