...
import type { ClawAddPlan, ClawAddPlanAction, Aetheriagnostic } from "./types.js";

export const CLAW_WORKSPACE_FILE_RECORD_SCHEMA_VERSION =
  "aether.clawWorkspaceFileRecord.v1" as const;
...
export class ClawWorkspaceWriteError extends Error {
  constructor(
    readonly diagnostics: Aetheriagnostic[],
...
function diagnostic(action: ClawAddPlanAction, code: string, message: string): Aetheriagnostic {
  return {
    level: "error",
    code,
    phase: "mutation",
