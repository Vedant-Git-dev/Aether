...
export const DEFAULT_FLEET_IMAGE = "ghcr.io/aether/aether:latest";
const FLEET_BASE_PORT = 19_100;
export const FLEET_GATEWAY_PORT = 18_789;
const FLEET_CONTAINER_HOME = "/home/node";
const FLEET_CONTAINER_STATE_DIR = "/home/node/.aether";
const FLEET_CONTAINER_AUTH_SECRET_DIR = "/home/node/.config/aether";
export const FLEET_TENANT_LABEL = "aether.fleet.tenant";
export const FLEET_OWNER_LABEL = "aether.fleet.owner";
export const FLEET_ATTEMPT_LABEL = "aether.fleet.attempt";
export const FLEET_ENV_KEYS_LABEL = "aether.fleet.env-keys";
export const FLEET_DISK_LIMIT_LABEL = "aether.fleet.disk-limit";
...
export function buildCellEnvironment(
  ...
  return {
    ...
    AETHER_HOME: FLEET_CONTAINER_HOME,
    AETHER_STATE_DIR: FLEET_CONTAINER_STATE_DIR,
    AETHER_CONFIG_PATH: `${FLEET_CONTAINER_STATE_DIR}/aether.json`,
    AETHER_WORKSPACE_DIR: `${FLEET_CONTAINER_STATE_DIR}/workspace`,
    AETHER_GATEWAY_TOKEN: token,
...
export function cellContainerName(tenantId: string): string {
  return `aether-cell-${validateTenantId(tenantId)}`;
}
