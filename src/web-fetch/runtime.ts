...
const webFetchProviderCache = new WeakMap<AetherConfig, WebFetchProviderCacheEntry>();

function resolveFetchConfig(config: AetherConfig | undefined): WebFetchConfig | undefined {
