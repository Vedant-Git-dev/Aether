...
import type { AetherPluginNodeHostCommandIo } from "../plugins/types.js";
import type { AetherPluginNodeHostCommandContext } from "../plugins/types.node-host.js";
...
function ensureNodePathEnv(): string {
  ensureAetherCliOnPath({ pathEnv: process.env.PATH ?? "" });
...
export async function prepareNodeHostRuntime(params?: {
  ...
  return {
    ...
    start({
      ...
      const pluginCommandContext: AetherPluginNodeHostCommandContext = {
      ...
      return {
        async invoke(frame) {
          ...
          const pluginCommandIo: AetherPluginNodeHostCommandIo | undefined =
