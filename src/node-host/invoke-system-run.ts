...
type ExecToolConfig = NonNullable<NonNullable<AetherConfig["tools"]>["exec"]>;
...
async function loadSystemRunConfig(opts: HandleSystemRunInvokeOptions): Promise<AetherConfig> {
