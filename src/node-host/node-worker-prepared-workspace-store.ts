...
import { ensureNodeWorkerPreparedWorkspaceSchema } from "../state/aether-state-db-schema-additive.js";
...
export class NodeWorkerPreparedWorkspaceStore {
  constructor(private readonly options: AetherStateDatabaseOptions) {}
