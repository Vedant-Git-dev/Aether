...
function widgetPresentationFailureText(
  ...
  const nextStep =
    error.code === "no_eligible_node"
      ? "Pair a canvas-capable device or open the Aether app, then retry."
...
/** Creates a self-contained widget hosted by Aether core. */
