...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof AetherConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: AetherConfig; env: NodeJS.ProcessEnv }): {
  cfg: AetherConfig;
  changes: string[];
} {
