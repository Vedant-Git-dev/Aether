...
export function stubAuditChannelPlugin(params: {
  ...
  resolveAccount: (cfg: AetherConfig, accountId: string | null | undefined) => unknown;
  inspectAccount?: (cfg: AetherConfig, accountId: string | null | undefined) => unknown;
  isConfigured?: (account: unknown, cfg: AetherConfig) => boolean;
}): ChannelPlugin {
  return {
    id: params.id,
    meta: {
