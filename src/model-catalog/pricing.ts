...
import type { RemoteModelCatalogPricing } from "@aether/model-catalog-core";
import { MODEL_PRICING_SOURCES } from "@aether/model-catalog-core/model-catalog-pricing";
import { buildModelCatalogRef } from "@aether/model-catalog-core/model-catalog-refs";
import type { ModelCatalogCost } from "@aether/model-catalog-core/model-catalog-types";
import {
...
const EMPTY_CONFIG: AetherConfig = {};
const pricingContextByConfig = new WeakMap<AetherConfig, PricingContext>();
...
function buildPricingContext(config: AetherConfig): PricingContext {
...
export function resolveModelPricingContext(config: AetherConfig = EMPTY_CONFIG): PricingContext {
