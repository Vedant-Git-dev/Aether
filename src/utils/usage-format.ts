...
import { normalizeBuiltInProviderModelId } from "@aether/model-catalog-core/provider-model-id-normalization";
...
export type { ModelCostConfig } from "@aether/llm-core";
...
function resolveCostAgentDir(config?: AetherConfig, agentDir?: string): string | undefined {
  if (agentDir) {
    return agentDir;
  }
