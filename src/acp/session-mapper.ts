/** Resolves ACP request metadata into Aether Gateway session keys and reset behavior. */
import { readBool, readMetadataString } from "@aether/acp-core/meta";
...
/** Parses ACP request metadata into Aether session routing hints. */
