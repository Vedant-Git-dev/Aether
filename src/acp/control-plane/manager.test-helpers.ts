...
import type { AcpRuntime, AcpRuntimeCapabilities } from "@aether/acp-core/runtime/types";
...
export type { AcpRuntime, AetherConfig, SessionAcpMeta };
...
const ORIGINAL_STATE_DIR = process.env.AETHER_STATE_DIR;
...
export function installAcpSessionManagerTestLifecycle(): void {
  ...
  afterEach(() => {
    if (ORIGINAL_STATE_DIR === undefined) {
      deleteTestEnvValue("AETHER_STATE_DIR");
    } else {
      setTestEnvValue("AETHER_STATE_DIR", ORIGINAL_STATE_DIR);
    }
