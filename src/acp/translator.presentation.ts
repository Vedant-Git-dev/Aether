...
} from "@aether/acp-core/session-lineage-meta";
import { timestampMsToIsoString } from "@aether/normalization-core/number-coercion";
import {
  normalizeFastMode,
...
export function buildSessionPresentation(params: {
  ...
  const configOptions: SessionConfigOption[] = [
    buildSelectConfigOption({
      ...
      description:
        "Controls how much deliberate reasoning Aether requests from the Gateway model.",
    ...
    buildSelectConfigOption({
      ...
      name: "Tool verbosity",
      description:
        "Controls how much tool progress and output detail Aether keeps enabled for the session.",
    ...
    buildSelectConfigOption({
      ...
      name: "Usage detail",
      description:
        "Controls how much usage information Aether attaches to responses for the session. 'inherit' follows the configured default; 'off' explicitly disables it for this session.",
