...
export function buildRealtimeVoiceSpeakExactMessage(params: {
  ...
  return [
    "Internal Aether voice playback result.",
    "Do not call aether_agent_consult or any other tool for this message.",
    `Speak this exact Aether answer to ${params.surfaceLabel}, without adding, removing, or rephrasing words.`,
...
export function classifyRealtimeVoiceConsultToolCall(
  ...
  if (message.includes("Speak this exact Aether answer")) {
