...
const mutationDigestDeliveryOwner = new ClientVoiceMutationDigestOwner<AetherConfig>({
...
if (process.env.VITEST || process.env.NODE_ENV === "test") {
  (globalThis as Record<PropertyKey, unknown>)[Symbol.for("aether.clientVoiceSessionTestApi")] =
