...
import { normalizeStructuredPromptSection } from "@aether/ai/internal/shared";
...
/**
 * Delegate a context-engine compaction request to Aether's built-in runtime compaction path.
 *
