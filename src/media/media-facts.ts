import type { MediaKind } from "@aether/media-core/constants";
import {
  getFileExtension,
  kindFromMime,
...
const RUNTIME_PROMPT_MEDIA_FACTS = Symbol.for("aether.runtimePromptMediaFacts");
...
function readPersistedMediaFactInputs(message: object): Array<MediaFactInput | null> | undefined {
  const metadata = asNonArrayRecord(asNonArrayRecord(message)["__aether"]);
