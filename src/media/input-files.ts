...
} from "@aether/media-core/attachment-classify";
import { canonicalizeBase64, estimateBase64DecodedBytes } from "@aether/media-core/base64";
import { parseMediaContentLength } from "@aether/media-core/content-length";
import { detectMime, normalizeMimeType } from "@aether/media-core/mime";
...
async function fetchWithGuard(
  ...
  const { response, release } = await fetchWithSsrFGuard({
    ...
    init: { headers: { "User-Agent": "Aether-Gateway/1.0" } },
  });
