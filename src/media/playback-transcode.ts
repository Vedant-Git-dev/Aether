...
import { extensionForMime, normalizeMimeType } from "@aether/media-core/mime";
...
if (process.env.VITEST || process.env.NODE_ENV === "test") {
  (globalThis as Record<PropertyKey, unknown>)[Symbol.for("aether.playbackTranscodeTestApi")] = {
