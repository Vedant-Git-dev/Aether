...
} from "@aether/net-policy/redact-sensitive-url";
...
const SECTION_DOCS_URLS = {
  accessGroups: "https://docs.aether.ai/channels/access-groups",
  messages: "https://docs.aether.ai/concepts/messages",
  tts: "https://docs.aether.ai/tools/tts",
  commands: "https://docs.aether.ai/tools/slash-commands",
  hooks: "https://docs.aether.ai/automation/hooks",
  cron: "https://docs.aether.ai/automation/cron-jobs",
  bindings: "https://docs.aether.ai/concepts/agent-bindings",
  plugins: "https://docs.aether.ai/plugins/manage-plugins",
  mcp: "https://docs.aether.ai/tools/mcp",
  memory: "https://docs.aether.ai/concepts/memory",
  talk: "https://docs.aether.ai/nodes/talk",
  gateway: "https://docs.aether.ai/gateway/configuration",
  browser: "https://docs.aether.ai/tools/browser",
  nodeHost: "https://docs.aether.ai/nodes",
  discovery: "https://docs.aether.ai/gateway/discovery",
  acp: "https://docs.aether.ai/tools/acp-agents",
  agents: "https://docs.aether.ai/concepts/agent",
  models: "https://docs.aether.ai/concepts/models",
  skills: "https://docs.aether.ai/tools/skills",
  tools: "https://docs.aether.ai/tools",
  session: "https://docs.aether.ai/concepts/session",
  security: "https://docs.aether.ai/gateway/security",
  approvals: "https://docs.aether.ai/tools/exec-approvals",
  env: "https://docs.aether.ai/help/environment",
  auth: "https://docs.aether.ai/concepts/oauth",
  update: "https://docs.aether.ai/install/updating",
  telemetry: "https://docs.aether.ai/gateway/telemetry",
  logging: "https://docs.aether.ai/logging",
  diagnostics: "https://docs.aether.ai/gateway/diagnostics",
  cli: "https://docs.aether.ai/cli",
  secrets: "https://docs.aether.ai/gateway/secrets",
  ui: "https://docs.aether.ai/web/control-ui",
  wizard: "https://docs.aether.ai/start/wizard",
  channels: "https://docs.aether.ai/channels",
  broadcast: "https://docs.aether.ai/channels/broadcast-groups",
  audio: "https://docs.aether.ai/nodes/audio",
  voicewake: "https://docs.aether.ai/nodes/voicewake",
  presence: "https://docs.aether.ai/concepts/presence",
  cloudWorkers: "https://docs.aether.ai/gateway/cloud-workers",
  desktop: "https://docs.aether.ai/gateway/configuration",
  worktreeRoot: "https://docs.aether.ai/concepts/managed-worktrees",
  proxy: "https://docs.aether.ai/security/network-proxy",
  transcripts: "https://docs.aether.ai/plugins/meeting-plugins",
  surfaces: "https://docs.aether.ai/concepts/messages",
...
const FIELD_PLACEHOLDERS: Record<string, string> = {
  ...
  "gateway.controlUi.basePath": "/aether",
  "gateway.controlUi.environment.label": "edge",
  "gateway.controlUi.root": "dist/control-ui",
  "gateway.controlUi.allowedOrigins": "https://control.example.com",
  "channels.mattermost.baseUrl": "https://chat.example.com",
  "agents.entries.*.identity.avatar": "avatars/aether.png",
};
