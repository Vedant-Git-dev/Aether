...
function applyOverrideTree(cfg: AetherConfig, overrideTree: OverrideTree): AetherConfig {
  const next = mergeOverrides(cfg, overrideTree) as AetherConfig;
...
export function applyConfigOverrides(cfg: AetherConfig): AetherConfig {
...
export function captureConfigOverrideApplier(): (cfg: AetherConfig) => AetherConfig {
