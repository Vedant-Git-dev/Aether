...
export type CodeModeConfig =
  ...
  | "auto"
  | {
      /** Aether Code Mode default, overridden by per-model codeMode. Default: false; "auto" engages catalog-preferred models. */
...
export type ToolsConfig = {
  ...
  /** Runtime loop detection for repetitive/ stuck tool-call patterns. */
  loopDetection?: ToolLoopDetectionConfig;
  /** Compact large Aether, MCP, and client tool catalogs behind search/call tools. */
