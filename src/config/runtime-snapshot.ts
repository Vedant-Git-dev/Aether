...
let runtimeConfigSnapshot: AetherConfig | null = null;
let runtimeConfigSourceSnapshot: AetherConfig | null = null;
...
function configSnapshotsMatch(left: AetherConfig, right: AetherConfig): boolean {
  if (left === right) {
    return true;
  }
...
export function hashRuntimeConfigValue(value: AetherConfig): string {
...
export function registerRuntimeConfigSnapshotPreparer(
  prepare: (config: AetherConfig) => void,
): () => void {
...
export function getRuntimeConfigSnapshot(): AetherConfig | null {
  return runtimeConfigSnapshot;
}

export function getRuntimeConfigSourceSnapshot(): AetherConfig | null {
...
export function resolveRuntimeConfigCacheKey(config: AetherConfig): string {
...
export function selectApplicableRuntimeConfig(params: {
  inputConfig?: AetherConfig;
  runtimeConfig?: AetherConfig | null;
  runtimeSourceConfig?: AetherConfig | null;
...
export function createRuntimeConfigReader(inputConfig: AetherConfig): () => AetherConfig {
...
export function loadPinnedRuntimeConfig(loadFresh: () => AetherConfig): AetherConfig {
  if (runtimeConfigSnapshot) {
    return runtimeConfigSnapshot;
  }
