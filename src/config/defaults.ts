...
} from "@aether/model-catalog-core/provider-model-id-normalization";
import { asPositiveFiniteNumber } from "@aether/normalization-core/number-coercion";
...
export function applyMessageDefaults(cfg: AetherConfig): AetherConfig {
...
export function applyAgentDefaults(cfg: AetherConfig): AetherConfig {
...
function hasAnthropicDefaultSignal(cfg: AetherConfig, env: NodeJS.ProcessEnv): boolean {
...
export function applyCompactionDefaults(cfg: AetherConfig): AetherConfig {
