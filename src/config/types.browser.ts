...
export type BrowserProfileConfig = {
  ...
  mcpArgs?: string[];
  /**
   * Profile driver (default: aether). "extension" attaches to the user's
   * signed-in browser through the Aether Chrome extension relay.
   */
  driver?: "aether" | "aether" | "existing-session" | "extension";
...
export type BrowserConfig = {
  ...
  attachOnly?: boolean;
  /** Default profile to use when profile param is omitted. Default: "aether" */
