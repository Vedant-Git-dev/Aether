...
import { asFiniteNumberInRange } from "@aether/normalization-core/number-coercion";
...
export function normalizeTalkConfig(config: AetherConfig): AetherConfig {
  if (!config.talk) {
    return config;
  }
