 ...
 * directory can point at an external AETHER_INCLUDE_ROOTS file that reads
...
type ResolveConfigIncludesOptions = {
   ...
   * may resolve into. Typically populated from `AETHER_INCLUDE_ROOTS`.
...
class IncludeProcessor {
  ...
  private resolvePath(includePath: string): { resolvedPath: string; root: IncludeRoot } {
    ...
    // AETHER_INCLUDE_ROOTS and let operators opt into shared include trees
