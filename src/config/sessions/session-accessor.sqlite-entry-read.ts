...
type AetherAgentDatabaseReader = Pick<AetherAgentDatabase, "agentId" | "db">;
type SessionEntryRow = Selectable<AetherAgentKyselyDatabase["session_nodes"]>;
...
export function readSessionEntryRow(
  database: AetherAgentDatabaseReader,
  sessionKey: string,
