...
export function resolveMainSessionKey(cfg: AetherConfig): string {
...
export function resolveSystemMainSessionTarget(cfg: AetherConfig): {
  agentId: string;
  sessionKey: string;
} {
...
export function resolveSystemMainSessionKey(cfg: AetherConfig): string {
...
export function resolveSessionRoutingContract(cfg: AetherConfig): string {
