...
import type { SessionPendingInputs } from "../../state/aether-agent-db.generated.js";
...
type PendingInputDatabase = Pick<AetherAgentDatabase, "db" | "path">;
...
const owners = resolveGlobalSingleton(Symbol.for("aether.sessionPendingInputOwners"), () => ({
...
const recoveredDedupeOwners = resolveGlobalSingleton(
  Symbol.for("aether.sessionPendingInputDedupeRecoveries"),
