...
import type { ConfigFileSnapshot, LegacyConfigIssue, AetherConfig } from "./types.js";
...
export async function readConfigFileSnapshotInternal(
  ...
  let fallbackSourceConfig: AetherConfig = {};
  ...
  try {
    ...
    if (
      ...
      let recoveryCandidate: AetherConfig | null = null;
