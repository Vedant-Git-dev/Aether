import { asNullableObjectRecord, isRecord } from "@aether/normalization-core/record-coerce";
...
const SECRETREF_POLICY_DOC_URL = "https://docs.aether.ai/reference/secretref-credential-surface";
