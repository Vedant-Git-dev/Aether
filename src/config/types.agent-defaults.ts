...
export type AgentModelEntryConfig = {
  ...
  /** Aether Code Mode override; omitted inherits the enclosing activation policy. */
  codeMode?: boolean;
...
export type AgentCompactionConfig = {
  ...
  /** Thinking level for embedded Aether compaction summaries. Default: low. */
  thinkingLevel?: AgentThinkingLevel | "inherit";
  /** Embedded Aether keepRecentTokens budget used for cut-point selection. */
