...
import type { AetherConfig, ResolvedSourceConfig, RuntimeConfig } from "./types.js";
...
export function asResolvedSourceConfig(config: AetherConfig): ResolvedSourceConfig {
  return config as ResolvedSourceConfig;
}

export function asRuntimeConfig(config: AetherConfig): RuntimeConfig {
