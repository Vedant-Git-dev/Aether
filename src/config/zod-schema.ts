...
import { AetherSchemaShape } from "./zod-schema.root-shape.js";
...
export const AetherSchema = z.strictObject(AetherSchemaShape).superRefine((cfg, ctx) => {
  const agents = listAgentEntries(cfg as AetherConfig);
