...
/**
 * @deprecated Compatibility facade for the `aether/plugin-sdk/discord` subpath.
...
export type { AetherConfig } from "./config-contracts.js";
export type { AetherPluginApi, PluginRuntime } from "./channel-plugin-common.js";
...
/** Discord channel config shape for one account in Aether config. */
export type DiscordAccountConfig = NonNullable<NonNullable<AetherConfig["channels"]>["discord"]>;
...
type DiscordApiFacadeModule = {
  ...
  inspectDiscordAccount: (params: { cfg: AetherConfig; accountId?: string | null }) => unknown;
  listDiscordAccountIds: (cfg: AetherConfig) => string[];
  ...
  resolveDefaultDiscordAccountId: (cfg: AetherConfig) => string;
...
function resolveCompatRuntimeConfig(params: { cfg?: AetherConfig }): AetherConfig {
...
/** List configured Discord account ids from Aether config. */
export function listDiscordAccountIds(cfg: AetherConfig): string[] {
...
export function resolveDefaultDiscordAccountId(cfg: AetherConfig): string {
