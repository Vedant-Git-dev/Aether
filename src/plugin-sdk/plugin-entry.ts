...
export type {
  ...
  MigrationSummary,
  AetherGatewayDiscoveryAdvertiseContext,
  ...
  AetherPluginNodeInvokePolicyContext,
  AetherPluginNodeInvokePolicyResult,
  AetherPluginReloadRegistration,
  AetherPluginSecurityAuditCollector,
  AetherPluginSecurityAuditContext,
  AetherPluginService,
...
export type {
  AetherPluginGatewayEventScope,
  AetherPluginGatewayEvents,
...
} from "@aether/model-catalog-core/model-catalog-types";
...
type DefinePluginEntryOptions = {
   ...
   */
  kind?: AetherPluginDefinition["kind"];
  configSchema?: AetherPluginConfigSchema | (() => AetherPluginConfigSchema);
  reload?: AetherPluginDefinition["reload"];
  nodeHostCommands?: AetherPluginDefinition["nodeHostCommands"];
  securityAuditCollectors?: AetherPluginDefinition["securityAuditCollectors"];
  register: NonNullable<AetherPluginDefinition["register"]>;
};

/** Normalized object shape that Aether loads from a plugin entry module. */
 ...
 * `aether/plugin-sdk/core` so they inherit the channel capability wiring.
 *
 * @experimental Pin and test Aether host versions; existing compatibility windows still apply.
 */
