...
export { normalizeProviderId } from "@aether/model-catalog-core/provider-id";
export {
  normalizeAntigravityPreviewModelId,
  normalizeGooglePreviewModelId,
} from "@aether/model-catalog-core/provider-model-id-normalize";
...
export { isCloudModelRef } from "@aether/model-catalog-core/model-catalog-refs";
...
const LOCAL_MODEL_FAMILY_PREFERENCES = [
  ...
  // aether tool calls) scored gemma4:e4b well above qwen3.5:4b on approval
