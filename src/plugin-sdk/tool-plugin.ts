...
export const toolPluginMetadataSymbol = Symbol.for("aether.plugin-sdk.tool-plugin.metadata");

/** Runtime context supplied to a concrete tool plugin execution handler. */
export type ToolPluginExecutionContext = {
  /** Plugin runtime API for tool implementations that need Aether services. */
  api: AetherPluginApi;
