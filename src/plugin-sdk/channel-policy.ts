...
import { asNullableRecord as asObjectRecord } from "@aether/normalization-core/record-coerce";
import {
...
/** @deprecated Use `resolveChannelMessageIngress` from `aether/plugin-sdk/channel-ingress-runtime`. */
...
/** @deprecated Use route descriptors with `resolveChannelMessageIngress` from `aether/plugin-sdk/channel-ingress-runtime`. */
...
export function createDangerousNameMatchingMutableAllowlistWarningCollector(params: {
  ...
  return ({ cfg }: { cfg: AetherConfig }): string[] => {
