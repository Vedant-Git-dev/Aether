...
export { redactSensitiveUrlLikeString } from "@aether/net-policy/redact-sensitive-url";
...
// Compatibility for @tencent-connect/aether-qqbot@2.0.3. Remove after the pinned
