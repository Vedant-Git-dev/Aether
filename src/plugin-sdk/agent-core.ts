...
/** Runtime adapter that lets the package agent-core use Aether LLM helpers. */
export const aetherAgentCoreRuntime = {
...
/** Agent-core class preconfigured with Aether runtime dependencies. */
export class Agent extends CoreAgent {
  constructor(options: CoreAgentOptions = {}) {
    super({ runtime: aetherAgentCoreRuntime, ...options });
  }
}

// Aether-owned reusable agent core
