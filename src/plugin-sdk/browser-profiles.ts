...
export const DEFAULT_AETHER_BROWSER_ENABLED = true;
...
export const DEFAULT_AETHER_BROWSER_COLOR = "#FF4500";
/** Default Aether-managed browser profile name. */
export const DEFAULT_AETHER_BROWSER_PROFILE_NAME = "aether";
/** Default browser profile selected when config omits a profile name. */
export const DEFAULT_BROWSER_DEFAULT_PROFILE_NAME = "aether";
 ...
 */
export const DEFAULT_UPLOAD_DIR = "/tmp/aether/uploads";
