...
import {
  ...
  type AetherPluginApiWithoutFacades,
} from "../plugins/api-facades.js";
import type { AetherPluginApi } from "./plugin-runtime.js";

/** Partial plugin API overrides accepted by the SDK test helper. */
export type TestPluginApiInput = Partial<AetherPluginApi>;

/** Create a minimal plugin API object for plugin-sdk contract and unit tests. */
export function createTestPluginApi(api: TestPluginApiInput = {}): AetherPluginApi {
  ...
  const mergedApi = {
    ...
    config: {},
    runtime: {} as AetherPluginApi["runtime"],
    ...
    on() {},
    ...flatApi,
  } satisfies AetherPluginApiWithoutFacades;
