...
export type { AetherConfig } from "../config/config.js";
export type { DmPolicy } from "../config/types.js";
// Registry readers (2026-07-22): @nodeskai/feishu, aether-channel-whatsapp-official,
// aether-vk, aether-ndr, moltbot-channel-feishu, @kagura-agent/aether-zulip,
// @jeik/dingtalk-connector, @xzq-xu/feishu, @dingtalk-real-ai/dingtalk-connector,
// @aether-vk/vk, yzw-dingtalk-connector, and aether-channel-zulip.
...
export type {
  ...
  WizardProgress,
  WizardPrompter,
  // Registry reader (2026-07-22): @ama2/aether-channel.
  WizardSelectParams,
...
// Registry readers (2026-07-22): @cyzlmh/aether-sms, @spicerhome/claw-messenger,
// @chatu-ai/webhub, @rowger_go/chatu, and @emotion-machine/claw-messenger.
export { normalizeE164 } from "../utils.js";
// Registry readers (2026-07-22): aether-rcs, @woowonjae/rol-websocket-channel,
// aether-swarm-layer, rol-websocket-channel, @clawling/clawchat-plugin-aether,
// @workclaw/aether-workclaw, clawspec, and @privateclaw/privateclaw.
...
export {
  ...
  // Registry reader (2026-07-22): @lansenger-pm/aether-lansenger-channel.
  ...
  // Registry reader (2026-07-22): aether-channel-xiaozhu.
  resolveSetupAccountId,
  runSingleChannelSecretStep,
  setSetupChannelEnabled,
  // Registry readers (2026-07-22): aether-vk and @aether-vk/vk.
