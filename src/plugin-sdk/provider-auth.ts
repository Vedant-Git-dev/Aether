...
export { findNormalizedProviderValue } from "@aether/model-catalog-core/provider-id";
...
function readGithubCopilotDomainFromConfig(config?: AetherConfig): string | undefined {
...
export async function resolveCopilotApiToken(params: {
  ...
  githubDomain?: string;
  /**
   * Aether config used to resolve the persisted `githubDomain` provider
