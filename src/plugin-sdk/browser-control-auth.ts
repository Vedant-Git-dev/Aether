// Browser control auth helpers resolve plugin browser credentials from Aether config.
...
type BrowserControlAuthSurface = {
  resolveBrowserControlAuth: (cfg?: AetherConfig, env?: NodeJS.ProcessEnv) => BrowserControlAuth;
