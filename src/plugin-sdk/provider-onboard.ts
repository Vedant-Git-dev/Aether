...
export type { AetherConfig, ModelApi, ModelDefinitionConfig, ModelProviderConfig };
export {
...
export type ProviderOnboardPresetAppliers<TArgs extends unknown[]> = {
  applyProviderConfig: (cfg: AetherConfig, ...args: TArgs) => AetherConfig;
  applyConfig: (cfg: AetherConfig, ...args: TArgs) => AetherConfig;
};
...
>(params: {
  ...
  applyPreset: (cfg: AetherConfig, preset: TParams) => AetherConfig;
  primaryModelRef: string;
...
export function createAliasOnlyPresetAppliers(params: {
  ...
  const applyProviderConfig = (cfg: AetherConfig): AetherConfig => {
...
export function applyOpencodeZenModelDefault(cfg: AetherConfig): {
  next: AetherConfig;
  changed: boolean;
} {
