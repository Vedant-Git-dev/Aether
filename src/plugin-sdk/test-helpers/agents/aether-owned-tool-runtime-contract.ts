// Aether-owned tool runtime contract helpers mock agent tool runtimes in SDK tests.
...
export function installAetherOwnedToolHooks(params?: {
 ...
 * Pair with `installAetherOwnedToolHooks()` when a test asserts before/after hook behavior.
 */
...
export function resetAetherOwnedToolHooks(): void {
  resetGlobalHookRunner();
  resetPluginRuntimeStateForTest();
