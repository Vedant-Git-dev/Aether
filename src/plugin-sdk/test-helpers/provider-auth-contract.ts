...
type EnsureAuthProfileStore =
  typeof import("aether/plugin-sdk/provider-auth").ensureAuthProfileStore;
type ListProfilesForProvider =
  typeof import("aether/plugin-sdk/provider-auth").listProfilesForProvider;
...
function installSharedAuthProfileStoreHooks(state: { authStore: AuthProfileStore }) {
  beforeEach(() => {
    vi.doMock("aether/plugin-sdk/provider-auth", async () => {
      const actual = await vi.importActual<typeof import("aether/plugin-sdk/provider-auth")>(
        "aether/plugin-sdk/provider-auth",
      );
      return {
        ...actual,
