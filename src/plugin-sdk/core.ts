...
import type { AetherPluginApi } from "../plugins/types.js";
...
export type {
  ...
  AetherPluginSessionsChangedEvent,
...
export { parseStrictPositiveInteger } from "@aether/normalization-core/number-coercion";
...
type DefineChannelPluginEntryOptions<TPlugin = ChannelPlugin> = {
  ...
  registerCliMetadata?: (api: AetherPluginApi) => void;
  registerFull?: (api: AetherPluginApi) => void;
  registerCapabilities?: (api: AetherPluginApi) => void;
};
...
type ChatChannelThreadingReplyModeOptions<TResolvedAccount> =
  ...
  | {
      scopedAccountReplyToMode: {
        resolveAccount: (cfg: AetherConfig, accountId?: string | null) => TResolvedAccount;
        resolveReplyToMode: (
