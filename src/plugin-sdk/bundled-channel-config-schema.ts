/**
 * Bundled-channel config schemas for Aether-maintained plugins.
 *
 * Third-party plugins should define plugin-local schemas and import primitives
 * from aether/plugin-sdk/channel-config-schema instead of depending on these
...
type ChannelConfig = NonNullable<AetherConfig["channels"]>;
