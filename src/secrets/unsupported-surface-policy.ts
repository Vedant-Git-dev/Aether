...
// Candidate scanning only sees aether.json; auth-profile-only surfaces are audited elsewhere.
...
/**
 * Concrete unsupported config value discovered from an aether.json-like object.
 */
...
/**
 * Finds configured aether.json values whose surfaces currently reject SecretRef objects.
 */
