...
type HiddenGitHubStoreDatabase = Pick<AetherStateKyselyDatabase, "secret_store_entries">;
type HiddenGitHubStoreRow = Selectable<AetherStateKyselyDatabase["secret_store_entries"]>;
