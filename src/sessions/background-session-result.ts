  ...
  return await runExclusiveSessionLifecycleMutation({
    ...
    run: async () => {
      ...
      const message = {
        ...
        timestamp: Date.now(),
        idempotencyKey,
        aetherAutomation: params.provenance,
      } satisfies SessionTranscriptAssistantMessage & {
        idempotencyKey: string;
        aetherAutomation: BackgroundSessionResultProvenance;
      };
        ...
        messages: [
          {
            message: priorMessage
              ? { ...priorMessage, content: message.content, aetherAutomation: params.provenance }
              : message,
