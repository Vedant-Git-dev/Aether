...
type SessionUpstreamMonitorOptions = AetherStateDatabaseOptions & {
...
function databaseOptions(options: SessionUpstreamMonitorOptions): AetherStateDatabaseOptions {
  return {
...
if (process.env.VITEST || process.env.NODE_ENV === "test") {
  (globalThis as Record<PropertyKey, unknown>)[
    Symbol.for("aether.sessionUpstreamMonitorTestApi")
