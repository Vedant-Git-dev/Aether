...
type AuditEventsTable = AetherStateKyselyDatabase["audit_events"];
type AuditDatabase = Pick<AetherStateKyselyDatabase, "audit_events">;
...
export function listAuditEvents(params: {
  ...
  const { db } = openAetherStateDatabase(params.database);
