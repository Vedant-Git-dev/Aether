...
>;
type ExecutionDecisionRow = Selectable<AetherStateKyselyDatabase["execution_decision_facts"]>;
...
const ensureExecutionDecisionFactSchema = createAetherStateSchemaEnsurer({
...
type ExecutionDecisionFactOptions = AetherStateDatabaseOptions & {
  now?: number;
    ...
    remediation: [
      {
        ...
        text: "Run aether vitals and inspect the shared state database before trusting this decision.",
      },
    ],
  };
}
