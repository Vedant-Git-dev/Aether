// Workshop config helpers resolve skill workshop settings from Aether config.
...
export function resolveSkillWorkshopConfig(config?: AetherConfig): SkillWorkshopConfig {
