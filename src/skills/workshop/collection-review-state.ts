...
type CollectionReviewDatabase = Pick<AetherStateDatabase, "skill_workshop_collection_reviews">;
...
export function readSkillReviewOutcomes(options: AetherStateDatabaseOptions = {}) {
...
export function listSkillCollectionReviewOutcomes(
  ...
  const database = openAetherStateDatabase(databaseOptions(options));
