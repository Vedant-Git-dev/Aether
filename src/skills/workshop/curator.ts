...
type CuratorDatabase = Pick<AetherStateDatabase, "skill_usage" | "skill_workshop_proposals">;
...
function curatorDb(options: AetherStateDatabaseOptions = {}) {
...
export function registerSkillUsageTracking(options: AetherStateDatabaseOptions = {}): () => void {
