...
export function resolveSkillsInstallPreferences(config?: AetherConfig): SkillsInstallPreferences {
...
const BUNDLED_SOURCES = new Set(["aether-bundled", "aether-custodian"]);

function isBundledSkill(entry: SkillEntry): boolean {
  return BUNDLED_SOURCES.has(resolveSkillSource(entry.skill));
}

export function resolveBundledAllowlist(config?: AetherConfig): ReadonlySet<string> | undefined {
