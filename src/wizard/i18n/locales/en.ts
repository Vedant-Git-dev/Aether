...
export const en = {
  ...
  wizard: {
    ...
    gateway: {
      ...
      plaintextPasswordHint: "Stores the password directly in Aether config",
      ...
      tokenStoreProvisioned:
        "Generated a Gateway secret and stored it in the Aether secret store as {name}. Config keeps only a reference; inspect it with `aether secrets store list`.",
    ...
    migration: {
      ...
      complete: "Migration complete. Run `aether vitals` next.",
    ...
    memoryImport: {
      ...
      confirm: "Import these memories into your Aether workspace?",
    ...
    plugins: {
      ...
      extrasSelect: "Optional plugins — select any extras you want to enable",
      extrasSkip: "Continue without extras",
      extrasSkipHint: "Enable any time later with: aether plugins enable <id>",
    ...
    model: {
      ...
      providerModelPrompt: "Model name for {provider}",
      providerModelPlaceholder: "{provider}/model-name (or just the model name)",
    ...
    remote: {
      ...
      insecureRemoteUrl:
        "Use wss:// for remote hosts, or ws://127.0.0.1/localhost via SSH tunnel. Break-glass: AETHER_ALLOW_INSECURE_PRIVATE_WS=1 for trusted private networks.",
      ...
      plaintextTokenHint: "Stores the secret directly in Aether config",
    ...
    guided: {
      ...
      laneSecurityLine:
        "Aether runs an AI agent with real access to this machine. Security guide: https://docs.aether.ai/gateway/security",
      ...
      quickstartBackground:
        "To keep the Gateway running in the background later: aether gateway install",
      quickstartReopen:
        "Run aether to open the TUI, or aether dashboard to reopen the web dashboard.",
      ...
      quickstartGatewayPending:
        "The Gateway is not reachable yet. Keep this terminal open and run aether gateway status to check startup.",
      accessFullHint:
      ...
      custodianIntro: "Hi — I'm Aether. I keep this system running. Let's get you set up.",
      findMeLater:
        "You can always find me later — run `aether` in a terminal, or open Settings in the dashboard.",
      ...
      complete: "Aether is ready.",
      completeWithoutAi: "Aether setup is saved. Connect AI before opening chat.",
      ...
      escapeHatches: "For the full step-by-step wizard, run `aether awaken` (no flags).",
      ...
      invalidConfigDetails: "Aether config {path} is invalid:\n{issues}",
      invalidConfigRepair:
      ...
      nextSteps:
        "Workspace: {workspace}\nAdd a channel: `aether channels add`\nPrefer chatting? Run `aether ignite` and say `connect telegram` (or `connect slack`).\nOpen the dashboard: `aether dashboard`\nChat later: `aether`",
      nextStepsWithoutAi:
        "Workspace: {workspace}\nAdd AI later: re-run `aether awaken`\nAfter AI connects, add a channel: `aether channels add`\nOpen the dashboard: `aether dashboard`",
    ...
    security: {
      ...
      attribution:
        "Aether is an open-source assistant that learns and grows with you, by the Aether Foundation (a non-profit).",
      baselineDmSessions:
      ...
      hardeningRequired:
        "If you're not comfortable managing access controls and security hardening, don't run Aether without help.",
      learnMore: "Learn more at",
      notMultitenant: "Aether is not designed to safely separate multiple users by default.",
      personalAgent: "By default, Aether is a personal agent for one operator.",
    ...
    telemetry: {
      ...
      decline: "No thanks",
      description:
        "Share which features you use (channels, providers, plugin count) as part of the daily update check. Never messages, never identifiers. See exactly what is sent: `aether telemetry show`. Change anytime: `aether telemetry on|off`.",
      title: "Help make Aether better?",
    },
    skills: {
      ...
      docsLine: "Docs: https://docs.aether.ai/skills",
      enterEnv: "Enter {env}",
      ...
      manualPrereqsDoctorHint:
        "Install those tools first, then run `aether vitals` to review skills + requirements.",
    ...
    clickclack: {
      ...
      helpCreateToken:
        "In ClickClack: Workspace settings → Integrations → Aether → create bot → copy token",
      invalidToken:
    ...
    nextcloudTalk: {
      ...
      helpInstallCommand:
        '2) Run: ./occ talk:bot:install "Aether" "<shared-secret>" "<webhook-url>" --feature webhook --feature response --feature reaction',
    ...
    whatsapp: {
      ...
      ownerNumberNote: "We need the sender/owner number so Aether can allowlist you.",
      ...
      separatePhoneLabel: "Separate phone just for Aether",
    ...
    irc: {
      ...
      nextStatusCommand: "Command: aether channels status --probe",
    ...
    synologyChat: {
      ...
      incomingWebhookHelpReplies: "This is the URL Aether uses to send replies back to Chat.",
      ...
      publicWebhookUrlScope:
        "Expose only this webhook route; Aether uses it for short-lived attachment downloads.",
    ...
    signal: {
      ...
      multipleEntries: "Multiple entries: comma-separated.",
      nextLinkDevice: 'Link device with: signal-cli link -n "Aether"',
    ...
    twitch: {
      ...
      envPrompt: "Twitch env var AETHER_TWITCH_ACCESS_TOKEN detected. Use env token?",
      ...
      helpEnvVars: "Env vars supported: AETHER_TWITCH_ACCESS_TOKEN",
    ...
    channelsPrimer: {
      ...
      blurbs: {
        ...
        synologyChat: "Connect your Synology NAS Chat to Aether with full agent capabilities.",
    ...
    search: {
      ...
      configured: "configured",
      configureLaterHint: "Configure later with aether tune --section web",
      docsLine: "Docs: {url}",
    ...
    finalize: {
      ...
      controlUiDocs: "Docs: https://docs.aether.ai/web/control-ui",
      dashboardCopyPaste: "Copy/paste this URL in a browser on this machine to control Aether.",
      dashboardOpened: "Opened in your browser. Keep that tab to control Aether.",
      ...
      gatewayTokenStored:
        "Stored in: $AETHER_CONFIG_PATH (default: ~/.aether/aether.json) under gateway.auth.token, or in AETHER_GATEWAY_TOKEN.",
      ...
      outroDashboardLink: "Onboarding complete. Use the dashboard link above to control Aether.",
      outroDashboardOpened:
        "Onboarding complete. Dashboard opened; keep that tab to control Aether.",
      ...
      containerSystemdUnavailable:
        "Systemd user services are not available inside this container. Aether is skipping only the background service install; run the Gateway in the foreground or use your container supervisor.",
      securityReminder:
        "Running agents on your computer is risky — harden your setup: https://docs.aether.ai/security",
      ...
      webDocs: "Docs: https://docs.aether.ai/tools/web",
      ...
      webUiUrl: "Web UI: {url}",
      whatNow: 'What now: https://aether.ai/showcase ("What People Are Building").',
      whatNowTitle: "What now",
      workspaceBackupTitle: "Workspace backup",
      workspaceDocs: "Docs: https://docs.aether.ai/concepts/agent-workspace",
