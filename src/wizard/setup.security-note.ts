...
export function getSecurityNoteMessage(): string {
  return [
    ...
    formatCliCommand("aether security audit --deep"),
    formatCliCommand("aether security audit --fix"),
    "",
    `${t("wizard.security.learnMore")} https://docs.aether.ai/gateway/security`,
  ].join("\n");
}
