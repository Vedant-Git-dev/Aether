 ...
 */
class AetherIpLocation extends AetherLightDomContentsElement {
...
if (globalThis.customElements) {
  ...
  if (!customElements.get("aether-ip-location")) {
    customElements.define("aether-ip-location", AetherIpLocation);
  }
}

declare global {
  interface HTMLElementTagNameMap {
    "aether-ip-location": AetherIpLocation;
  }
}
