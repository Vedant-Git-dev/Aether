...
class SidebarAgentCard extends AetherLightDomContentsElement {
...
if (!customElements.get("aether-sidebar-agent-card")) {
  customElements.define("aether-sidebar-agent-card", SidebarAgentCard);
}
