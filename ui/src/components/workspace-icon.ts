 ...
 */
class WorkspaceIcon extends AetherLightDomContentsElement {
...
if (!customElements.get("aether-workspace-icon")) {
  customElements.define("aether-workspace-icon", WorkspaceIcon);
}
