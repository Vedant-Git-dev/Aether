...
class AetherBoardWidgetCell extends AetherLightDomElement {
  ...
  private readonly frame = new BoardWidgetFrameLifecycle({
    ...
    scrollBy: (deltaY) => {
      this.closest("aether-board-view")?.scrollBy({ top: deltaY, behavior: "auto" });
    },
    requestUpdate: () => this.requestUpdate(),
...
if (!customElements.get("aether-board-widget-cell")) {
  customElements.define("aether-board-widget-cell", AetherBoardWidgetCell);
}

declare global {
  interface HTMLElementTagNameMap {
    "aether-board-widget-cell": AetherBoardWidgetCell;
  }
}
