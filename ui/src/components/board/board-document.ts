...
export class AetherBoardDocument extends AetherLightDomElement {
  ...
  private async bindProvider(
    ...
    capabilities: ReturnType<AetherBoardDocument["providerCapabilities"]>,
    generation: number,
...
if (!customElements.get("aether-board-document")) {
  customElements.define("aether-board-document", AetherBoardDocument);
}

declare global {
  interface HTMLElementTagNameMap {
    "aether-board-document": AetherBoardDocument;
  }
}
