...
// Drawn in the smooth Aether lobster style (see the dreams scene and
...
if (!customElements.get("aether-lobster-pet")) {
  customElements.define("aether-lobster-pet", LobsterPet);
}
