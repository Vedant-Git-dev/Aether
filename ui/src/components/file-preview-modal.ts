...
export class AetherFilePreviewModal extends AetherLitElement {
  ...
  override render() {
    ...
    return html`
      <aether-modal-dialog
        label=${label}
        style="--aether-modal-width: min(1100px, 92vw); --aether-modal-max-height: 86vh;"
...
declare global {
  interface HTMLElementTagNameMap {
    "aether-file-preview-modal": AetherFilePreviewModal;
  }
}
