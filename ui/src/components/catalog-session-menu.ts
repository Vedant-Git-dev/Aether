...
class CatalogSessionMenu extends AetherLightDomElement {
    ...
    return html`
      ...
      >
        ...
        <wa-dropdown-item class="session-menu__item" value="viewer">
          ...
          >
          <span class="session-menu__text">${t("chat.catalog.openInAether")}</span>
        </wa-dropdown-item>
        <wa-dropdown-item
...
if (!customElements.get("aether-catalog-session-menu")) {
  customElements.define("aether-catalog-session-menu", CatalogSessionMenu);
}
