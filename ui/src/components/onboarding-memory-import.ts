...
const ONBOARDING_MEMORY_IMPORT_KEY = "aether.onboarding.memory-import";
...
class OnboardingMemoryImport extends AetherLightDomElement {
...
if (!customElements.get("aether-onboarding-memory-import")) {
  customElements.define("aether-onboarding-memory-import", OnboardingMemoryImport);
}

declare global {
  interface HTMLElementTagNameMap {
    "aether-onboarding-memory-import": OnboardingMemoryImport;
  }
}
