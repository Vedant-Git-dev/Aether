...
class UpdateRunView extends AetherLightDomElement {
...
if (!customElements.get("aether-update-run-view")) {
  customElements.define("aether-update-run-view", UpdateRunView);
}
