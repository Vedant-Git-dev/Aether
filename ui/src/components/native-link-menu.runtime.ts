...
export class NativeLinkMenu extends AetherLightDomElement {
...
if (!customElements.get("aether-native-link-menu")) {
  customElements.define("aether-native-link-menu", NativeLinkMenu);
}
