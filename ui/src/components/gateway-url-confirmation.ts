...
function renderGatewayUrlConfirmation(props: GatewayUrlConfirmationProps) {
  ...
  return html`
    <aether-modal-dialog label=${title} description=${summary} @modal-cancel=${props.onCancel}>
...
class GatewayUrlConfirmation extends AetherLightDomContentsElement {
...
if (!customElements.get("aether-gateway-url-confirmation")) {
  customElements.define("aether-gateway-url-confirmation", GatewayUrlConfirmation);
}
