...
class AppSidebar extends AppSidebarSessionNavigationElement implements SessionListHost {
  ...
  override disconnectedCallback() {
    window.removeEventListener("aether:native-gateways-changed", this.nativeGatewaysChanged);
  ...
  override connectedCallback() {
    ...
    window.addEventListener("aether:native-gateways-changed", this.nativeGatewaysChanged);
    this.hiddenSessionCatalogsChanged();
      ...
      >
        <div class="sidebar-shell" @mousedown=${beginNativeWindowDragFromTopInset}>
          ...
          <div class="sidebar-shell__footer">
            ${
              this.devGitBranch
                ? html`<aether-tooltip .content=${this.devGitBranch}>
...
if (!customElements.get("aether-app-sidebar")) {
  customElements.define("aether-app-sidebar", AppSidebar);
}
