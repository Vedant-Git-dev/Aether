...
class MacosTitlebarControls extends AetherLightDomContentsElement {
  ...
  private renderButton(options: {
    ...
    return html`
      <aether-tooltip .content=${options.tooltip ?? options.label}>
        <button
          type="button"
...
if (!customElements.get("aether-macos-titlebar-controls")) {
  customElements.define("aether-macos-titlebar-controls", MacosTitlebarControls);
}
