...
function renderSecretToggle(
  ...
  return html`
    <aether-tooltip .content=${revealed ? hide : show}>
      <button
        type="button"
          ...
          : html`
              <details class="login-gate__help">
                ...
                <ol class="login-gate__steps">
                  <li>
                    ${t("connection.help.step1")}${renderConnectCommand("aether gateway run")}
                  </li>
                  <li>
                    ${t("connection.help.step2")} ${renderConnectCommand("aether dashboard")}
                  </li>
                ...
                <div class="login-gate__docs">
                  <a
                    class="session-link"
                    href="https://docs.aether.ai/web/dashboard"
                    target=${EXTERNAL_LINK_TARGET}
                    rel=${buildExternalLinkRel()}
    ...
    <div class="login-gate">
      ...
      <div class="login-gate__card" data-mode=${feedback?.placement ?? "form"}>
        <header class="login-gate__brand">
          ...
          <span class="login-gate__brand-name">Aether</span>
        </header>
        ${body}
      </div>
    </div>
...
class LoginGate extends AetherLightDomContentsElement {
...
if (!customElements.get("aether-login-gate")) {
  customElements.define("aether-login-gate", LoginGate);
}
