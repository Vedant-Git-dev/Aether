import { gatewayOriginScope } from "@aether/gateway-client/browser";
...
const SIDEBAR_SESSION_GROUPING_STORAGE_KEY = "aether:sidebar:sessions:grouping";
const SIDEBAR_SESSION_CATALOG_GROUPING_STORAGE_KEY = "aether:sidebar:sessions:catalog-grouping";
const SIDEBAR_SESSION_SHOW_PREVIEW_STORAGE_KEY = "aether:sidebar:sessions:show-preview";
const SIDEBAR_SESSION_SHOW_CRON_STORAGE_KEY = "aether:sidebar:sessions:show-cron";
const SIDEBAR_SESSION_SHOW_SYSTEM_STORAGE_KEY = "aether:sidebar:sessions:show-system";
const SIDEBAR_SESSION_HIDE_EMPTY_GROUPS_STORAGE_KEY = "aether:sidebar:sessions:hide-empty-groups";
const SIDEBAR_SESSION_STATUS_FILTER_STORAGE_KEY = "aether:sidebar:sessions:status-filter";
const SIDEBAR_SESSION_SORT_MODE_STORAGE_KEY = "aether:sidebar:sessions:sort-mode";
const SIDEBAR_SESSION_COLLAPSED_SECTIONS_STORAGE_KEY =
  "aether:sidebar:sessions:collapsed-sections";
const SIDEBAR_HIDDEN_SESSION_CATALOGS_STORAGE_KEY = "aether:sidebar:sessions:hidden-catalogs";
const SIDEBAR_SESSION_OWNER_FILTER_STORAGE_PREFIX =
  "aether.control.sidebarSessionOwnerFilter.v1:";
export const SIDEBAR_HIDDEN_SESSION_CATALOGS_CHANGED_EVENT =
  "aether:sidebar-hidden-catalogs-changed";
