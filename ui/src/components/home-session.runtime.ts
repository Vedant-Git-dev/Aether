...
export class AetherHomeSession extends AetherLightDomElement {
...
customElements.define("aether-home-session", AetherHomeSession);

declare global {
  interface HTMLElementTagNameMap {
    "aether-home-session": AetherHomeSession;
  }
}
