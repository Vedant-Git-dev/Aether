...
/** `<aether-terminal-panel>` — the dockable Control UI shell surface. */
export class AetherTerminalPanel extends AetherLitElement {
...
declare global {
  interface HTMLElementTagNameMap {
    "aether-terminal-panel": AetherTerminalPanel;
  }
}
