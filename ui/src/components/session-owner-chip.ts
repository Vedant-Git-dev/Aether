...
export function renderSessionOwnerChip(
  ...
  return owner?.id
    ? html`<aether-session-owner-chip
        .owner=${owner}
        size=${size}
...
export function renderSessionOwnerAvatar(
  ...
  return html`<aether-viewer-avatar
 ...
 */
class SessionOwnerChip extends AetherLightDomElement {
...
if (!customElements.get("aether-session-owner-chip")) {
  customElements.define("aether-session-owner-chip", SessionOwnerChip);
}

declare global {
  interface HTMLElementTagNameMap {
    "aether-session-owner-chip": SessionOwnerChip;
  }
}
