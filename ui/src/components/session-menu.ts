...
class SessionMenu extends AetherLightDomElement {
  ...
  override connectedCallback() {
    ...
    // through it (same pattern as aether-native-link-menu).
...
if (!customElements.get("aether-session-menu")) {
  customElements.define("aether-session-menu", SessionMenu);
}
