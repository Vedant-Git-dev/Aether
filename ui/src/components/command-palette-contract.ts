...
export const COMMAND_PALETTE_TARGET_EVENT = "aether-command-palette-target";
export const COMMAND_PALETTE_OPEN_EVENT = "aether:command-palette-open";
export const SHELL_NAV_DRAWER_TOGGLE_EVENT = "aether:shell-nav-drawer-toggle";
