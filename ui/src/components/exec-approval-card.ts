...
class ApprovalCountdown extends AetherLightDomContentsElement {
  ...
  private readonly polling = new PollController(
    ...
    () => {
      this.requestUpdate();
      if (!this.compact) {
        this.closest("aether-modal-dialog")?.setAttribute(
          "description",
...
if (!customElements.get("aether-approval-countdown")) {
  customElements.define("aether-approval-countdown", ApprovalCountdown);
}
