...
/** `<aether-browser-panel>` — the dockable gateway browser surface. */
class AetherBrowserPanel extends AetherLitElement implements BrowserPanelControllerHost {
...
if (!customElements.get("aether-browser-panel")) {
  customElements.define("aether-browser-panel", AetherBrowserPanel);
}

declare global {
  interface HTMLElementTagNameMap {
    "aether-browser-panel": AetherBrowserPanel;
  }
}
