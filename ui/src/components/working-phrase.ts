...
class WorkingPhrase extends AetherLightDomContentsElement {
...
if (!customElements.get("aether-working-phrase")) {
  customElements.define("aether-working-phrase", WorkingPhrase);
}
