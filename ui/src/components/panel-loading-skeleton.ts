...
class PanelLoadingSkeleton extends AetherLitElement {
...
if (!customElements.get("aether-panel-loading-skeleton")) {
  customElements.define("aether-panel-loading-skeleton", PanelLoadingSkeleton);
}

declare global {
  interface HTMLElementTagNameMap {
    "aether-panel-loading-skeleton": PanelLoadingSkeleton;
  }
}
