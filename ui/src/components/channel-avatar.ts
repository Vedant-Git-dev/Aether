...
class ChannelAvatar extends AetherLightDomContentsElement {
...
if (!customElements.get("aether-channel-avatar")) {
  customElements.define("aether-channel-avatar", ChannelAvatar);
}
