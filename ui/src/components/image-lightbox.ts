...
class AetherImageLightbox extends AetherLitElement {
  ...
  static override styles = css`
    ...
    aether-modal-dialog {
      --aether-modal-width: 100vw;
      --aether-modal-max-width: 100vw;
      --aether-modal-max-height: 100dvh;
...
if (!customElements.get("aether-image-lightbox")) {
  customElements.define("aether-image-lightbox", AetherImageLightbox);
}

declare global {
  interface HTMLElementTagNameMap {
    "aether-image-lightbox": AetherImageLightbox;
  }
}
