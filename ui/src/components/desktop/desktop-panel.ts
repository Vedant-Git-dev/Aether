...
/** `<aether-desktop-panel>` — dockable RFB access to Gateway desktop sources. */
class AetherDesktopPanel extends AetherLitElement {
...
if (!customElements.get("aether-desktop-panel")) {
  customElements.define("aether-desktop-panel", AetherDesktopPanel);
}

declare global {
  interface HTMLElementTagNameMap {
    "aether-desktop-panel": AetherDesktopPanel;
  }
}
