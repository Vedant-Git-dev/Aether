...
class ConfigFormStructuredDraft extends AetherLightDomElement {
...
if (!customElements.get("aether-config-form-structured-draft")) {
  customElements.define("aether-config-form-structured-draft", ConfigFormStructuredDraft);
}
