...
export class CommandPalette extends AetherLightDomContentsElement {
...
if (!customElements.get("aether-command-palette")) {
  customElements.define("aether-command-palette", CommandPalette);
}
