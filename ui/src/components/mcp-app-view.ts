...
import { isMcpAppViewExpiredError } from "@aether/gateway-protocol";
...
class AetherAppBridge extends AppBridge {
...
export class McpAppView extends LitElement {
  ...
  private async setupResources(
    ...
    try {
      ...
      const bridge = new AetherAppBridge(
        null,
        { name: "Aether", version: "1.0.0" },
        buildMcpAppHostCapabilities(
          payload.csp,
