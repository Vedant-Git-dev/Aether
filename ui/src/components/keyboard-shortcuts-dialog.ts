...
class KeyboardShortcutsDialog extends AetherLitElement {
  ...
  override render() {
    ...
    return html`
      <aether-modal-dialog label=${t("shortcutsOverlay.title")} @modal-cancel=${close}>
        <div class="dialog">
          <header class="header">
...
if (!customElements.get("aether-keyboard-shortcuts-dialog")) {
  customElements.define("aether-keyboard-shortcuts-dialog", KeyboardShortcutsDialog);
}
