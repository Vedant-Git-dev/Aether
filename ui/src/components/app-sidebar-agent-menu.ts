...
const IDENTITY_MENU_LINKS: ReadonlyArray<{
  ...
  { href: "https://docs.aether.ai", icon: "book", label: () => t("common.docs") },
  {
    href: "https://docs.aether.ai/help",
    icon: "messageSquare",
    label: () => t("agentChip.getHelp"),
  },
  { href: "https://discord.gg/aether", icon: "users", label: () => t("agentChip.discord") },
  {
    ...
    >
      ...
      <div class="sidebar-identity-menu__footer">
        ...
        <span class="sidebar-mode-switch">
          <aether-theme-mode-toggle .mode=${params.themeMode}></aether-theme-mode-toggle>
        </span>
      </div>
    </wa-dropdown>
  `;
