...
import type { AetherModalDialog } from "./modal-dialog.ts";
...
class ExecApproval extends AetherLightDomContentsElement {
  @property({ attribute: false }) props?: ExecApprovalProps;
  @query("aether-modal-dialog") private dialog?: AetherModalDialog;
...
if (!customElements.get("aether-exec-approval")) {
  customElements.define("aether-exec-approval", ExecApproval);
}
