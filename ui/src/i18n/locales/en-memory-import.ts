...
const enMemoryImport = {
  memoryImport: {
    ...
    confirmBackup: "Aether creates a verified pre-import backup before copying memory.",
    ...
    subtitle:
      "Review Codex consolidated memory and Claude Code auto-memory before copying it into Aether.",
