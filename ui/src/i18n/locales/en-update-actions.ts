...
const enUpdateActions = {
  updates: {
    confirm: {
      ...
      macMessage:
        "Hands this update to the Aether Mac app, which installs it and restarts the Gateway it manages.",
      impact:
    ...
    dialog: {
      ...
      notStarted:
        "The update request went unanswered. Run `aether triage` on the Gateway host and inspect the result before retrying.",
    },
    triage: {
    ...
    report: {
      ...
      message:
        "Review the sanitized report below. Confirming will submit it with the authenticated GitHub CLI when available; otherwise Aether will offer a prefilled issue link or save the sanitized report locally.",
