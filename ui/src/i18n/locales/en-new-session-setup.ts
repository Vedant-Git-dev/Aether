...
const enNewSessionSetup = {
  newSession: {
    ...
    terminalPlacementUnsupported:
      "Native CLI sessions use a specific host, not Aether worker placement. Reset this draft and choose a native host.",
    ...
    sessionHostingDisabled:
      "Session hosting is disabled. Run aether connect --service --session-host on the device.",
