...
const enSessionPlacement = {
  sessionsView: {
    ...
    continueOnGatewayConfirm:
      'Continue "{session}" on the Gateway? Unsynced device files and in-flight work may be lost. Aether will continue from the last Gateway-synced state and will not replay the interrupted turn.',
