...
export const en: TranslationMap & {
  ...
  lazyView: {
    ...
    staleSubtitle: "Aether was updated in the background. Reload to get the latest panel.",
    reloading: "Reloading…",
    retry: "Retry",
    stylesFailed: "Styles failed to load, so the page may look broken.",
  },
  communityInvite: {
    cardLabel: "Join the Aether community on Discord",
  ...
  updates: {
    ...
    dialog: {
      disconnected:
        "The Gateway disconnected during the update. This page reconnects on its own. If it stays disconnected, run `aether triage` on the Gateway host to open a local coding agent for diagnosis and repair.",
      restarting:
        "The Gateway is restarting. This page disconnects and reconnects on its own. If it stays disconnected, run `aether triage` on the Gateway host to open a local coding agent for diagnosis and repair.",
    },
    channel: {},
    installKind: {},
    page: {},
    ...
    verificationFailedWithIdentity:
      "Update finished, but the running install does not match the expected revision. Expected {expected}, running {actual}. Run `aether triage` on the Gateway host before retrying.",
    handoffTimeout:
      "Update completion was not confirmed. Run `aether triage` on the Gateway host and inspect the result before retrying.",
    outcomeUnknown:
      "The update outcome is unknown. Run `aether triage` on the Gateway host and inspect the result before retrying.",
    triage: {
      hostHint:
        "If Ask Aether is unavailable, run `aether triage` on the Gateway host to open a local coding agent for diagnosis and repair. Diagnose the cause before retrying.",
    },
    report: {},
    failureReasons: {
      ...
      notGitInstall:
        "Not a git checkout. Run `aether update` from the CLI for a global reinstall.",
      notAetherRoot:
        "Run the update from an Aether checkout or use the CLI global reinstall path.",
      ...
      managedServiceHandoffUnavailable:
        "Stop the foreground Gateway, run `aether update`, then launch it again. For automatic updates, install a managed Gateway service.",
      doctorFailed: "Doctor repair failed. Run `aether doctor --non-interactive` and retry.",
      managedServiceHandoffFailed:
        "The update helper stopped before finishing. Run `aether update` in the terminal to see why.",
      managedServiceHandoffSpawnFailed:
        "The Gateway could not start the update helper. Run `aether update` in the terminal instead.",
      managedServiceHandoffParentTimeout:
        "The Gateway stayed up too long for the update helper. Start the update again, or run `aether update`.",
  ...
  devices: {
    ...
    pairing: {
      ...
      qrAlt: "Aether mobile pairing QR code",
      ...
      review: "Review",
      waiting: "Official Aether mobile apps connect automatically after scanning.",
    ...
    inventory: {
      ...
      desktopEnableHint:
        "Enable desktop.host.enabled: true in the node config and add desktop.stream to gateway.nodes.commands.allow, then restart both. The node reconnects with a pending reapproval for desktop.stream; approve it here or with aether nodes approve.",
      uptime: "up {time}",
      loadLabel: "load {load}",
  ...
  worktrees: {
    ...
    subtitle: "Isolated repository checkouts owned by Aether.",
  ...
  newSession: {
    ...
    worktreeBranchNote: "Creates branch aether/<name> in a separate checkout.",
    ...
    nativeTerminalHint:
      "Start the native CLI on the selected machine using its own account and configuration. This does not create an Aether Chat.",
  ...
  sessionsView: {
    ...
    moveSessionNoReplayWarning:
      "Aether safely reconciles the current workspace before moving. Active work is never replayed.",
  ...
  approvalPage: {
    ...
    connectionErrorDescription:
      "Aether cannot confirm or record a decision while disconnected. Reconnect to check the current status.",
    retry: "Retry",
  ...
  browser: {
    ...
    navigationCheckFailed: "Aether couldn’t verify this tab’s address. Refresh to try again.",
  ...
  modelSetup: {
    ...
    intro:
      "Aether discovers AI access on this Gateway. Choose a provider to begin; nothing is selected, tested, installed, or saved automatically.",
    required: {
      title: "No AI provider configured",
      body: "We couldn't find a provider and model configured for this agent. Choose a supported connection; Aether will test it before enabling chat.",
    ...
    access: {
      ...
      gatewayTooOld: "The Gateway is running an older Aether version",
    },
    candidates: {
    ...
    nativeDiscovery: {
      ...
      body: "Show native assistant conversations from this Gateway host in Aether. This is discovery, not an import or copy.",
    ...
    manual: {
      ...
      verifyHint: "Aether verifies a real model reply before marking the connection ready.",
      required: "Choose a provider and enter an API key or token.",
    },
    success: {
      title: "Connection verified",
      body: "Aether received a real reply from {modelRef}. You can start chatting now.",
  ...
  onboarding: {
    memoryImport: {
      ...
      body: "Aether found memory from other coding assistants. Import it into your agent workspace?",
      ...
      doneBody: "Migrated {migrated}, skipped {skipped}. You can continue setting up Aether.",
    },
  },
  assistantPanel: {
  ...
  custodian: {
    ...
    cancel: "Cancel",
    send: "Send",
    thinking: "Aether is thinking",
    earlier: "Earlier",
    requestFailed: "Aether could not reply. Try again.",
    connectionChanged: "The Gateway connection changed. Retry to continue this setup.",
    sessionRestarted:
      "{error} Aether started a fresh session; earlier messages remain for context.",
    unsupportedGateway: "Update the Gateway to continue setup with Aether.",
    panel: {
      title: "Aether",
      toggle: "Toggle Ask Aether",
      close: "Close Ask Aether",
      resize: "Resize Ask Aether",
      dockBottom: "Dock Ask Aether at bottom",
      dockRight: "Dock Ask Aether at right",
    },
    history: {
      button: "History",
      ...
      requestFailed: "Aether could not load change history.",
      loadMore: "Load more",
    ...
    nudge: {
      ...
      channelSetupTitle: "Reach Aether outside this app",
      channelSetupBody:
        "The web app already works. Add a channel only if you want to message Aether from another service.",
  ...
  mcpPage: {
    intro: "Connect and manage MCP servers that provide tools to Aether.",
    servers: "Servers",
    oauth: "OAuth",
    filtered: "Filtered",
  ...
  memoryPage: {
    intro: "Choose how Aether stores, searches, and maintains agent memory.",
  ...
  pluginsPage: {
    ...
    detailBuiltWith: "Built with Aether",
    ...
    optionalCapability: "Optional Aether capability.",
    enabled: "Enabled",
    disabled: "Disabled",
    available: "Available",
  ...
  aboutPage: {
    ...
    waveHello: "Wave hello to Aether",
    ...
    license: "© 2026 Aether Foundation — MIT License.",
  ...
  appsPage: {
    heroTitle: "Take Aether everywhere",
    heroTagline:
      "Companion apps for your desktop and browser — plus plugins to extend what your agent can do.",
    ...
    cards: {
      ...
      windows: {
        title: "Windows",
        desc: "The Windows companion connects your PC as an Aether device.",
      },
      linux: {
        title: "Linux",
      ...
      chrome: {
        ...
        desc: "Let Aether drive your existing Chrome — tabs, pages, and forms.",
      },
      plugins: {
        title: "Plugins & ClawHub",
        desc: "Extend Aether with channels, tools, and skills from the community.",
      },
    },
  },
  presence: {
  ...
  skillWorkshop: {
    ...
    selfLearning: {
      ...
      pitchBody:
        "Aether learns from completed work and improves reusable skills in the background. Reviews use your configured model.",
  ...
  connection: {
    ...
    scopeUpgrade: {
      ...
      guidance:
        "This browser has limited access. Manage it with aether devices on the Gateway or from Devices on an admin browser.",
      ...
      pending:
        "Approve this browser by running aether devices on the Gateway or from Devices on an admin browser. Retry reattaches to the request; Cancel stops waiting.",
      retry: "Retry",
      cancel: "Cancel",
  ...
  chat: {
    ...
    catalog: {
      ...
      openInAether: "Open in Aether",
      openInTerminal: "Open in terminal",
      deleteSession: "Delete",
      deleteSessionConfirm:
        "Delete this external session from Aether? Make sure no other runner is using it. Beamed sessions are deleted permanently. Sessions kept by another tool, such as Codex, are archived there and may be restorable.",
    ...
    catalogOpenTargetViewer: "Aether viewer",
    ...
    workspaceConflict: {
      ...
      description:
        "Aether kept your local versions and applied the other cloud changes. Inspect the staged result or take its version for a conflicted path.",
      ...
      commandsUnavailable:
        "This filename contains terminal control characters, so Aether will not build a copyable shell command for it. Inspect the staged ref directly and enter the path manually with care.",
  ...
  cron: {
    ...
    list: {
      ...
      emptyHint: "Describe what Aether should do and when — it runs on schedule.",
    ...
    detail: {
      ...
      newSubtitle: "Describe what Aether should do, then pick when it runs.",
    ...
    form: {
      ...
      promptPlaceholder: "Describe what Aether should do...",
      repeat: "Repeat",
