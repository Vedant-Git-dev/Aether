...
const enSettings = {
  ...
  cloudWorkersPage: {
    snapshots: {
      ...
      retirementHint:
        "Checkpoint {checkpoint} is awaiting deletion. Cleanup retries during the next warm-image capture or worker teardown. Inspect aether crabbox warm-images --json and resolve provider deletion errors if it remains pending.",
      ...
      cancelBuildMessage:
        "Stop this snapshot build and destroy its worker? Aether waits for provider work and cleanup to finish.",
      ...
      migrationHint:
        "Run aether doctor --fix and follow its provider-cleanup recovery instructions before provisioning workers.",
    },
    ...
    fields: {
      ...
      setup: "Setup command",
      setupHelp: "Optional idempotent shell command run before Aether is installed.",
  ...
  modelProviders: {
    ...
    readiness: {
      ...
      notConfigured: "Choose a provider and verify the model Aether will use.",
    ...
    logout: {
      ...
      confirm:
        "Remove the saved sign-in for {provider} from Aether? You can add this account again later.",
    ...
    defaults: {
      ...
      thinkingHelp:
        "Sets the global default for new sessions when no session-specific thinking level is set. Aether maps unsupported levels to the closest option supported by the selected model.",
      thinkingDefaultHelp:
  ...
  updates: {
    ...
    page: {
      ...
      channelDescription: "Choose which Aether release track this Gateway follows.",
  ...
  configPage: {
    deviceSettings: {
      appOnly: "These settings are only available inside the Aether app.",
      ...
      iconStyle: "Dock icon",
      iconStyleHint:
        "Original uses your Mac’s icon style. Other designs follow light/dark mode while Aether runs.",
      showDockIconHint:
        "Keep Aether visible in the Dock. When off, windows still show the Dock icon while open.",
      ...
      keepAwakeHint: "Keep the screen awake while Aether is active.",
      ...
      chromeExtensionHint:
        "Prepare the Aether extension on this Mac, then approve it in Chrome. This does not install on a remote Gateway.",
      chromeExtensionPreparing: "Preparing Chrome…",
      chromeExtensionPending:
        "Native host registered and installation requested. Open Chrome and approve Aether; restart Chrome if the request has not appeared. Use the Store link if you previously removed it.",
      chromeExtensionStoreRequired:
        "Native host registered. Add Aether from the Chrome Web Store to finish setup.",
      ...
      chromeExtensionFailed:
        "Setup could not finish. Install the Aether CLI on this Mac and run aether browser extension install for details.",
      ...
      cookieSyncUnavailable: "Cookie sync requires remote mode with an external Aether CLI.",
      cookieSyncEnabled: "Sync cookies to the remote computer",
      cookieSyncHint:
        "Continuously copy this Mac's logged-in cookies for the domains below into the remote Aether browser profile. Off by default.",
      domains: "Domains",
      domainsHint:
      ...
      activePresenceHint:
        "Share this Mac's idle duration so Aether can identify the Mac you used most recently and route node alerts. Never sends keys, pointer positions, app names, or window titles. Requires Accessibility.",
    },
    deviceTalk: {
      title: "This Mac",
  ...
  configView: {
    ...
    notifications: {
      ...
      nativeBlockedHint: "Allow Aether in macOS System Settings > Notifications.",
    ...
    appearance: {
      ...
      fonts: {
        ...
        system: "System",
        previewCaption: "Aether · A little clarity goes a long way",
        previewProse:
