...
export function setControlUiBasePath(value: string | undefined) {
  ...
  if (typeof window === "undefined") {
    vi.stubGlobal(
      ...
      value == null
        ? ({} as TestWindow)
        : ({ __AETHER_CONTROL_UI_BASE_PATH__: value } as unknown as TestWindow),
    );
    return;
  }
  if (value == null) {
    delete (window as TestWindow)["__AETHER_CONTROL_UI_BASE_PATH__"];
    return;
  }
  Object.defineProperty(window, "__AETHER_CONTROL_UI_BASE_PATH__", {
    value,
    writable: true,
    configurable: true,
  });
