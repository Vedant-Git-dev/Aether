  ...
  it.each([
    ...
    async ({ catalogArchive, sessionArchive, canDelete }) => {
      ...
      const expectCatalogMenu = () => {
        const menu = sidebar.querySelector("aether-catalog-session-menu");
      ...
      menuButton.click();
      await sidebar.updateComplete;
      expect(sidebar.querySelector("aether-catalog-session-menu")).toBeNull();
