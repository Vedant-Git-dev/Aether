import { ErrorCodes } from "@aether/gateway-client/browser";
import { err as failure, ok, type Result } from "@aether/normalization-core/result";
 ...
 * writer changed aether.json; retrying the whole-form draft would clobber
