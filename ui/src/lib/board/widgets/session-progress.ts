...
import type { BoardGetParams, ProgressCardGetParams } from "@aether/gateway-protocol";
...
class AetherSessionProgressWidget extends AetherLightDomElement {
...
if (!customElements.get("aether-session-progress-widget")) {
  customElements.define("aether-session-progress-widget", AetherSessionProgressWidget);
}

declare global {
  interface HTMLElementTagNameMap {
    "aether-session-progress-widget": AetherSessionProgressWidget;
  }
}
