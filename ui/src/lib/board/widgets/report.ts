...
class AetherReportWidget extends AetherLightDomElement {
...
if (!customElements.get("aether-report-widget")) {
  customElements.define("aether-report-widget", AetherReportWidget);
}

declare global {
  interface HTMLElementTagNameMap {
    "aether-report-widget": AetherReportWidget;
  }
}
