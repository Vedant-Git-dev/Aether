...
export const SESSION_DRAG_MIME = "application/x-aether-session-key";
const SIDEBAR_SECTION_DRAG_MIME = "application/x-aether-session-group";
const SIDEBAR_ROUTE_DRAG_MIME = "application/x-aether-sidebar-route";
