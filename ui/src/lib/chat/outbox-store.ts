...
const LEGACY_STORAGE_KEY_PREFIX = "aether.control.chatComposer.v1:";
const PREVIOUS_STORAGE_KEY_PREFIX = "aether.control.chatComposer.v2:";
const BLOB_STORAGE_KEY_PREFIX = "aether.control.chatComposer.v3:";
const STORAGE_KEY_PREFIX = "aether.control.chatComposer.v4:";
...
export function notifyStoredChatOutboxChanges(): void {
  for (const listener of storedChatOutboxChangeListeners) {
    try {
      ...
      console.error("[aether] stored chat outbox listener failed", error);
    }
  }
}
