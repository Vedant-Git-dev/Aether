...
const SKILL_SOURCE_GROUPS: Array<{ id: string; labelKey: string; sources: string[] }> = [
  { id: "workspace", labelKey: "skillGroups.workspace", sources: ["aether-workspace"] },
  { id: "built-in", labelKey: "skillGroups.builtIn", sources: ["aether-bundled"] },
  { id: "installed", labelKey: "skillGroups.installed", sources: ["aether-managed"] },
  { id: "extra", labelKey: "skillGroups.extra", sources: ["aether-extra"] },
];
