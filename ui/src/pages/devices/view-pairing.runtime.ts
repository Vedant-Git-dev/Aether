...
const MOBILE_PAIRING_DOCS_URL =
  "https://docs.aether.ai/channels/pairing#pair-from-the-control-ui-recommended";
const NODE_PAIRING_DOCS_URL = "https://docs.aether.ai/gateway/pairing#one-paste-node-pairing";
...
export function renderDevicePairSetup(props: DevicePairSetupProps) {
  ...
  const nodeCommand = setup ? `aether node run --pair "oc-pair://${setup.setupCode}"` : "";
  ...
  return html`
    <aether-modal-dialog label=${title} description=${description} @modal-cancel=${props.onClose}>
