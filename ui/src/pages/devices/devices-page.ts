...
const DEVICES_DOCS_URL = "https://docs.aether.ai/nodes";
...
class DevicesPage extends AetherLightDomElement {
...
if (!customElements.get("aether-devices-page")) {
  customElements.define("aether-devices-page", DevicesPage);
}
