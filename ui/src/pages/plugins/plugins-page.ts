...
class PluginsPage extends AetherLightDomElement {
...
if (!customElements.get("aether-plugins-page")) {
  customElements.define("aether-plugins-page", PluginsPage);
}

declare global {
  interface HTMLElementTagNameMap {
    "aether-plugins-page": PluginsPage;
  }
}
