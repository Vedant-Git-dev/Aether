...
const MEMORY_IMPORT_DOCS_URL = "https://docs.aether.ai/install/migrating";
...
export class MemoryImportPage extends AetherLightDomElement {
...
if (!customElements.get("aether-memory-import-page")) {
  customElements.define("aether-memory-import-page", MemoryImportPage);
}
