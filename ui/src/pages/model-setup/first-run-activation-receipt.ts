...
import { gatewayCredentialScope } from "@aether/gateway-client/browser";
import type { ApplicationContext } from "../../app/context.ts";
import { getSafeLocalStorage } from "../../local-storage.ts";
import { activationTimeoutForKind } from "./state.ts";

const FIRST_RUN_ACTIVATION_RECEIPT_KEY = "aether.modelSetup.pendingActivation.v1";
const DEVICE_IDENTITY_KEY = "aether-device-identity-v1";
