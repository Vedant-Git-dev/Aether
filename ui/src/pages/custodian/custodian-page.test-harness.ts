import { GATEWAY_SERVER_CAPS } from "@aether/gateway-protocol";
...
export async function mountPage(
  ...
  const page = document.createElement("aether-custodian-page") as TestCustodianPage;
