import type { SystemAgentChatQuestion } from "@aether/gateway-protocol";
import { normalizeNullableString as nonEmptyString } from "@aether/normalization-core/string-coerce";
...
/**
 * Sanitize the typed `question` field from `aether.chat`. The gateway owns
