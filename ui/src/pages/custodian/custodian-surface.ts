...
class CustodianSurface extends AetherLightDomElement {
      ...
      return html`
        ...
        >
          ...
          <div class="custodian__setup-state" role="alert">
            <aether-mascot mood="idle" .size=${this.compact ? 72 : 96}></aether-mascot>
            ...
            store.sending
              ? html`<div class="chat-group assistant custodian__thinking-row" role="status">
                  <div class="chat-avatar assistant custodian__mascot-avatar" aria-hidden="true">
                    <aether-mascot mood="thinking" .size=${26}></aether-mascot>
                  </div>
...
if (!customElements.get("aether-custodian-surface")) {
  customElements.define("aether-custodian-surface", CustodianSurface);
}

declare global {
  interface HTMLElementTagNameMap {
    "aether-custodian-surface": CustodianSurface;
  }
}
