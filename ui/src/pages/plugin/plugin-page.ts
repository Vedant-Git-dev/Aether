...
export class PluginPage extends AetherLightDomContentsElement {
...
if (!customElements.get("aether-plugin-page")) {
  customElements.define("aether-plugin-page", PluginPage);
}
