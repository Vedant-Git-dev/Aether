...
class ActivityPage extends AetherLightDomElement {
...
export const activityPageComponent = {
  ...
  render: (location: RouteLocation = { pathname: "/activity", search: "", hash: "" }) =>
    html`<aether-activity-page .routeLocation=${location}></aether-activity-page>`,
};

if (!customElements.get("aether-activity-page")) {
  customElements.define("aether-activity-page", ActivityPage);
}
