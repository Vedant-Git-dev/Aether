...
class DevicePage extends AetherLightDomElement {
          ...
          control: html`
            <div class="device-extension-setup">
              <div class="device-extension-setup__actions">
                ...
                <a
                  href="https://chromewebstore.google.com/detail/aether/kcdjddhmeafeomebliikmbpblkmkfoig"
                  target="_blank"
                  rel="noopener noreferrer"
                  >${t("appsPage.ctaChromeWebStore")}</a
                >
                ${renderLearnMoreLink("https://docs.aether.ai/tools/chrome-extension")}
              </div>
              <p role="status">
                ${
  ...
  override render() {
    ...
    return html`
      ${renderSettingsPageHeader({
        ...
        ${renderLearnMoreLink("https://docs.aether.ai/platforms/macos")}`,
      })}
...
if (!customElements.get("aether-device-page")) {
  customElements.define("aether-device-page", DevicePage);
}
