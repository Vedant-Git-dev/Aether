...
class DevicePermissionsPage extends AetherLightDomElement {
...
if (!customElements.get("aether-device-permissions-page")) {
  customElements.define("aether-device-permissions-page", DevicePermissionsPage);
}
