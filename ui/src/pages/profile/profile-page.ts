...
const PROFILE_DOCS_URL = "https://docs.aether.ai/concepts/user-model";
...
export class ProfilePage extends AetherLightDomElement {
  ...
  private renderModelAccounts() {
    return html`<aether-model-accounts
  ...
  private renderBody() {
    ...
    return renderSettingsPage(html`
      ...
      <aether-github-connections></aether-github-connections>
      ${renderSettingsGroup(
        renderSettingsNavRow({
...
if (!customElements.get("aether-profile-page")) {
  customElements.define("aether-profile-page", ProfilePage);
}
