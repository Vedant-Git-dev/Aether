...
export class ModelAccounts extends AetherLightDomContentsElement {
...
if (!customElements.get("aether-model-accounts")) {
  customElements.define("aether-model-accounts", ModelAccounts);
}
