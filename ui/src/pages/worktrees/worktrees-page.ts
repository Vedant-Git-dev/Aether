...
const WORKTREES_DOCS_URL = "https://docs.aether.ai/concepts/managed-worktrees";
...
class WorktreesPage extends AetherLightDomElement {
...
if (!customElements.get("aether-worktrees-page")) {
  customElements.define("aether-worktrees-page", WorktreesPage);
}
