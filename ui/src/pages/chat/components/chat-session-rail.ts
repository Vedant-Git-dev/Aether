...
export class ChatSessionRailElement extends AetherLightDomElement {
...
if (!customElements.get("aether-chat-session-rail")) {
  customElements.define("aether-chat-session-rail", ChatSessionRailElement);
}
