...
class ChatVideoPlayer extends AetherLightDomContentsElement {
  @property() src = "";
...
if (!customElements.get("aether-chat-video-player")) {
  customElements.define("aether-chat-video-player", ChatVideoPlayer);
}

declare global {
  interface HTMLElementTagNameMap {
    "aether-chat-video-player": ChatVideoPlayer;
  }
}
