...
class ChatHeaderSessionMenu extends AetherLightDomElement {
...
if (!customElements.get("aether-chat-header-session-menu")) {
  customElements.define("aether-chat-header-session-menu", ChatHeaderSessionMenu);
}

declare global {
  interface HTMLElementTagNameMap {
    "aether-chat-header-session-menu": ChatHeaderSessionMenu;
  }
}
