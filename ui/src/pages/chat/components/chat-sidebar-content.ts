...
function renderSidebarAttachment(
  ...
  if (kind === "audio") {
    return html`<aether-chat-audio-player
      .src=${src}
      .sourceIdentity=${content.sourceIdentity ?? content.src ?? src}
      .label=${content.title}
      .mimeType=${content.mimeType ?? ""}
        ...
        props.embedded
          ...
          : html`<div class="sidebar-header">
              ...
              <div class="sidebar-header__actions">
                <aether-tooltip .content=${t("chat.detailPanel.close")}>
                  <button
                    @click=${props.onClose}
                    class="btn"
                    type="button"
