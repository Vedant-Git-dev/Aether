...
class ChatSvgAttachment extends AetherLightDomContentsElement {
  @property() src = "";
...
if (!customElements.get("aether-chat-svg-attachment")) {
  customElements.define("aether-chat-svg-attachment", ChatSvgAttachment);
}

declare global {
  interface HTMLElementTagNameMap {
    "aether-chat-svg-attachment": ChatSvgAttachment;
  }
}
