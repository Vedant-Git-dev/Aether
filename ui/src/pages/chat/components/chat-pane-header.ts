  ...
  return html`
    ...
    >
      <div class="chat-pane__header-leading">
        ${
          props.mergedChrome
            ? html`<aether-tooltip .content=${drawerLabel}>
                <button
          ...
          <fieldset class="chat-pane__actions" ?disabled=${props.actionsDisabled}>
            ...
            ${
              props.onOpenSplitView && !compactSessionActions
                ? html`<aether-tooltip .content=${t("chat.splitView.open")}>
                    <button
            ...
            ${
              !props.narrow && props.onSplitDown
                ? html`<aether-tooltip .content=${t("chat.splitView.splitDown")}>
                    <button
            ...
            ${
              !props.narrow && props.onSplitRight
                ? html`<aether-tooltip .content=${t("chat.splitView.splitRight")}>
                    <button
            ...
            ${
              props.onClosePane
                ? html`<aether-tooltip .content=${t("chat.splitView.closePane")}>
                    <button
            ...
            ${
              props.mergedChrome && !compactSessionActions
                ? html`<aether-tooltip .content=${t("chat.openCommandPalette")}>
                    <button
