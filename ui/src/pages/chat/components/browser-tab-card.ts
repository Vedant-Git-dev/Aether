...
class AetherBrowserTabCard extends AetherLitElement {
...
if (!customElements.get("aether-browser-tab-card")) {
  customElements.define("aether-browser-tab-card", AetherBrowserTabCard);
}

declare global {
  interface HTMLElementTagNameMap {
    "aether-browser-tab-card": AetherBrowserTabCard;
  }
}
