import { toErrorObject } from "@aether/normalization-core";
...
class ChatDetailPanel extends AetherLightDomElement {
...
if (!customElements.get("aether-chat-detail-panel")) {
  customElements.define("aether-chat-detail-panel", ChatDetailPanel);
}
