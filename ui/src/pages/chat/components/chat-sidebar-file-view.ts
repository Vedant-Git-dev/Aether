                    ...
                    controls.editing
                      ...
                      : html`
                          ${
                            content.edit
                              ? html`
                                  <aether-tooltip .content=${t("chat.detailPanel.editFile")}>
                                    <button
                          ...
                          <aether-tooltip .content=${t("chat.detailPanel.searchInFile")}>
                            <button
                              class="btn btn--sm sidebar-file-view__action"
                              type="button"
                          ...
                          ${
                            controls.onReveal
                              ? html`
                                  <aether-tooltip .content=${t("chat.detailPanel.showInFiles")}>
                                    <button
                                      class="btn btn--sm sidebar-file-view__action"
                                      type="button"
