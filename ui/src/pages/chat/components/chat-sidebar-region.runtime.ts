...
class ChatSidebarRegion extends AetherLightDomElement {
  ...
  override connectedCallback(): void {
    ...
    window.addEventListener("aether:native-close-focused-panel", this.closeFocusedPanel, options);
  }
  ...
  private renderHeaderActions(panelActions: TemplateResult | typeof nothing | null) {
    ...
    return html`<div class="rail-header__actions side-panel__actions">
      ...
      <span class="side-panel__action-group side-panel__action-group--close">
        ${
          active
            ? html`<aether-tooltip .content=${expandLabel}>
                <button
        ...
        <aether-tooltip .content=${t("common.close")}>
          <button
...
if (!customElements.get("aether-chat-sidebar-region")) {
  customElements.define("aether-chat-sidebar-region", ChatSidebarRegion);
}

declare global {
  interface HTMLElementTagNameMap {
    "aether-chat-sidebar-region": ChatSidebarRegion;
  }
}
