...
class ChatTextAttachment extends AetherLightDomContentsElement {
  @property() src = "";
...
if (!customElements.get("aether-chat-text-attachment")) {
  customElements.define("aether-chat-text-attachment", ChatTextAttachment);
}

declare global {
  interface HTMLElementTagNameMap {
    "aether-chat-text-attachment": ChatTextAttachment;
  }
}
