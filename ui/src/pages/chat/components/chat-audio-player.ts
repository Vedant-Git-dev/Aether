...
class ChatAudioPlayer extends AetherLightDomContentsElement {
  @property() src = "";
...
if (!customElements.get("aether-chat-audio-player")) {
  customElements.define("aether-chat-audio-player", ChatAudioPlayer);
}

declare global {
  interface HTMLElementTagNameMap {
    "aether-chat-audio-player": ChatAudioPlayer;
  }
}
