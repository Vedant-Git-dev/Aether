...
class SessionDiffMenu extends AetherLightDomElement {
...
if (!customElements.get("aether-session-diff-menu")) {
  customElements.define("aether-session-diff-menu", SessionDiffMenu);
}

declare global {
  interface HTMLElementTagNameMap {
    "aether-session-diff-menu": SessionDiffMenu;
  }
}
