...
import { normalizeNullableString as toTrimmedString } from "@aether/normalization-core/string-coerce";
...
function buildToolStreamMessage(entry: ToolStreamEntry): Record<string, unknown> {
  ...
  return {
    ...
    __aetherToolStreamResultReceived: entry.resultReceived === true,
    ...(entry.resultReceived !== true && entry.liveDiffStat
      ? { __aetherToolStreamDiffStat: entry.liveDiffStat }
      : {}),
    __aetherToolStreamReceivedAt: entry.receivedAt,
  };
}
