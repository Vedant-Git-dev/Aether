...
export function resumeStagedPanes(
  ...
  for (const pane of root.querySelectorAll<StagedAttachmentPane>("aether-chat-pane")) {
...
export function closeStagedPane(
  ...
  const mounted = [...root.querySelectorAll<StagedAttachmentPane>("aether-chat-pane")].filter(
