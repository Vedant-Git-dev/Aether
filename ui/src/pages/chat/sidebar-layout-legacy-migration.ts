import { isRecord } from "@aether/normalization-core";
...
const MIGRATION_MARKER_KEY = "aether.chat.sidePanel.legacyDockVisibility.v1";

const LEGACY_DOCKS = [
  { storageKey: "aether.browser.panel.v1", slot: "browser" },
  { storageKey: "aether.desktopPanel", slot: "desktop" },
