...
export abstract class ChatPaneLifecycle extends ChatPaneSessionCreation {
  ...
  override connectedCallback() {
    ...
    const panelToggleEvents = [
      [TERMINAL_PANEL_TOGGLE_EVENT, "terminal", "aether-terminal-panel"],
      [BROWSER_PANEL_TOGGLE_EVENT, "browser", "aether-browser-panel"],
      [DESKTOP_PANEL_TOGGLE_EVENT, "desktop", "aether-desktop-panel"],
    ] as const;
