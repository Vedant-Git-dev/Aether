...
const LAZY_SIDEBAR_ELEMENTS: Partial<Record<LazyElementKey, LazyElement>> = {
  ...
  browser: ["aether-browser-panel", () => import("../../components/browser/browser-panel.ts")],
  desktop: ["aether-desktop-panel", () => import("../../components/desktop/desktop-panel.ts")],
  companion: ["aether-chat-session-rail", () => import("./components/chat-session-rail.ts")],
  discussion: [
    ...
    ${
      regionError !== undefined
        ? regionError === null
          ? (regionLoading ?? null)
          : null
        : html`<aether-chat-sidebar-region
