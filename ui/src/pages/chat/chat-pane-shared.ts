import { asNullableRecord as catalogRawRecord } from "@aether/normalization-core/record-coerce";
...
function openDropdownOwnsKey(root: ParentNode, key: string): boolean {
  const surface = root instanceof Element ? (root.closest("aether-app") ?? root) : root;
