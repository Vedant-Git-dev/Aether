...
export class ModelAccountUsage extends AetherLightDomElement {
...
if (!customElements.get("aether-model-account-usage")) {
  customElements.define("aether-model-account-usage", ModelAccountUsage);
}
