...
export class ModelProvidersPage extends AetherLightDomElement {
  ...
  private refresh(opts: { force: boolean }): Promise<void> {
    ...
    if (opts.force) {
      this.querySelectorAll<ModelAccountUsage>("aether-model-account-usage").forEach((account) =>
...
if (!customElements.get("aether-model-providers-page")) {
  customElements.define("aether-model-providers-page", ModelProvidersPage);
}
