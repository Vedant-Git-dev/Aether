...
class SkillWorkshopPage extends AetherLightDomElement {
...
if (!customElements.get("aether-skill-workshop-page")) {
  customElements.define("aether-skill-workshop-page", SkillWorkshopPage);
}
