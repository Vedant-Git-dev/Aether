      ...
      : [
          ...
          renderSettingsRow({
            ...
            control: html`<details class="updates-attempt-details">
              ...
              <pre><code>aether triage</code></pre>
            </details>`,
          }),
        ]),
...
function readUpdatesSettings(
  ...
  // aether@extended-stable package install never writes update.channel.
  const channel =
    ...
    <div id="config-section-update">
      ${renderSettingsPage([
        ...
        html`<p class="settings-page__hint">
          <a href="https://docs.aether.ai/install/update-troubleshooting" target="_blank"
