...
import type { TranscriptsStatusResult } from "@aether/gateway-protocol";
...
class MeetingCaptureSettings extends AetherLightDomElement {
...
if (!customElements.get("aether-meeting-capture-settings")) {
  customElements.define("aether-meeting-capture-settings", MeetingCaptureSettings);
}
