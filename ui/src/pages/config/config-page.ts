...
import { asNullableRecord as asConfigRecord } from "@aether/normalization-core/record-coerce";
...
function renderConfigPageSubtitle(pageId: ConfigPageId) {
  switch (pageId) {
    case "appearance":
      ...
      ${renderLearnMoreLink("https://docs.aether.ai/web/control-ui")}`;
    case "mcp":
      return html`${t("mcpPage.intro")} ${renderLearnMoreLink("https://docs.aether.ai/tools/mcp")}`;
    case "security":
      return html`${t("quickSettings.security.intro")}
      ${renderLearnMoreLink("https://docs.aether.ai/gateway/security")}`;
    case "talk":
      return html`${t("talkPage.intro")}
      ${renderLearnMoreLink("https://docs.aether.ai/nodes/talk")}`;
    case "updates":
...
export class ConfigPage extends AetherLightDomElement {
...
if (!customElements.get("aether-config-page")) {
  customElements.define("aether-config-page", ConfigPage);
}
