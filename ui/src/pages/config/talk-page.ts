...
import type { TalkCatalogResult } from "@aether/gateway-protocol";
...
class TalkSettingsPage extends AetherLightDomElement {
...
if (!customElements.get("aether-talk-settings")) {
  customElements.define("aether-talk-settings", TalkSettingsPage);
}

export function renderTalkPage(props: TalkPageProps) {
  return html`
    <aether-talk-settings
