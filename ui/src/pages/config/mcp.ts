...
const MCP_DOCS_URL = "https://docs.aether.ai/tools/mcp";
          ...
          <div class="settings-group">
            <div class="settings-row settings-row--stacked">
              <div class="mcp-command-card__grid">
                <code>aether mcp status --verbose</code>
                <code>aether mcp doctor --probe</code>
                <code>aether mcp login &lt;name&gt;</code>
                <code>aether mcp reload</code>
              </div>
            </div>
          </div>
        </section>

        <aether-mcp-servers-card
