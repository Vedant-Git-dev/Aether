...
class MemoryMemoriesElement extends AetherLightDomElement {
...
if (!customElements.get("aether-memory-memories")) {
  customElements.define("aether-memory-memories", MemoryMemoriesElement);
}
