...
const docsCta = (path: string): AppCardCta => ({
  kind: "external",
  href: `https://docs.aether.ai${path}`,
    ...
    cards: [
      {
        ...
        ctas: [
          {
            kind: "external",
            href: "https://github.com/aether/aether/releases",
      ...
      },
      {
        ...
        ctas: [
          {
            kind: "external",
            href: "https://github.com/aether/aether-windows-node/releases/latest",
            label: () => t("appsPage.ctaDownload"),
          },
    ...
    cards: [
      {
        ...
        ctas: [
          ...
          {
            kind: "external",
            href: "https://docs.aether.ai/tools/chrome-extension",
...
const COMMUNITY_LINKS: ReadonlyArray<{ href: string; icon: TemplateResult; label: () => string }> =
  [
    ...
    { href: "https://docs.aether.ai", icon: icons.book, label: () => t("appsPage.linkDocs") },
  ];
