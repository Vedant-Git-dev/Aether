...
const APPROVALS_DOCS_URL = "https://docs.aether.ai/tools/exec-approvals";
...
class ApprovalsPage extends AetherLightDomElement {
...
if (!customElements.get("aether-approvals-page")) {
  customElements.define("aether-approvals-page", ApprovalsPage);
}
