...
class LobsterdexPage extends AetherLightDomElement {
...
if (!customElements.get("aether-lobsterdex-page")) {
  customElements.define("aether-lobsterdex-page", LobsterdexPage);
}
