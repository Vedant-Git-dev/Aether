...
const CHANNELS_DOCS_URL = "https://docs.aether.ai/channels";
...
class ChannelsPage extends AetherLightDomElement {
...
if (!customElements.get("aether-channels-page")) {
  customElements.define("aether-channels-page", ChannelsPage);
}
