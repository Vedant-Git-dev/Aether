...
import { asNullableRecord, readStringField } from "@aether/normalization-core/record-coerce";
...
export function renderChannelDetail(params: {
  ...
  return html`
    <aether-modal-dialog label=${params.label} @modal-cancel=${() => params.onClose()}>
