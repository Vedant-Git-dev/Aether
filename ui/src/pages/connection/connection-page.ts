...
const CONNECTION_DOCS_URL = "https://docs.aether.ai/gateway/remote";

export class ConnectionPage extends AetherLightDomElement {
...
if (!customElements.get("aether-connection-page")) {
  customElements.define("aether-connection-page", ConnectionPage);
}
