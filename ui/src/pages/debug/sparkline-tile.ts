...
class DebugSparklineTile extends AetherLightDomElement {
  @property() label = "";
  @property() sub = "";
...
if (!customElements.get("aether-debug-sparkline")) {
  customElements.define("aether-debug-sparkline", DebugSparklineTile);
}
