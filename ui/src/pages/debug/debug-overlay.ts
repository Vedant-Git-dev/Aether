...
export class DebugOverlay extends AetherLightDomElement {
...
if (!customElements.get("aether-debug-overlay")) {
  customElements.define("aether-debug-overlay", DebugOverlay);
}
