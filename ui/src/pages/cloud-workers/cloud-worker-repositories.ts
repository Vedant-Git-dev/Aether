...
class CloudWorkerRepositories extends AetherLightDomContentsElement {
...
if (!customElements.get("aether-cloud-worker-repositories")) {
  customElements.define("aether-cloud-worker-repositories", CloudWorkerRepositories);
}

export function renderCloudWorkerRepositories(canManage: boolean) {
  return html`<aether-cloud-worker-repositories
    .canManage=${canManage}
  ></aether-cloud-worker-repositories>`;
}
