...
class CloudWorkerSnapshotPolicy extends AetherLightDomContentsElement {
...
if (!customElements.get("aether-cloud-worker-snapshot-policy")) {
  customElements.define("aether-cloud-worker-snapshot-policy", CloudWorkerSnapshotPolicy);
}
