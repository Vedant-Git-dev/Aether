...
class CloudWorkerSnapshots extends AetherLightDomElement {
  ...
  override render() {
    ...
    return renderSettingsPage(html`
      ...
      <aether-cloud-worker-snapshot-policy></aether-cloud-worker-snapshot-policy>
      ${this.renderBuildDialog()}
    `);
  }
}

if (!customElements.get("aether-cloud-worker-snapshots")) {
  customElements.define("aether-cloud-worker-snapshots", CloudWorkerSnapshots);
}
