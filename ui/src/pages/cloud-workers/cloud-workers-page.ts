...
const CLOUD_WORKERS_DOCS_URL = "https://docs.aether.ai/gateway/cloud-workers";
...
class CloudWorkersPage extends AetherLightDomElement {
  ...
  override render() {
    ...
    return html`
      ...
      ${renderSettingsWorkspace(html`
        ...
        ${this.view === "profiles" ? body : html`<aether-cloud-worker-snapshots></aether-cloud-worker-snapshots>`}
      `)}
    `;
  }
}

if (!customElements.get("aether-cloud-workers-page")) {
  customElements.define("aether-cloud-workers-page", CloudWorkersPage);
}
