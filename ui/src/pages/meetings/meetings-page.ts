...
class MeetingsPage extends AetherLightDomElement {
...
export const meetingsPageComponent = {
  ...
  render: (search: unknown) =>
    html`<aether-meetings-page
      .routeSearch=${typeof search === "string" ? search : ""}
    ></aether-meetings-page>`,
};

if (!customElements.get("aether-meetings-page")) {
  customElements.define("aether-meetings-page", MeetingsPage);
}
