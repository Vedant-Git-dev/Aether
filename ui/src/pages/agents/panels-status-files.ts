                  ...
                  summary.configured === 0
                    ? html`
                        <a
                          ...
                          href="https://docs.aether.ai/channels"
                          target="_blank"
                          rel="noopener"
                    ...
                    !activeEntry
                      ...
                      : html`
                              ...
                              <button
                                ...
                                @click=${(e: Event) => {
                                  ...
                                  btn
                                    ...
                                    ?.querySelector<AetherModalDialog>("aether-modal-dialog")
                                    ?.show();
                                }}
                              >
                          ...
                          <aether-modal-dialog
                            ...
                            style="--aether-modal-width: min(1040px, calc(100vw - 32px));"
                            ...
                            <div class="md-preview-dialog__panel">
                              <div class="md-preview-dialog__header">
                                ...
                                <div class="md-preview-dialog__actions">
                                  <aether-tooltip .content=${t("agents.files.expandPreview")}>
                                    <button
                                      type="button"
                                  ...
                                  <aether-tooltip .content=${t("agents.files.editFile")}>
                                    <button
                                      type="button"
                                  ...
                                  <aether-tooltip .content=${t("agents.files.closePreview")}>
                                    <button
                                      type="button"
                                      class="btn btn--sm md-preview-icon-btn"
