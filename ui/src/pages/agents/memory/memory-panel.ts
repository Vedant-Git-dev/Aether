...
class AgentMemoryPanel extends AetherLightDomElement {
...
if (!customElements.get("aether-agent-memory-panel")) {
  customElements.define("aether-agent-memory-panel", AgentMemoryPanel);
}
