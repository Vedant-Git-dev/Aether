...
const SESSIONS_DOCS_URL = "https://docs.aether.ai/concepts/session";
...
class SessionsPage extends AetherLightDomElement {
...
if (!customElements.get("aether-sessions-page")) {
  customElements.define("aether-sessions-page", SessionsPage);
}
