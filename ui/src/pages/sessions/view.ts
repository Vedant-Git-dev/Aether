...
function renderFilterToggle(params: {
  ...
  const className = [
    ...
    .join(" ");
  return html`
    <aether-tooltip .content=${params.title}>
...
export function renderSessions(props: SessionsProps) {
  ...
  const sessionsTitle = html`
    ...
    ${
      props.result
        ? html`
            <aether-tooltip .content=${t("sessionsView.store", { path: props.result.path })}>
  ...
  return [
    ...
    >
      ...
      <td class="data-table-key-col">
        <aether-tooltip .content=${keyCellTitle}>
          ...
          ${sessionDetails.map(
            (item) => html`
              <div class="session-detail-stat">
                ...
                <aether-tooltip .content=${item.value}>
