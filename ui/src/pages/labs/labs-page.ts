...
class LabsPage extends AetherLightDomElement {
  ...
  override render() {
    ...
    return html`
      ${renderSettingsPageHeader({
        ...
        ${renderLearnMoreLink("https://docs.aether.ai/concepts/experimental-features")}`,
      })}
...
if (!customElements.get("aether-labs-page")) {
  customElements.define("aether-labs-page", LabsPage);
}
