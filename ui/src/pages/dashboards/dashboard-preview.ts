...
class AetherDashboardPreview extends AetherLightDomElement {
...
if (!customElements.get("aether-dashboard-preview")) {
  customElements.define("aether-dashboard-preview", AetherDashboardPreview);
}
