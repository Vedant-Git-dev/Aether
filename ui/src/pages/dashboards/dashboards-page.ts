...
class DashboardsPage extends AetherLightDomElement {
...
if (!customElements.get("aether-dashboards-page")) {
  customElements.define("aether-dashboards-page", DashboardsPage);
}
