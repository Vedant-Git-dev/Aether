...
export class GitHubConnections extends AetherLightDomElement {
...
if (!customElements.get("aether-github-connections")) {
  customElements.define("aether-github-connections", GitHubConnections);
}
