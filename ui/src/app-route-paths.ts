...
export const INTERNAL_AGENT_PATH_PARAM = "__aetherAgentPath";
export const INTERNAL_ACTIVITY_PATH_PARAM = "__aetherActivityPath";
export const INTERNAL_SESSION_PATH_PARAM = "__aetherSessionPath";
export const INTERNAL_MEMORY_PATH_PARAM = "__aetherMemoryPath";
export const INTERNAL_PLUGINS_PATH_PARAM = "__aetherPluginsPath";
export const INTERNAL_PLUGIN_SETTINGS_PATH_PARAM = "__aetherPluginSettingsPath";
export const INTERNAL_WORKBOARD_PATH_PARAM = "__aetherWorkboardPath";
...
export const INTERNAL_PLUGIN_PATH_PARAM = "__aetherPluginPath";
...
function pluginTabSlug(tab: PluginTab): string | undefined {
  ...
  if (NATIVE_ROUTE_SEGMENTS.has(slug)) {
    if (!warnedSlugs.has(slug)) {
      ...
      console.warn(`[aether] /${slug} is a native route; using /plugin.`);
    }
    return undefined;
  }
  return slug;
...
// directories so "/apps/aether" keeps working. Inference is a last-resort
