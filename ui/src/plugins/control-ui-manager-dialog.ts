...
class ControlUiPluginManagerDialog extends AetherLightDomContentsElement {
  ...
  override render() {
    ...
    return html`<aether-modal-dialog .label=${t("pluginUi.customize")}>
      <section class="card">
...
if (!customElements.get("aether-plugin-manager-dialog")) {
  customElements.define("aether-plugin-manager-dialog", ControlUiPluginManagerDialog);
}
