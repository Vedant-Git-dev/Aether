...
import type { BoardGetParams } from "@aether/gateway-protocol";
...
class ControlUiPluginView extends AetherLightDomContentsElement {
  ...
  override requestUpdate(...args: Parameters<AetherLightDomContentsElement["requestUpdate"]>) {
...
class ControlUiPluginContributions extends AetherLightDomContentsElement {
...
if (!customElements.get("aether-plugin-contributions")) {
  customElements.define("aether-plugin-contributions", ControlUiPluginContributions);
}
if (!customElements.get("aether-plugin-view")) {
  customElements.define("aether-plugin-view", ControlUiPluginView);
}
