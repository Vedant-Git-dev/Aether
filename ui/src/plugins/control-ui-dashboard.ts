...
class PluginSessionDashboard extends AetherLightDomElement {
...
if (!customElements.get("aether-plugin-session-dashboard")) {
  customElements.define("aether-plugin-session-dashboard", PluginSessionDashboard);
}

declare global {
  interface HTMLElementTagNameMap {
    "aether-plugin-session-dashboard": PluginSessionDashboard;
  }
}
