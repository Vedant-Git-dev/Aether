    ...
    mountDialog: (container, props) =>
      mount(
        ...
        async () => {
          ...
          return document.createElement("aether-modal-dialog");
        },
        (element, next) => {
    ...
    mountAgentPicker: (container, props) =>
      mount(
        ...
        async () => {
          ...
          return document.createElement("aether-agent-select");
        },
    ...
    mountDashboard: (container, props) =>
      mount(
        ...
        async () => {
          ...
          return document.createElement("aether-plugin-session-dashboard");
        },
        (element, next, current) => {
