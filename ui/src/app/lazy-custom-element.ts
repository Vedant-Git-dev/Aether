...
export const COMMAND_PALETTE_ELEMENT = {
  tagName: "aether-command-palette",
  label: "command palette",
  loadModule: () => import("../components/command-palette.ts"),
} satisfies OptionalCustomElement;

const DEBUG_OVERLAY_TAG = "aether-debug-overlay";
...
const KEYBOARD_SHORTCUTS_TAG = "aether-keyboard-shortcuts-dialog";
...
const MACOS_TITLEBAR_TAG = "aether-macos-titlebar-controls";
...
export const APPROVAL_PAGE_ELEMENT = {
  tagName: "aether-approval-page",
  label: "approval page",
  loadModule: () => import("../pages/approval/approval-page-registration.ts"),
} satisfies OptionalCustomElement;

const QUESTION_PAGE_TAG = "aether-question-page";
...
const EXEC_APPROVAL_TAG = "aether-exec-approval";
