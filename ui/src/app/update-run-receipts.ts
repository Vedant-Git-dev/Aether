...
const TRIAGED_KEY = "aether:control-ui:update:v1";
const ARRAY_TRIAGED_KEY = "aether:control-ui:update-triaged:v1";
...
export function createUpdateRunReceipts() {
  ...
  const key = (kind: ReceiptKind) =>
    kind === "triaged" ? TRIAGED_KEY : "aether:control-ui:update-acknowledged:v1";
