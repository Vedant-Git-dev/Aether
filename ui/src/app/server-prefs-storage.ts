...
export const LAST_SEEN_KEY = "aether.control.serverPrefs.v1";
...
export const PENDING_KEY = "aether.control.serverPrefs.pending.v1";
...
const RETAINED_LOCAL_KEY = "aether.control.serverPrefs.retained-local.v1";
